...
public class Simple2 extends SGTDBF<IConstructor, IConstructor, ISourceLocation> implements IParserTest{
	...
	private final static AbstractStackNode<IConstructor> LITERAL_b3 = new LiteralStackNode<IConstructor>(3, 0, PROD_b_b, new int[]{'b'});
	...
	public IConstructor executeParser(){
		return parse(NONTERMINAL_START_S, null, "ab".toCharArray(), new DefaultNodeFlattener<IConstructor, IConstructor, ISourceLocation>(), new UPTRNodeFactory());
	}
