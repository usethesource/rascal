...
public class NonTerminalStarListEmpty extends SGTDBF<IConstructor, ITree, ISourceLocation> implements IParserTest{
	...
	public NonTerminalStarListEmpty(){
		super();
	}
	...
	public IValue getExpectedResult() throws IOException{
		String expectedInput = "appl(prod(sort(\"S\"),[\\iter-star(sort(\"A\"))],{}),[appl(regular(\\iter-star(sort(\"A\"))),[])])";
		return new StandardTextReader().read(ValueFactoryFactory.getValueFactory(), RascalValueFactory.uptr, RascalValueFactory.Tree, new StringReader(expectedInput));
	}

	public static void main(String[] args){
		NonTerminalStarListEmpty nrsl = new NonTerminalStarListEmpty();
