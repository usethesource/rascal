...
public class Epsilon extends SGTDBF<IConstructor, Tree, ISourceLocation> implements IParserTest{
	...
	public Tree executeParser(){
		return parse(NONTERMINAL_START_S, null, new char[]{}, new DefaultNodeFlattener<IConstructor, Tree, ISourceLocation>(), new UPTRNodeFactory());
	}
