...
public class Ambiguous1 extends SGTDBF<IConstructor, IConstructor, ISourceLocation> implements IParserTest{
	...
	static{
		...
		S_EXPECT_2[0].setAlternativeProduction(PROD_S_a);
	}
	...
	public IValue getExpectedResult() throws IOException{
		String expectedInput = "amb({appl(prod(sort(\"S\"),[lit(\"a\")],{}),[appl(prod(lit(\"a\"),[\\char-class([single(97)])],{}),[char(97)])]),appl(prod(sort(\"S\"),[sort(\"A\")],{}),[appl(prod(sort(\"A\"),[lit(\"a\")],{}),[appl(prod(lit(\"a\"),[\\char-class([single(97)])],{}),[char(97)])])])})";
