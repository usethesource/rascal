...
public class Ambiguous4 extends SGTDBF<IConstructor, ITree, ISourceLocation> implements IParserTest{
	...
	public ITree executeParser(){
		return parse(NONTERMINAL_START_S, null, "bbbbbb".toCharArray(), new DefaultNodeFlattener<IConstructor, ITree, ISourceLocation>(), new UPTRNodeFactory(true));
	}
