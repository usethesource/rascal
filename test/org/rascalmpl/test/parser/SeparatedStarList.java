...
public class SeparatedStarList extends SGTDBF<IConstructor, ITree, ISourceLocation> implements IParserTest{
	...
	private final static IConstructor SYMBOL_SEP_STAR_LIST_A = VF.constructor(RascalValueFactory.Symbol_IterStarSepX, SYMBOL_A, VF.list(SYMBOL_b));
	...
	private final static IConstructor PROD_S_SEPSTARLIST_A_b = VF.constructor(RascalValueFactory.Production_Default,  SYMBOL_START_S, VF.list(SYMBOL_SEP_STAR_LIST_A), VF.set());
	private final static IConstructor PROD_SEPSTARLIST_A_b = VF.constructor(RascalValueFactory.Production_Regular, SYMBOL_SEP_STAR_LIST_A);
	...
	private final static AbstractStackNode<IConstructor> LIST2 = new SeparatedListStackNode<IConstructor>(2, 0, PROD_SEPSTARLIST_A_b, NONTERMINAL_A0, new AbstractStackNode[]{LITERAL_b1}, false);
	...
	static{
		...
		S_EXPECT_1[0].setAlternativeProduction(PROD_S_SEPSTARLIST_A_b);
	}
	...
	public ITree executeParser(){
		return parse(NONTERMINAL_START_S, null, "ababa".toCharArray(), new DefaultNodeFlattener<IConstructor, ITree, ISourceLocation>(), new UPTRNodeFactory(true));
	}
