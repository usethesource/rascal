...
module lang::rascal::check::ATypeInstantiation
...
AType instantiateRascalTypeParams(AType::aadt(str s, list[AType] ps, list[Keyword] common), Bindings bindings) 
    = AType::aadt(s,[instantiateRascalTypeParams(p,bindings) | p <- ps], [<instantiateRascalTypeParams(ft,bindings), fn, de> | <ft, fn, de> <- common]);
