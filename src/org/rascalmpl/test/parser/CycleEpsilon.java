...
A ::= AA | epsilon | a
*/
public class CycleEpsilon extends SGTDBF implements IParserTest{
	...
	private final static AbstractStackNode[] A_EXPECT_3 = new AbstractStackNode[1];
	static{
		A_EXPECT_3[0] = EPSILON_4;
		A_EXPECT_3[0].setProduction(A_EXPECT_3);
		A_EXPECT_3[0].setParentProduction(PROD_A_epsilon);
	}
	...
	public AbstractStackNode[] A(){
		return new AbstractStackNode[]{A_EXPECT_1[0], A_EXPECT_2[0], A_EXPECT_3[0]};
	}
