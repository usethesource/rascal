...
public class Ambiguous6 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NONTERMINAL_B1 = new NonTerminalStackNode(1, AbstractStackNode.DEFAULT_LEVEL_ID, "B");
	private final static AbstractStackNode NONTERMINAL_C2 = new NonTerminalStackNode(2, AbstractStackNode.DEFAULT_LEVEL_ID, "C");
	private final static AbstractStackNode NONTERMINAL_D3 = new NonTerminalStackNode(3, AbstractStackNode.DEFAULT_LEVEL_ID, "D");
	private final static AbstractStackNode NONTERMINAL_E4 = new NonTerminalStackNode(4, AbstractStackNode.DEFAULT_LEVEL_ID, "E");
	private final static AbstractStackNode NONTERMINAL_E5 = new NonTerminalStackNode(5, AbstractStackNode.DEFAULT_LEVEL_ID, "E");
	private final static AbstractStackNode NONTERMINAL_F6 = new NonTerminalStackNode(6, AbstractStackNode.DEFAULT_LEVEL_ID, "F");
	private final static AbstractStackNode NONTERMINAL_G7 = new NonTerminalStackNode(7, AbstractStackNode.DEFAULT_LEVEL_ID, "G");
	...
	public static void main(String[] args){
		...
		IValue result = a6.parse(NONTERMINAL_START_S, null, "a".toCharArray());
