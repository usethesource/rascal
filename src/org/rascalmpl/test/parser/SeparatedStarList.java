...
public class SeparatedStarList extends SGLL{
	...
	private final static IConstructor PROD_S_SEPSTARLIST_A_b = vf.constructor(Factory.Production_Default, vf.list(SYMBOL_SEP_STAR_LIST_A), SYMBOL_START_S, vf.list(Factory.Attributes));
	private final static IConstructor PROD_SEPSTARLIST_A_b = vf.constructor(Factory.Production_List, vf.list(SYMBOL_A, vf.list(SYMBOL_b)), vf.list(Factory.Attributes));
