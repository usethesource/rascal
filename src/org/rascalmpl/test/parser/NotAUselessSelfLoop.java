...
public class NotAUselessSelfLoop extends SGTDBF implements IParserTest{
	...
	private final static IConstructor PROD_A_CC = VF.constructor(Factory.Production_Default,  SYMBOL_A, VF.list(SYMBOL_C, SYMBOL_C), VF.set());
	...
	private final static IConstructor PROD_B_CC = VF.constructor(Factory.Production_Default,  SYMBOL_B, VF.list(SYMBOL_C, SYMBOL_C), VF.set());
	private final static IConstructor PROD_C_AA = VF.constructor(Factory.Production_Default,  SYMBOL_C, VF.list(SYMBOL_A, SYMBOL_A), VF.set());
