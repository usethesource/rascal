...
A ::= a
*/
public class NonTerminalStarList extends SGTDBF implements IParserTest{
	...
	private final static IConstructor PROD_S_STARLISTA = VF.constructor(Factory.Production_Default,  SYMBOL_START_S, VF.list(SYMBOL_STAR_LIST_A), VF.set());
	...
	static{
		...
		S_EXPECT_1[0].setParentProduction(PROD_S_STARLISTA);
	}
	...
	public static void main(String[] args){
		...
		IConstructor result = nrsl.parse(NONTERMINAL_START_S, null, "aaa".toCharArray(), new NodeToUPTR());
