...
public class Optional3 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NON_TERMINAL_O5 = new NonTerminalStackNode(5, AbstractStackNode.DEFAULT_LEVEL_ID, "O");
	...
	public static void main(String[] args){
		...
		IValue result = o3.parse(NONTERMINAL_START_S, null, "aa".toCharArray());
