...
O ::= a
*/
public class Optional1 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NON_TERMINAL_O2 = new NonTerminalStackNode(2, AbstractStackNode.DEFAULT_LEVEL_ID, "O");
	...
	public static void main(String[] args){
		...
		IValue result = o1.parse(NONTERMINAL_START_S, null, "aa".toCharArray());
