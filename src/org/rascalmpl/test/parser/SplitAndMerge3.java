...
public class SplitAndMerge3 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NONTERMINAL_C4 = new NonTerminalStackNode(4, AbstractStackNode.DEFAULT_LEVEL_ID, "C");
	...
	public static void main(String[] args){
		...
		IValue result = ms3.parse(NONTERMINAL_START_S, null, "aaa".toCharArray());
