...
B ::= aa | a
*/
public class Ambiguous5 extends SGTDBF<IConstructor, ISourceLocation> implements IParserTest{
	...
	private final static IConstructor PROD_B_aa = VF.constructor(Factory.Production_Default,  SYMBOL_B, VF.list(SYMBOL_aa), VF.set());
	...
	private final static AbstractStackNode LITERAL_aa4 = new LiteralStackNode(4, 0, PROD_aa_aa, new int[]{'a','a'});
