...
A ::= Aa | a
*/
public class LeftRecursion extends SGTDBF<IConstructor, ISourceLocation> implements IParserTest{
	...
	private final static AbstractStackNode LITERAL_a2 = new LiteralStackNode(2, 1, PROD_a_a, new int[]{'a'});
