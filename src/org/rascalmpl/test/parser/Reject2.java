...
public class Reject2 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NONTERMINAL_AB0 = new NonTerminalStackNode(0, AbstractStackNode.DEFAULT_LEVEL_ID, "AB");
	private final static AbstractStackNode NONTERMINAL_AB1 = new NonTerminalStackNode(1, AbstractStackNode.DEFAULT_LEVEL_ID, "AB");
	private final static AbstractStackNode NONTERMINAL_BC2 = new NonTerminalStackNode(2, AbstractStackNode.DEFAULT_LEVEL_ID, "BC");
	private final static AbstractStackNode NONTERMINAL_BC3 = new NonTerminalStackNode(3, AbstractStackNode.DEFAULT_LEVEL_ID, "BC");
	private final static AbstractStackNode NONTERMINAL_ABp4 = new NonTerminalStackNode(4, AbstractStackNode.DEFAULT_LEVEL_ID, "ABp");
	private final static AbstractStackNode NONTERMINAL_ABp5 = new NonTerminalStackNode(5, AbstractStackNode.DEFAULT_LEVEL_ID, "ABp");
	private final static AbstractStackNode NONTERMINAL_ABp6 = new NonTerminalStackNode(6, AbstractStackNode.DEFAULT_LEVEL_ID, "ABp");
	private final static AbstractStackNode NONTERMINAL_BCp7 = new NonTerminalStackNode(7, AbstractStackNode.DEFAULT_LEVEL_ID, "BCp");
	private final static AbstractStackNode NONTERMINAL_BCp8 = new NonTerminalStackNode(8, AbstractStackNode.DEFAULT_LEVEL_ID, "BCp");
	private final static AbstractStackNode NONTERMINAL_X9 = new NonTerminalStackNode(9, AbstractStackNode.DEFAULT_LEVEL_ID, "X");
	private final static AbstractStackNode NONTERMINAL_Y10 = new NonTerminalStackNode(10, AbstractStackNode.DEFAULT_LEVEL_ID, "Y");
	...
	public static void main(String[] args){
		...
		IValue result = r2.parse(NONTERMINAL_START_S, null, "aabbcc".toCharArray());
