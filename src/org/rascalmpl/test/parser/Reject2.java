...
public class Reject2 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NONTERMINAL_AB0 = new NonTerminalStackNode(0, 1, "AB");
	private final static AbstractStackNode NONTERMINAL_AB1 = new NonTerminalStackNode(1, 0, "AB");
	private final static AbstractStackNode NONTERMINAL_BC2 = new NonTerminalStackNode(2, 1, "BC");
	private final static AbstractStackNode NONTERMINAL_BC3 = new NonTerminalStackNode(3, 1, "BC");
	private final static AbstractStackNode NONTERMINAL_ABp4 = new NonTerminalStackNode(4, 0, "ABp");
	private final static AbstractStackNode NONTERMINAL_ABp5 = new NonTerminalStackNode(5, 0, "ABp");
	private final static AbstractStackNode NONTERMINAL_ABp6 = new NonTerminalStackNode(6, 0, "ABp");
	private final static AbstractStackNode NONTERMINAL_BCp7 = new NonTerminalStackNode(7, 0, "BCp");
	private final static AbstractStackNode NONTERMINAL_BCp8 = new NonTerminalStackNode(8, 0, "BCp");
	private final static AbstractStackNode NONTERMINAL_X9 = new NonTerminalStackNode(9, 0, "X");
	private final static AbstractStackNode NONTERMINAL_Y10 = new NonTerminalStackNode(10, 0, "Y");
	private final static AbstractStackNode LITERAL_a11 = new LiteralStackNode(11, 0, PROD_a_a, new char[]{'a'});
	private final static AbstractStackNode LITERAL_b12 = new LiteralStackNode(12, 2, PROD_b_b, new char[]{'b'});
	private final static AbstractStackNode LITERAL_b13 = new LiteralStackNode(13, 0, PROD_b_b, new char[]{'b'});
	private final static AbstractStackNode LITERAL_c14 = new LiteralStackNode(14, 2, PROD_c_c, new char[]{'c'});
	private final static AbstractStackNode EPSILON_15 = new EpsilonStackNode(15, 0);
	private final static AbstractStackNode EPSILON_16 = new EpsilonStackNode(16, 0);
	private final static AbstractStackNode CHAR16 = new CharStackNode(16, 0, new char[][]{{'a', 'a'}});
	private final static AbstractStackNode CHAR17 = new CharStackNode(17, 0, new char[][]{{'c', 'c'}});
	private final static AbstractStackNode LIST18 = new ListStackNode(18, 0, PROD_PLUSLISTa, CHAR16, true);
	private final static AbstractStackNode LIST19 = new ListStackNode(19, 1, PROD_PLUSLISTc, CHAR17, true);
	...
	public IConstructor executeParser(){
		return parse(NONTERMINAL_START_S, null, "aabbcc".toCharArray());
	}
	...
	public static void main(String[] args){
		Reject2 r2 = new Reject2();
		IConstructor result = r2.parse(NONTERMINAL_START_S, null, "aabbcc".toCharArray());
