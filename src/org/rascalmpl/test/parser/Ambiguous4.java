...
B ::= bb | b
*/
public class Ambiguous4 extends SGTDBF<IConstructor, ISourceLocation> implements IParserTest{
	...
	private final static AbstractStackNode LITERAL_b4 = new LiteralStackNode(4, 0, PROD_b_b, new int[]{'b'});
	private final static AbstractStackNode LITERAL_bb5 = new LiteralStackNode(5, 0, PROD_bb_bb, new int[]{'b','b'});
	...
	public IConstructor executeParser(){
		return (IConstructor) parse(NONTERMINAL_START_S, null, "bbbbbb".toCharArray(), new DefaultNodeFlattener<IConstructor, ISourceLocation>(), new UPTRNodeFactory());
	}
