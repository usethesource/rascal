...
public class Ambiguous2 extends SGTDBF implements IParserTest{
	...
	static{
		...
		S_EXPECT_1[1].setParentProduction(PROD_S_Aab);
	}
	...
	static{
		...
		S_EXPECT_2[0].setParentProduction(PROD_S_bab);
	}
	...
	public IConstructor executeParser(){
		return parse(NONTERMINAL_START_S, null, "bab".toCharArray(), new NodeToUPTR());
	}
	...
	public static void main(String[] args){
		...
		IConstructor result = a2.parse(NONTERMINAL_START_S, null, "bab".toCharArray(), new NodeToUPTR());
