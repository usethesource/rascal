...
public class SplitAndMerge2 extends SGLL implements IParserTest{
	...
	private final static AbstractStackNode NONTERMINAL_C3 = new NonTerminalStackNode(3, AbstractStackNode.DEFAULT_LEVEL_ID, "C");
	private final static AbstractStackNode NONTERMINAL_D4 = new NonTerminalStackNode(4, AbstractStackNode.DEFAULT_LEVEL_ID, "D");
	private final static AbstractStackNode NONTERMINAL_D5 = new NonTerminalStackNode(5, AbstractStackNode.DEFAULT_LEVEL_ID, "D");
	...
	public static void main(String[] args){
		...
		IValue result = ms2.parse(NONTERMINAL_START_S, null, "aaa".toCharArray());
