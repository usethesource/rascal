...
public class AmbiguousEpsilonList extends SGLL implements IParserTest{
	...
	public static void main(String[] args){
		...
		IValue result = ael.parse(NONTERMINAL_START_S, "a".toCharArray());
