...
public abstract class Assignable extends org.rascalmpl.ast.Assignable {
	...
	static public class IfDefinedOrDefault extends org.rascalmpl.ast.Assignable.IfDefinedOrDefault {
		...
		public IfDefinedOrDefault(INode __param1, org.rascalmpl.ast.Assignable __param2, Expression __param3) {
	...
	static public class Tuple extends org.rascalmpl.ast.Assignable.Tuple {
		...
		public Result<IValue> __evaluate(AssignableEvaluator __eval) {
			...
			if (!__eval.__getValue().getType().isTupleType()) {
				...
				throw new UnexpectedTypeError(org.rascalmpl.interpreter.AssignableEvaluator.__getTf().tupleEmpty(), __eval.__getValue().getType(), this);
			}
			...
			return org.rascalmpl.interpreter.result.ResultFactory.makeResult(org.rascalmpl.interpreter.AssignableEvaluator.__getTf().tupleType(resultTypes),
					tupleType.make(__eval.__getEval().getValueFactory(), results), __eval.__getEval());
	...
	static public class Subscript extends org.rascalmpl.ast.Assignable.Subscript {
		...
		public Subscript(INode __param1, org.rascalmpl.ast.Assignable __param2, Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public Result<IValue> __evaluate(Evaluator __eval) {
			...
			if (receiver.getType().isListType()) {
				...
				throw new UnexpectedTypeError(org.rascalmpl.interpreter.Evaluator.__getTf().integerType(), subscript.getType(), this);
				...
				throw new UnexpectedTypeError(keyType, subscript.getType(), this.getSubscript());
			}
			// TODO implement other subscripts
			throw new UnsupportedOperationError("subscript", receiver.getType(), this);
		...
		public Result<IValue> __evaluate(AssignableEvaluator __eval) {
			...
			if (rec.getType().isListType() && subscript.getType().isIntegerType()) {
				try {
					...
					throw org.rascalmpl.interpreter.utils.RuntimeExceptionFactory.indexOutOfBounds((IInteger) subscript.getValue(), __eval.__getEval().getCurrentAST(), __eval.__getEval()
							.getStackTrace());
				}
				...
				if (rec.getType().getArity() != 2) {
					throw new UnsupportedSubscriptError(rec.getType(), subscript.getType(), this);
				}

				if (!__eval.__getValue().getType().isSubtypeOf(rec.getType().getFieldType(1))) {
					throw new UnexpectedTypeError(rec.getType().getFieldType(1), __eval.__getValue().getType(), __eval.__getEval().getCurrentAST());
				}
	...
	static public class Constructor extends org.rascalmpl.ast.Assignable.Constructor {
		...
		public Constructor(INode __param1, Name __param2, List<org.rascalmpl.ast.Assignable> __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public Result<IValue> __evaluate(AssignableEvaluator __eval) {
			...
			if (!valueType.isNodeType() && !valueType.isAbstractDataType() && !valueType.isConstructorType()) {
				throw new UnexpectedTypeError(org.rascalmpl.interpreter.AssignableEvaluator.__getTf().nodeType(), __eval.__getValue().getType(), this);
			}
			...
			if (!node.getName().equals(org.rascalmpl.interpreter.utils.Names.name(this.getName()))) {
				throw org.rascalmpl.interpreter.utils.RuntimeExceptionFactory.nameMismatch(node.getName(), org.rascalmpl.interpreter.utils.Names.name(this.getName()), this.getName(), __eval
			...
			for (int i = 0; i < arguments.size(); i++) {
				Type argType = !nodeType.isConstructorType() ? org.rascalmpl.interpreter.AssignableEvaluator.__getTf().valueType() : nodeType.getFieldType(i);
			...
			Type constructor = __eval.__getEval().getCurrentEnvt().getConstructor(node.getName(), org.rascalmpl.interpreter.AssignableEvaluator.__getTf().tupleType(resultTypes));

			if (constructor == null) {
				throw new ImplementationError("could not find constructor for " + node.getName() + " : " + org.rascalmpl.interpreter.AssignableEvaluator.__getTf().tupleType(resultTypes));
			}
	...
	static public class Ambiguity extends org.rascalmpl.ast.Assignable.Ambiguity {
		...
		public Ambiguity(INode __param1, List<org.rascalmpl.ast.Assignable> __param2) {
			super(__param1, __param2);
		}
	...
	static public class Annotation extends org.rascalmpl.ast.Assignable.Annotation {
		...
		public Annotation(INode __param1, org.rascalmpl.ast.Assignable __param2, Name __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public Result<IValue> __evaluate(Evaluator __eval) {
			...
			if (!__eval.getCurrentEnvt().declaresAnnotation(receiver.getType(), label)) {
				throw new UndeclaredAnnotationError(label, receiver.getType(), this);
			}

			Type type = __eval.getCurrentEnvt().getAnnotationType(receiver.getType(), label);
		...
		public Result<IValue> __evaluate(AssignableEvaluator __eval) {
			...
			if (!__eval.__getEnv().declaresAnnotation(result.getType(), label)) {
				throw new UndeclaredAnnotationError(label, result.getType(), this);
			}
	...
	static public class FieldAccess extends org.rascalmpl.ast.Assignable.FieldAccess {
		...
		public FieldAccess(INode __param1, org.rascalmpl.ast.Assignable __param2, Name __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public Result<IValue> __evaluate(Evaluator __eval) {
			...
			if (receiver == null) {
				throw new UndeclaredVariableError(this.getReceiver().toString(), this.getReceiver());
			}
		...
		public Result<IValue> __evaluate(AssignableEvaluator __eval) {
			...
			if (receiver.getType().isTupleType()) {
				...
				IValue result = ((ITuple) receiver.getValue()).set(idx, __eval.__getValue().getValue());
				...
				if (!node.hasField(label)) {
					throw new UndeclaredFieldError(label, receiver.getValue().getType(), this);
				}

				int index = node.getFieldIndex(label);

				if (!__eval.__getValue().getType().isSubtypeOf(node.getFieldType(index))) {
					throw new UnexpectedTypeError(node.getFieldType(index), __eval.__getValue().getType(), this);
				}
