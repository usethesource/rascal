...
public RegExpModifier (org.eclipse.imp.pdb.facts.INode __param1) {
	super(__param1);
}
...
public Ambiguity (org.eclipse.imp.pdb.facts.INode __param1,java.util.List<org.rascalmpl.ast.RegExpModifier> __param2) {
	super(__param1,__param2);
}
@Override
public <T>  T __evaluate(org.rascalmpl.ast.NullASTVisitor<T> __eval) {
