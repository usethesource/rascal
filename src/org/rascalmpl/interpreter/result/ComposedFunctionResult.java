...
public class ComposedFunctionResult extends Result<IValue> implements IExternalValue, ICallableValue {
	...
	@Override
	public Result<IValue> call(IRascalMonitor monitor, Type[] argTypes,
			IValue[] argValues, Map<String, IValue> keyArgValues, Result<IValue> self, Map<String, Result<IValue>> openFunctions) {
	...
	public static class NonDeterministic extends ComposedFunctionResult {
		...
		public Result<IValue> call(Type[] argTypes, IValue[] argValues, Map<String, IValue> keyArgValues, Result<IValue> self, Map<String, Result<IValue>> openFunctions) {
			...
			try {
				try {
					return getRight().call(argTypes, argValues, keyArgValues, self, this.getOpenFunctions());
				...
				return getLeft().call(argTypes, argValues, keyArgValues, self, this.getOpenFunctions());
