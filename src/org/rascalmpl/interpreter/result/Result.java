...
public abstract class Result<T extends IValue> implements Iterator<Result<IValue>> {
	...
	protected <U extends IValue> Result<U> inListRelation(ListRelationResult that) {
		return that.undefinedError(IN_STRING, this);
	}
	...
	protected <U extends IValue> Result<U> notInListRelation(ListRelationResult that) {
		return that.undefinedError(NOTIN_STRING, this);
	}
	...
	protected <U extends IValue> Result<U> greaterThanOrEqualListRelation(ListRelationResult that) {
		return that.undefinedError(GREATER_THAN_OR_EQUAL_STRING, this);
	}
