...
.Description
An insert statement may only occur in the action part of a link:/Rascal#Patterns-PatternWithAction[pattern with action], 
more precisely in a case in a 
link:/Rascal#Expressions-Visit[visit] expression. 
