...
[[Declarations-StaticTyping]]
# StaticTyping
:concept: Declarations/StaticTyping
...
image::{concept}/Concepts/StaticTyping/type-lattice.png[width=400,title="Type Lattice"]
...
----
rascal>int j = "abc";
[error] Unable to bind subject type str to assignable IN 'j = "abc";'
----
...
include::TypeConstraints/TypeConstraints.adoc[TypeConstraints]

include::TypeParameters/TypeParameters.adoc[TypeParameters]
