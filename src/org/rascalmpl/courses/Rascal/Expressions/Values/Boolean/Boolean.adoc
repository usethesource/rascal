[[Values-Boolean]]
# Boolean
:concept: Expressions/Values/Boolean
...
The following library function are provided for Boolean:
subtoc[Rascal/Libraries/Prelude/Boolean,1]
...
:leveloffset: +1
include::All/All.adoc[All]

include::And/And.adoc[And]

include::Any/Any.adoc[Any]

include::Equivalence/Equivalence.adoc[Equivalence]

include::IfDefinedElse/IfDefinedElse.adoc[IfDefinedElse]

include::Implication/Implication.adoc[Implication]

include::IsDefined/IsDefined.adoc[IsDefined]

include::Match/Match.adoc[Match]

include::Negation/Negation.adoc[Negation]

include::NoMatch/NoMatch.adoc[NoMatch]

include::Or/Or.adoc[Or]
