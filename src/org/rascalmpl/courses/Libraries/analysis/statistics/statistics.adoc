...
:leveloffset: +1
include::Correlation/Correlation.adoc[Correlation]

include::Descriptive/Descriptive.adoc[Descriptive]

include::Frequency/Frequency.adoc[Frequency]

include::Inference/Inference.adoc[Inference]

include::SimpleRegression/SimpleRegression.adoc[SimpleRegression]
