...
** <<Prelude-Exception,Exception>>: Exceptions thrown by the Rascal run-time.
...
** <<Prelude-ParseTree,ParseTree>>: Library functions for parse trees.
...
** <<Prelude-Type,Type>>: Rascal's type system, implemented in Rascal itself.
