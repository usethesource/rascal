...
ok
rascal>now();
datetime: $2016-05-31T12:14:39.331+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:42.183+00:00$
rascal>splitDateTime(N);
tuple[datetime,datetime]: <$2016-05-31$,$T12:14:42.183+00:00$>
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:42.563+00:00$
rascal>incrementYears(N);
datetime: $2017-07-01T12:14:42.563+00:00$
rascal>incrementYears(N, 5);
datetime: $2021-07-01T12:14:42.563+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:44.661+00:00$
rascal>incrementMonths(N);
datetime: $2016-08-01T12:14:44.661+00:00$
rascal>incrementMonths(N, 5);
datetime: $2016-12-01T12:14:44.661+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:45.093+00:00$
rascal>incrementDays(N);
datetime: $2016-07-02T12:14:45.093+00:00$
rascal>incrementDays(N, 5);
datetime: $2016-07-06T12:14:45.093+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:45.558+00:00$
rascal>incrementHours(N);
datetime: $2016-07-01T13:14:45.558+00:00$
rascal>incrementHours(N, 5);
datetime: $2016-07-01T17:14:45.558+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:47.480+00:00$
rascal>incrementMinutes(N);
datetime: $2016-07-01T12:15:47.480+00:00$
rascal>incrementMinutes(N, 5);
datetime: $2016-07-01T12:19:47.480+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:47.892+00:00$
rascal>incrementSeconds(N);
datetime: $2016-07-01T12:14:48.892+00:00$
rascal>incrementSeconds(N, 5);
datetime: $2016-07-01T12:14:52.892+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:49.442+00:00$
rascal>incrementMilliseconds(N);
datetime: $2016-07-01T12:14:49.443+00:00$
rascal>incrementMilliseconds(N, 5);
datetime: $2016-07-01T12:14:49.447+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:50.122+00:00$
rascal>decrementYears(N);
datetime: $2015-07-01T12:14:50.122+00:00$
rascal>decrementYears(N, 5);
datetime: $2011-07-01T12:14:50.122+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:50.540+00:00$
rascal>decrementMonths(N);
datetime: $2016-06-01T12:14:50.540+00:00$
rascal>decrementMonths(N, 5);
datetime: $2016-02-01T12:14:50.540+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:52.146+00:00$
rascal>decrementDays(N);
datetime: $2016-06-30T12:14:52.146+00:00$
rascal>decrementDays(N, 3);
datetime: $2016-06-28T12:14:52.146+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:52.582+00:00$
rascal>decrementHours(N);
datetime: $2016-07-01T11:14:52.582+00:00$
rascal>decrementHours(N, 5);
datetime: $2016-07-01T07:14:52.582+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:53.002+00:00$
rascal>decrementMinutes(N);
datetime: $2016-07-01T12:13:53.002+00:00$
rascal>decrementMinutes(N, 5);
datetime: $2016-07-01T12:09:53.002+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:54.685+00:00$
rascal>decrementSeconds(N);
datetime: $2016-07-01T12:14:53.685+00:00$
rascal>decrementSeconds(N, 5);
datetime: $2016-07-01T12:14:49.685+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-31T12:14:55.111+00:00$
rascal>decrementMilliseconds(N);
datetime: $2016-07-01T12:14:55.110+00:00$
rascal>decrementMilliseconds(N, 5);
datetime: $2016-07-01T12:14:55.106+00:00$
----
...
ok
rascal>B = now();
datetime: $2016-05-31T12:14:55.585+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-03T12:14:55.585+00:00$
rascal>createInterval(B, E);
interval: Interval($2016-05-31T12:14:55.585+00:00$,$2016-07-03T12:14:55.585+00:00$)
----
...
ok
rascal>B = now();
datetime: $2016-05-31T12:14:57.522+00:00$
rascal>E1 = incrementHours(B);
datetime: $2016-07-01T13:14:57.522+00:00$
rascal>createDuration(B, E1);
Duration: duration(0,1,1,1,0,0,0)
rascal>E2 = incrementMinutes(B);
datetime: $2016-07-01T12:15:57.522+00:00$
...
ok
rascal>B = now();
datetime: $2016-05-31T12:14:58.365+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-03T12:14:58.365+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2016-05-31T12:14:58.365+00:00$,$2016-07-03T12:14:58.365+00:00$)
...
ok
rascal>B = now();
datetime: $2016-05-31T12:15:00.666+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-03T12:15:00.666+00:00$
rascal>daysDiff(B, E);
int: 33
----
...
ok
rascal>B = now();
datetime: $2016-05-31T12:15:01.176+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-03T12:15:01.176+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2016-05-31T12:15:01.176+00:00$,$2016-07-03T12:15:01.176+00:00$)
...
ok
rascal>N = now();
datetime: $2016-05-31T12:15:05.566+00:00$
rascal>printTime(N);
str: "12:15:05.566+0000"
...
ok
rascal>N = now();
datetime: $2016-05-31T12:15:05.999+00:00$
rascal>printDateTime(N);
str: "2016-05-31 12:15:05.999+0000"
rascal>printDateTime(N, "yyyy-MM-dd\'T\'HH:mm:ss.SSSZZ");
str: "2016-05-31T12:15:05.999+0000"
rascal>printDateTime(N, "YYYY/MM/dd/HH/mm/ss");
str: "2016/05/31/12/15/05"
----
