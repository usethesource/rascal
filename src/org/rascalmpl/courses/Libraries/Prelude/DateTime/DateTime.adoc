...
ok
rascal>now();
datetime: $2016-05-30T21:07:37.277+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:41.713+00:00$
rascal>splitDateTime(N);
tuple[datetime,datetime]: <$2016-05-30$,$T21:07:41.713+00:00$>
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:42.125+00:00$
rascal>incrementYears(N);
datetime: $2017-06-30T21:07:42.125+00:00$
rascal>incrementYears(N, 5);
datetime: $2021-06-30T21:07:42.125+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:42.864+00:00$
rascal>incrementMonths(N);
datetime: $2016-07-30T21:07:42.864+00:00$
rascal>incrementMonths(N, 5);
datetime: $2016-11-30T21:07:42.864+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:44.626+00:00$
rascal>incrementDays(N);
datetime: $2016-07-01T21:07:44.626+00:00$
rascal>incrementDays(N, 5);
datetime: $2016-07-05T21:07:44.626+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:45.040+00:00$
rascal>incrementHours(N);
datetime: $2016-06-30T22:07:45.040+00:00$
rascal>incrementHours(N, 5);
datetime: $2016-07-01T02:07:45.040+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:45.449+00:00$
rascal>incrementMinutes(N);
datetime: $2016-06-30T21:08:45.449+00:00$
rascal>incrementMinutes(N, 5);
datetime: $2016-06-30T21:12:45.449+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:47.231+00:00$
rascal>incrementSeconds(N);
datetime: $2016-06-30T21:07:48.231+00:00$
rascal>incrementSeconds(N, 5);
datetime: $2016-06-30T21:07:52.231+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:47.660+00:00$
rascal>incrementMilliseconds(N);
datetime: $2016-06-30T21:07:47.661+00:00$
rascal>incrementMilliseconds(N, 5);
datetime: $2016-06-30T21:07:47.665+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:48.131+00:00$
rascal>decrementYears(N);
datetime: $2015-06-30T21:07:48.131+00:00$
rascal>decrementYears(N, 5);
datetime: $2011-06-30T21:07:48.131+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:49.987+00:00$
rascal>decrementMonths(N);
datetime: $2016-05-30T21:07:49.987+00:00$
rascal>decrementMonths(N, 5);
datetime: $2016-01-30T21:07:49.987+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:50.428+00:00$
rascal>decrementDays(N);
datetime: $2016-06-29T21:07:50.428+00:00$
rascal>decrementDays(N, 3);
datetime: $2016-06-27T21:07:50.428+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:52.074+00:00$
rascal>decrementHours(N);
datetime: $2016-06-30T20:07:52.074+00:00$
rascal>decrementHours(N, 5);
datetime: $2016-06-30T16:07:52.074+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:52.502+00:00$
rascal>decrementMinutes(N);
datetime: $2016-06-30T21:06:52.502+00:00$
rascal>decrementMinutes(N, 5);
datetime: $2016-06-30T21:02:52.502+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:52.926+00:00$
rascal>decrementSeconds(N);
datetime: $2016-06-30T21:07:51.926+00:00$
rascal>decrementSeconds(N, 5);
datetime: $2016-06-30T21:07:47.926+00:00$
----
...
ok
rascal>N = now();
datetime: $2016-05-30T21:07:54.790+00:00$
rascal>decrementMilliseconds(N);
datetime: $2016-06-30T21:07:54.789+00:00$
rascal>decrementMilliseconds(N, 5);
datetime: $2016-06-30T21:07:54.785+00:00$
----
...
ok
rascal>B = now();
datetime: $2016-05-30T21:07:55.241+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-02T21:07:55.241+00:00$
rascal>createInterval(B, E);
interval: Interval($2016-05-30T21:07:55.241+00:00$,$2016-07-02T21:07:55.241+00:00$)
----
...
ok
rascal>B = now();
datetime: $2016-05-30T21:07:55.787+00:00$
rascal>E1 = incrementHours(B);
datetime: $2016-06-30T22:07:55.787+00:00$
rascal>createDuration(B, E1);
Duration: duration(0,1,0,1,0,0,0)
rascal>E2 = incrementMinutes(B);
datetime: $2016-06-30T21:08:55.787+00:00$
...
ok
rascal>B = now();
datetime: $2016-05-30T21:07:57.849+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-02T21:07:57.849+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2016-05-30T21:07:57.849+00:00$,$2016-07-02T21:07:57.849+00:00$)
...
ok
rascal>B = now();
datetime: $2016-05-30T21:07:59.935+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-02T21:07:59.935+00:00$
rascal>daysDiff(B, E);
int: 33
----
...
ok
rascal>B = now();
datetime: $2016-05-30T21:08:00.466+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2016-07-02T21:08:00.466+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2016-05-30T21:08:00.466+00:00$,$2016-07-02T21:08:00.466+00:00$)
...
ok
rascal>N = now();
datetime: $2016-05-30T21:08:05.543+00:00$
rascal>printTime(N);
str: "21:08:05.543+0000"
...
ok
rascal>N = now();
datetime: $2016-05-30T21:08:05.997+00:00$
rascal>printDateTime(N);
str: "2016-05-30 21:08:05.997+0000"
rascal>printDateTime(N, "yyyy-MM-dd\'T\'HH:mm:ss.SSSZZ");
str: "2016-05-30T21:08:05.997+0000"
rascal>printDateTime(N, "YYYY/MM/dd/HH/mm/ss");
str: "2016/05/30/21/08/05"
----
