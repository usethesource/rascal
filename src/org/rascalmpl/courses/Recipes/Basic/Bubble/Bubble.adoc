...
We present here several styles to implement bubble sort. Also see link::{Rascal}#Libraries-Prelude-Set-sort[] for a more efficient library function for sorting.
