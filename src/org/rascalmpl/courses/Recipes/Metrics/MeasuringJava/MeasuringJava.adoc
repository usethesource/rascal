...
[[Metrics-MeasuringJava]]
# Measuring Java
:concept: Metrics/MeasuringJava
...
:leveloffset: +1
include::MeasuringClasses/MeasuringClasses.adoc[MeasuringClasses]

include::MeasuringMethods/MeasuringMethods.adoc[MeasuringMethods]
