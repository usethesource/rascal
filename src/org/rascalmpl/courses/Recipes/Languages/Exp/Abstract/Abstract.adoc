...
[[Exp-Abstract]]
# Abstract
:concept: Languages/Exp/Abstract
...
Here we see Rascal's _pattern-directed invocation_ in action (see link:{RascalLang}#Declarations-Function[Function Declaration]).
