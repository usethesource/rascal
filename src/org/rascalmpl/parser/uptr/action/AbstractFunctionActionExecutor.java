 ...
 */
abstract public class AbstractFunctionActionExecutor implements IActionExecutor<ITree> {
	...
	public ITree filterAmbiguity(ITree ambCluster, Object environment) {
		...
		try {
			ITree result = filter(ambCluster);
	...
	abstract protected ITree filter(ITree t);
}
