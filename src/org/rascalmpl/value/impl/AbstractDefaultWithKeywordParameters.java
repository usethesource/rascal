...
public abstract class AbstractDefaultWithKeywordParameters<T extends IValue> implements IWithKeywordParameters<T> {
	 ...
	 */
	public AbstractDefaultWithKeywordParameters(T content, io.usethesource.capsule.api.deprecated.Map.ImmutableMap<String, IValue> parameters) {
	 ...
	 *         {@link #parameters}
	 */
	protected abstract T wrap(final T content, final io.usethesource.capsule.api.deprecated.Map.ImmutableMap<String, IValue> parameters);
	...
	public T unsetParameter(String label) {
		io.usethesource.capsule.api.deprecated.Map.ImmutableMap<String, IValue> removed = parameters.__remove(label);
