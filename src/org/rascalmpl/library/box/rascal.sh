...
$JAVAHOME/bin/java -cp $RDIR/lib/jline-0.9.94.jar:$RDIR/bin:$INSTALLEDHOME/sglr-invoker/bin:$WORK/org.eclipse.imp.pdb.values/bin:$WORK/org.eclipse.imp.pdb/bin \
