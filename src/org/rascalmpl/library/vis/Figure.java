...
public abstract class Figure implements Comparable<Figure> {
	...
	public double height; // height of element
							// When this figure is used as mouseOver or inner
							// figure, point back
	...
	public void bbox(BoundingBox b) {
	...
	public boolean isHGapFactorPropertySet() {
		return isRealPropertySet(Properties.HGAP_FACTOR);
	}

	public double getHGapFactorProperty() {
		return getRealProperty(Properties.HGAP_FACTOR);
	}

	public boolean isVGapFactorPropertySet() {
		return isRealPropertySet(Properties.VGAP_FACTOR);
	}

	public double getVGapFactorProperty() {
		return getRealProperty(Properties.VGAP_FACTOR);
	}
	...
	public boolean getStartGapProperty() {
		return getBooleanProperty(Properties.START_GAP);
	}

	public boolean getEndGapProperty() {
		return getBooleanProperty(Properties.END_GAP);
	}
