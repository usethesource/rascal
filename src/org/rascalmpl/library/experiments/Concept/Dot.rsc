...
module experiments::Concept::Dot
import IO;
import String;
...
str oStm(Stm x) {
    switch (x) {
        ...
        case E(Id from, Id to, Attrs attrs): return "<from>-\><to><oAttr(attrs)>";
        
        case E(NodeId from, Id to): return "<oNodeId(from)>-\><to>";
        case E(Id from, Id to, Attrs attrs): return "<oNodeId(from)>-\><to><oAttr(attrs)>";
        ...
        case E(Id from, NodeId to, Attrs attrs): return "<from>-\><oNodeId(to)><oAttr(attrs)>";
        ...
        case E(Id from, Stm to, Attrs attrs): return "<from>-\><oStm(to)><oAttr(attrs)>";
        
        case E(NodeId from, Stm to): return "<oNodeId(from)>-\><oStm(to)>";
        case E(Id from, Stm to, Attrs attrs): return "<oNodeId(from)>-\><oStm(to)><oAttr(attrs)>";
