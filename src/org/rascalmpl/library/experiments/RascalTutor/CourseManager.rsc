              ...
              body(
               div("conceptPane",
                 div("editArea",
                    ...
                    \<div id=\"pleaseWaitMessage\"\>\<img src=\"/Courses/images/loader-light.gif\" width=\"16\" height=\"16\" /\> Processing the changes in concept <basename(cn)> and regenerating the index for course <rootname(cn)>.\</div\>
                    \</form\>"
                  ))
             ));
}
