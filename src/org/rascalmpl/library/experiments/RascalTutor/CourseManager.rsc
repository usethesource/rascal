              ...
              body(
               div("conceptPane",
                 div("editArea",
                    ...
                    \<div id=\"pleaseWaitMessage\"\>\<img src=\"/Courses/images/loader-light.gif\" width=\"16\" height=\"16\" /\> Please hold while we process the changes in concept <basename(cn)> and regenerate the index for course <rootname(cn)>.\</div\>
                    \</form\>"
                  ))
             ));
}
