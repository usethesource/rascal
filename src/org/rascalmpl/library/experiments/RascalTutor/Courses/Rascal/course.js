...
searchTerms["Rascal/Expressions/Patterns/Abstract"] = new Array("(",")","*",":","[","{",",","<","]","}",">","/");
...
searchTerms["Rascal/Expressions/Patterns/Concrete"] = new Array("`","(",")","<",">");
