...
searchTerms["Rascal/Declarations/Function"] = new Array("default","java","\"","private","(",")","public",",","throws","test","\")?","(\"","...)","{",";","|","}","=");
...
searchTerms["Rascal/Expressions/Values/String/findAll"] = null;

searchTerms["Rascal/Expressions/Values/Set/Difference"] = new Array("set",")]","(","lub","[",",","]","-");

searchTerms["Rascal/Libraries/Vis/Figure/Figures/vscrollable"] = null;
...
searchTerms["Rascal/Libraries/ParseTree/parse"] = null;

searchTerms["Rascal/Expressions/Values/List/Subscription"] = new Array("[","]","list","int");

searchTerms["Rascal/Libraries/Vis/Figure/Figures/fswitch"] = null;
...
searchTerms["Rascal/Expressions/Values/String/replaceAll"] = null;

searchTerms["Rascal/IDEConstruction/IMP"] = null;

searchTerms["Rascal/Expressions/Values/Boolean/Match"] = new Array("value",":=","bool");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/onMouseExit"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/hgrow"] = null;

searchTerms["Rascal/IDEConstruction/DocumentationHover"] = new Array("@","t","doc","=");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/hsize"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/Disambiguation/Preceed"] = new Array("<<","!<<");

searchTerms["Rascal/Libraries/Vis/Render"] = new Array("vis","::","import","Render",";");
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/hscreen"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/fontSize"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/Disambiguation/Priority"] = new Array("syntax","(","alt_2","|","=",">");
...
searchTerms["Rascal/Libraries/Java"] = new Array("primType","()","enum","private","Entity","params","null","byte","transient","returnType","anonymousClass","name","typeParameter","synchronized","void","native","extends","id","volatile","list","PrimitiveType","java","abstract","boolean","\")]);","(",")","parameter","data",",","protected","str",");","deprecated","([","extended","interface","Id",";","=","nr","\"),","enumConstant","package","double","strictfp","elementType","char","array","wildcard","[","\\","float","]","Bound","Object","method","initializer","entity","primitive","public","lang","static","constr","int","final","Modifier","class","(\"","field","/*1*/","super","long","short","variable","|","bound");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/resizable"] = null;
...
searchTerms["Rascal/Expressions/Values/String/replaceFirst"] = null;

searchTerms["Rascal/Libraries/Vis"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/shrink"] = null;
...
searchTerms["Rascal/Libraries/Graph"] = new Array("alias","T","import","&","rel","from","to","[&",";",",","=","]","];","Graph");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/onMouseDown"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/fromArrow"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/vcat"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/tree"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/ColorModel/arbColor"] = null;
...
searchTerms["Rascal/Libraries/ParseTree/unparse"] = null;

searchTerms["Rascal/Expressions/Values/String/replaceLast"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/hresizable"] = null;

searchTerms["Rascal/Libraries/ValueIO"] = new Array("import","ValueIO",";");
...
searchTerms["Rascal/Expressions/Values/String/escape"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/connect"] = null;
...
searchTerms["Rascal/Libraries/Vis/Render/render"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/checkbox"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/lineStyle"] = null;
...
searchTerms["Rascal/Libraries/PriorityQueue"] = new Array("import",";","PriorityQueue");

searchTerms["Rascal/Expressions/Values/Relation/ident"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/vresizable"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/CompositionModel"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/Disambiguation/Reserve"] = null;
...
searchTerms["Rascal/Patterns/Concrete"] = new Array("`","(",")","<",">");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/std"] = null;

searchTerms["Rascal/IDEConstruction/ErrorMarking"] = new Array("@","t","message",";","messages","l","=");
...
searchTerms["Rascal/Expressions/ConcreteSyntax"] = new Array("Pattern","p","syntax","\">\";","X","\"<\"","\\","=");

searchTerms["Rascal/Expressions/Values/List/mapper"] = null;

searchTerms["Rascal/Concepts/IntroComprehensions"] = null;

searchTerms["Rascal/Patterns/Regular"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/KeyModifier"] = new Array("modShift","()","KeyModifier","modAlt","modCommand","();","data","|","modCtrl","=");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/timer"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/onMouseMove"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/shadow"] = null;

searchTerms["Rascal/Libraries/ParseTree/implode"] = null;

searchTerms["Rascal/Expressions/Values/Map/toRel"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/hshrink"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/vstartGap"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/vconnect"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/align"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/LineDecoration"] = new Array("msg","LineDecoration","level","error","(","public",")","data",",","info","int","str","highlight",";","warning","|","=","lineNumber");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/label"] = null;
...
searchTerms["Rascal/Expressions/Values/String/contains"] = null;

searchTerms["Rascal/Patterns"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/hconnect"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/aspectRatio"] = null;

searchTerms["Rascal/Expressions/Values/List/StrictSuperList"] = new Array("bool","[","]",">","list");

searchTerms["Rascal/Expressions/Reducer"] = new Array("(",")","|",",");

searchTerms["Rascal/Expressions/Selection"] = new Array("@","node","<:");
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/combo"] = null;
...
searchTerms["Rascal/Patterns/PatternWithAction"] = new Array("=>",":");
...
searchTerms["Rascal/Libraries/Vis/Render/renderSave"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/vendGap"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/shadowPos"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/Disambiguation/Follow"] = new Array(">>","!>>");

searchTerms["Rascal/Libraries/Vis/Figure/Figures"] = new Array("alias","Figure","[","=","];","list","Figures");

searchTerms["Rascal/Libraries/Vis/Figure/Figures/graph"] = null;

searchTerms["Rascal/IDEConstruction/Plugin"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/scale"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/manhattan"] = null;
...
searchTerms["Rascal/Libraries/JDT"] = new Array("each","All","ast","Entity","level","between","name","other","declaredFields","collections","EntityRel","declaredMethods","defines","extends","rel","qualified","which","initialization","@//","ModifierRel","certain","implement","classes","that","methodDecls","parameter","from","been",",","-","an","anno","Resource","fieldDecls","implements","methods","at","location","Maps","relationship","declarations","constructors","fields","declared","type",";","=","@","loc","entities","A","package","represented","for","uses","two","alias","calls","top","inner","and","modifier","of","by","interfaces","their","[","Modifiers","call","EntitySet","//","method","Entities","a","set","entity","mappings","have","public","local","shorthand","any","code","packages","hand","the","declaredSubTypes","BindingRel","variables","Modifier","class","types","field","constructor","to","modifiers","variable","short","Which","declaredTopTypes","];");

searchTerms["Rascal/Libraries/Vis/Figure/Figures/treemap"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/pack"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/startGap"] = null;
...
searchTerms["Rascal/Libraries/Resources"] = new Array("loc","::","root","set","util","Resources","import","(",")","data",",","folder","Resource",");","project","projects","contents","[","id",";","file","|","=","]");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/valign"] = null;

searchTerms["Rascal/Libraries/JDT/extractProject"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/shadowColor"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/ialign"] = new Array("align","num","(",")","FProperty","ialign");

searchTerms["Rascal/IDEConstruction/Hyperlinking"] = new Array("@","t","links","link","=");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/onMouseEnter"] = null;

searchTerms["Rascal/Libraries/ValueIO/readTextValueString"] = null;

searchTerms["Rascal/Expressions/Values/Map/domain"] = null;

searchTerms["Rascal/Libraries/RSF"] = new Array("import","RSF",";");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/hgap"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/hshadowPos"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/onKeyDown"] = null;
...
searchTerms["Rascal/Libraries/Vis/TestVis"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/KeySym"] = new Array("keyKeypad3","keyKeypad4","()","keyKeypad5","keyKeypad6","keyKeypad7","keyKeypad8","keyKeypad9","KeySym","keyShiftLeft","keyKeypadAdd","keyCommandRight","keyArrowLeft","keyCommandLeft","keyPrintScreen","keyControlLeft","keyArrowUp","keyF10","keyF11","keyF12","(","keyF13",")","keyF14","data","keyCapsLock","keyF15","keyArrowDown","keyF16","keyF17","keyF18","keyF19","str",");","keyTab","keyEnter","=","keyControlRight","keyKeypadDecimal","keyHelp","keyEscape","keyBackSpace","keyF20","keyKeypadSubtract","keyPageUp","keyF1","keyF2","keyF3","keyF4","keyF5","keyF6","keyPageDown","keyF7","keyF8","keyArrowRight","keyF9","keyScrollLock","keyPause","keyKeypadMultiply","keyHome","key","keyBreak","keyKeypadEqual","keyKeypadCr","keyPrintable","keyUnknown","keyKeypadDivide","keyCode","int","keyAltLeft","keyNumLock","keyAltRight","keyInsert","keyShiftRight","keyEnd","|","keyKeypad0","keyKeypad1","keyKeypad2");
...
searchTerms["Rascal/Declarations/SyntaxDefinition/Disambiguation/Associativity"] = new Array("syntax","assoc","left","(",")","|","right","=","-","non");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/endGap"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/orientation"] = new Array("Orientation","()","downTop","rightLeft","leftRight","topDown","();","data","|","=");
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/vscreen"] = null;

searchTerms["Rascal/Libraries/IO"] = new Array("import","IO",";");

searchTerms["Rascal/Expressions/Values/List/domain"] = null;

searchTerms["Rascal/Statements/Append"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/project"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/fontColor"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/overlay"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/fontNames"] = null;

searchTerms["Rascal/Expressions/Values/String/isEmpty"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/halign"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure"] = new Array("vis","::","Figure","import",";");
...
searchTerms["Rascal/Expressions/Replacement"] = new Array("[@","=","]");
...
searchTerms["Rascal/Libraries/LabeledGraph"] = new Array("alias","LGraph","label","T","import","&","rel","from","to","[&",";","LabeledGraph","L",",","=","]","];");

searchTerms["Rascal/Expressions/Operators"] = null;

searchTerms["Rascal/Expressions/Values/List/index"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/text"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/vgrow"] = null;

searchTerms["Rascal/Libraries/Message"] = new Array("loc","msg","str",");","at","Message","(","error",")","data","|","warning",",","=","info");

searchTerms["Rascal/Expressions/Values/Boolean/fromInt"] = null;

searchTerms["Rascal/IDEConstruction/Outline"] = null;

searchTerms["Rascal/IDEConstruction/Folding"] = new Array("@","a","syntax","foldable",";","=","true");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/onKeyUp"] = null;

searchTerms["Rascal/Statements/Insert"] = new Array("insert",";");

searchTerms["Rascal/Declarations/SyntaxDefinition/Action"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/rotate"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/vsize"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/area"] = null;

searchTerms["Rascal/Declarations/SyntaxDefinition"] = new Array("start","syntax","lexical","left","(","keyword",")","layout","non","-","assoc",":",";","|","right","=",">");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/layer"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/justify"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/AmbiguityDiagnosis"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/scrollable"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Figures/hvcat"] = null;

searchTerms["Rascal/Statements/For"] = new Array("(","for",")",";",",");

searchTerms["Rascal/Libraries/Benchmark"] = new Array("import",";","Benchmark");
...
searchTerms["Rascal/Libraries/ParseTree"] = new Array("ParseTree","import",";");
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/font"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/hendGap"] = null;

searchTerms["Rascal/Libraries/Resources/getProject"] = null;

searchTerms["Rascal/Libraries/Graph/bottom"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/fillColor"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/toArrow"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Properties/grow"] = null;
...
searchTerms["Rascal/Declarations/SyntaxDefinition/AmbiguityDetection"] = null;

searchTerms["Rascal/Declarations/SyntaxDefinition/Symbol"] = new Array("||","&&","@",">>","<<","\\\\","!","()","!>>","!<<","\"","\'","(",")","*","+","-","}+","Class","[","{","|","]","^","?");

searchTerms["Rascal/Libraries/Vis/Figure/Properties/size"] = null;

searchTerms["Rascal/Statements/Test"] = null;
...
searchTerms["Rascal/Libraries/Vis/Figure/Figures/scaleSlider"] = null;

searchTerms["Rascal/Expressions/Values/Range"] = new Array("..","[",",","]");

searchTerms["Rascal/Libraries/Benchmark/cpuTime"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/onMouseUp"] = null;

searchTerms["Rascal/Libraries/PriorityQueue/isEmpty"] = null;

searchTerms["Rascal/Libraries/Vis/Figure/Properties/vshrink"] = null;
