module experiments::vis2::Steden
...
*/
public map[str, lrel[str, int]] exampleVegaBarData() {
   lrel[str, int, int , int] v = 
      sort(toList(readCSV(#rel[str name, int p2012, int p2013, int ext], location, header=true)), 
