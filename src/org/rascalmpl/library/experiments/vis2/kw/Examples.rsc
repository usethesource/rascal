module experiments::vis2::kw::Examples
...
void ex10(){
	ex("ex10", box(fig=box(fillColor="white", size=<50,100>), fillColor="blue", size=<200,200>));
} 

void ex11(){
	ex("ex11", box(fillColor="blue", size=<200,200>, gap=<0,0>,
				   fig=box(fillColor="white", size=<50,100>, align=<left(), top()>)));
} 

void ex12(){
	ex("ex12", box(fig-box(fillColor="white", size=<50,100>, align=<right(), top()>), fillColor="blue", size=<200,200>, gap=<0,0>));
} 

void ex13(){
	ex("ex13", box(fig=box(fillColor="white", size=<50,100>, align=<right(), bottom()>), fillColor="blue", size=<200,200>, gap=<0,0>));
} 
