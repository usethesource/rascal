...
module experiments::Compiler::Benchmarks::fca::FCA
...
//public FormalContext[&Object, &Attribute] toFormalContext(Attribute2Objects[&Attribute, &Object] attributes) {
...
@reflect
public java value typeOf(value v);
