...
//private MuExp generateMuCode("ALL", list[MuExp] exps, list[bool] backtrackfree, loc src) {
...
//}
//
//private MuExp generateMuCode("OR", list[MuExp] exps, list[bool] backtrackfree, loc src) {
