...
value run3() = execute("module TMP import lang::rascal::\\syntax::Rascal; import ParseTree; value main(list[value] args) = #Statement;");
value run4() = execute("module TMP import experiments::Compiler::muRascal2RVM::B; import ParseTree; value main(list[value] args) = #A;");
