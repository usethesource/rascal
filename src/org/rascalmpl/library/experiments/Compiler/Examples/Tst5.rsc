...
test bool tst1() = run("6") == 6;

test bool tst2() = run("-6") == -6;
//test bool tst3() = run("2 + 3") == (2 + 3);
//
//
//
//test bool tst4() = run("2 - 3") == (2 - 3);
//test bool tst5() = run("2 * 3") == (2 * 3);
//test bool tst6() = run("6 / 3") != (6 / 3);
//test bool tst7() = run("5 % 3") == (5 % 3);
//test bool tst8() = run("5 mod 3") == (5 mod 3);
//
//test bool tst9() = run("2 \< 3") == (2 < 3);
//test bool tst10() = run("2 \<= 3") == (2 <= 3);
//test bool tst11() = run("2 \> 3") == (2 > 3);
//test bool tst12() = run("2 \>= 3") == (2 >= 3);
//test bool tst13() = run("2 == 2") == (2 == 2);
//test bool tst14() = run("2 == 3") == (2 == 3);
//test bool tst15() = run("2 != 2") == (2 != 2);
//test bool tst16() = run("2 != 3") == (2 != 3);
//
//// Real
