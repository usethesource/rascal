...
test bool tst1() = run("{ x = 1; x; }") == {x = 1; x;};
test bool tst2() = run("{ x = 10; x += 5; x; }") == {x = 10; x += 5; x;};
test bool tst3() = run("{ x = 10; x -= 5; x; }") == {x = 10; x -= 5; x;};
test bool tst() = run("{ x = 10; x *= 5; x; }") == {x = 10; x *= 5; x;};
test bool tst() = run("{ x = 10; x /= 5; x; }") == {x = 10; x /= 5; x;};
test bool tst() = run("{ x = {1,2,3}; x &= {3,4}; x; }") == { x = {1,2,3}; x &= {3,4}; x; };

value main(list[value] args) = run("{ \<x, y\> = \<1,2\>;  x + y; }");
