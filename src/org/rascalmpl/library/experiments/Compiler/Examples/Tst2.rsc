...
value main(list[value] args) = newGenerate("org.rascalmpl.library.lang.rascal.grammar.tests", "G0Parser", G0);// == readFile(|rascal:///lang/rascal/grammar/tests/G0Parser.java|);
