...
private rel[Symbol,Symbol] getDependencies(s1: Symbol::\set(Symbol s2)) = <s1, s2> + getDependencies(s2);
...
private rel[Symbol,Symbol] getDependencies(s1: Symbol:\lrel(list[Symbol] symbols)) = 
	{ <s1, Symbol::\tuple(symbols)> } + {<s1, s2> | s2 <- symbols} + {*getDependencies(s2) | s2 <- symbols};
private rel[Symbol,Symbol] getDependencies(s1: Symbol::\tuple(list[Symbol] symbols)) = {<s1, s2> | s2 <- symbols} + {*getDependencies(s2) | s2 <- symbols};
private rel[Symbol,Symbol] getDependencies(s1: Symbol::\list(Symbol s2)) = <s1, s2> + getDependencies(s2);
