...
public MuExp translateVisit(Label label, lang::rascal::\syntax::Rascal::Visit \visit) {	
	...
	addFunctionToModule(muFunction(phi_fuid, "PHI", phi_ftype, scopeId, NumberOfPhiFormals, pos_in_phi, false, false, \visit@\loc, [], (), false, 0, 0, body));
...
private MuExp translateComprehension(c: (Comprehension) `[ <{Expression ","}+ results> | <{Expression ","}+ generators> ]`) {
    ...
    listwriter_open_code = muCallPrim3("listwriter_open", [], c@\loc);
...
private MuExp translateComprehension(c: (Comprehension) `{ <{Expression ","}+ results> | <{Expression ","}+ generators> }`) {
    ...
    setwriter_open_code = muCallPrim3("setwriter_open", [], c@\loc);
...
private MuExp translateComprehension(c: (Comprehension) `(<Expression from> : <Expression to> | <{Expression ","}+ generators> )`) {
    ...
    mapwriter_open_code = muCallPrim3("mapwriter_open", [], c@\loc);
