...
public class BytecodeGenerator implements Opcodes {
	...
	public void closeMethod() {
		if (!emit)
			return;
		if (exitLabel != null) { // This label should never be reached, it is placed to
								 // keep JVM verifier happy. (Reason: code generated by compiler jumps to non existing location) 
