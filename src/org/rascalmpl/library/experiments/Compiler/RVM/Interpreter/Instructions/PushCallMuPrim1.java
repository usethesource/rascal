...
public class PushCallMuPrim1 extends Instruction {

	MuPrimitive muprim;

	public PushCallMuPrim1(CodeBlock ins, MuPrimitive muprim) {
		super(ins, Opcode.PUSHCALLMUPRIM1);
		this.muprim = muprim;
	}

	public String toString() {
		return "PUSHCALLMUPRIM1 " + muprim ;
	}
