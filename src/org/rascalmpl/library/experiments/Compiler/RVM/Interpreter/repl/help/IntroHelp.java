...
public class IntroHelp {
	...
	static String[] helpText = {
				...
				"    break <function>       Breakpoint at start of <function>",
				"    break <module> <lino>  Breakpoint in <module> at line <lino>",
				"    clear <bpnos>          Clear breakpoints with <bpnos>",
				"    disable <bpnos>        Disable breakpoints <bpnos> (empty list enables all)",
				"    enable <bpnos>         Enable breakpoints <bpnos> (empty list disables all)",
				"    ignore <bpno> <count>  Ignore breakpoint <bpno> for <count> times",
				"    quit                   Quit debugger",
				"",
				"Keyboard essentials:",
