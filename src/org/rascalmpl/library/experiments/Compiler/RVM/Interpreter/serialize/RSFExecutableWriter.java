...
//	}
//	
//	public void writeField(int fieldId, int l) throws IOException {
//        valueWriter.getWriter().writeField(fieldId, l);
//    }
//
//	private void writeLong(long l) throws IOException {
//		valueWriter.getWriter().writeInt64NoTag(l);
//	}
//	
//	 public void writeField(int fieldId, long[] la) throws IOException {
//		int n = la == null ? 0 : la.length;
//		valueWriter.writeField(fieldId, n);
...
//	}
//
//	public void writeField(int fieldId, Map<String, Integer> map) throws IOException {
//
...
//
//			valueWriter.getWriter().writeField(fieldId,  n);
//			
...
//			}
//		} else {
//		    valueWriter.getWriter().writeField(1234, mapId);
//		}
//	}
//
...
//	}
//
//    public void writeField(int fieldId, String s) throws IOException {
//        valueWriter.getWriter().writeField(fieldId,  s);
//        
//    }
