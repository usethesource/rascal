...
data Condition
     ...
     | \far-follow(Symbol symbol) 
     | \far-not-follow(Symbol symbol)
     | \far-precede(Symbol symbol)
     | \far-not-precede(Symbol symbol)
...
@javaClass{org.rascalmpl.library.Prelude}
@reflect{uses information about syntax definitions at call site}
public java void generate(type[&T<:Tree] begin);

@javaClass{org.rascalmpl.library.Prelude}
@reflect{uses information about syntax definitions at call site}
public java void save(type[&T<:Tree] begin, str path);
