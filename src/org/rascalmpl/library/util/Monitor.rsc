...
@javaClass{org.rascalmpl.library.util.Monitor}
public java void jobStep(str label="", int work = 1);

@javaClass{org.rascalmpl.library.util.Monitor} 
public java int jobEnd(bool success=true);

@javaClass{org.rascalmpl.library.util.Monitor} 
public java void jobTodo(int work=100);

@javaClass{org.rascalmpl.library.util.Monitor} 
public java void jobIsCancelled();
