...
public class CourseCompiler {
	...
	static void runAsciiDoctor(Asciidoctor asciidoctor,
							   Path srcPath,
							   String courseName,
							   Path destPath,
	...
	static void runAsciiDoctorCommand(String classpath,
									  Path srcPath,
									  String courseName,
									  Path destPath,
									  PrintWriter err) throws IOException {
	...
	public static void compileCourse(Path srcPath,
									 String courseName,
									 Path destPath,
									 Path libSrcPath,
									 PathConfig pcfg,
	...
	public static void compileCourse(Asciidoctor dr,
									 Path srcPath,
									 String courseName,
									 Path destPath,
									 Path libSrcPath,
		...
		Onthology
			o = new Onthology(srcPath, courseName, destPath, libSrcPath, pcfg, executor);
	...
	public static void compileCourseCommand(String classpath,
											Path srcPath,
											String courseName,
											Path destPath,
											Path libSrcPath,
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		cmdOpts
			.locsOption("course")
			.locsDefault(cmdOpts.getDefaultCourses().isEmpty() ? vf.list(cmdOpts.getDefaultCourses())
															   : cmdOpts.getDefaultCourses())
			.respectNoDefaults()
			.help("Add (absolute!) course location, use multiple --course arguments for multiple locations")

			.locsOption("src")
			.locsDefault(cmdOpts.getDefaultStdlocs().isEmpty() ? vf.list(cmdOpts.getDefaultStdlocs())
		...
		System.err.println(
			String.format("Course compilation done after %,d ms\n", TimeUnit.NANOSECONDS.toMillis(duration)));
	}
}
