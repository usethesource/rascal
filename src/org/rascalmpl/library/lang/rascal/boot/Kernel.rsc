...
RVMProgram compileAndLink(loc rascalSource,  bool firstTime, bool useJVM=false, bool serialize=true, bool verbose = false, loc bindir = |home:///bin|) =
     experiments::Compiler::Execute::compileAndLink(rascalSource, firstTime, useJVM=useJVM, serialize=serialize, verbose = verbose, bindir = bindir);
