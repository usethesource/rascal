module lang::rascal::tests::functionality::PatternTestsList3Test
...
test bool matchList50() = ([DATA X2, DATA Y, c()] !:= [a(), b()]);
  
test bool matchList51() = ([e(int X3), b()] := [e(3), b()]) && (X3 == 3);
test bool matchList52() = ([e(int X4)] := [e(3)]) && (X4 == 3);
test bool matchList53() = ([e(int X5)] !:= [a()]);
  
test bool matchList54() = ([a(), f([a(), b(), DATA X6])] := [a(), f([a(),b(),c()])]) && (X6 == c());
  
test bool matchList55() = ([a(), f([a(), b(), DATA X7]), *DATA Y7] := [a(), f([a(),b(),c()]), b()]) && (X7 == c() && Y7 == [b()]);
test bool matchList56() = ([DATA A1, f([A1, b(), DATA X8])] := [a(), f([a(),b(),c()])]) && (A1 == a());
test bool matchList57() = ([A1, f([A1, b(), DATA X8])] := [a(), f([a(),b(),c()])]) && (A1 == a());
  		
test bool matchList58() = ([f([DATA A1, b(), DATA X8]), A1] := [f([a(),b(),c()]), a()]) && (A1 == a());
test bool matchList59() = ([f([A1, b(), DATA X8]), A1] := [f([a(),b(),c()]), a()]) && (A1 == a());
...
test bool matchListSet11() = ([DATA A1, f({A1, b(), DATA X10})] := [a(), f({a(),b(),c()})]) && (A1 == a());
test bool matchListSet12() = ({DATA A2, f([A2, b(), DATA X11])} := {a(), f([a(),b(),c()])}) && (A2 == a());
