...
test bool assertTrue9() {void f(){ } f(); return true;}
  		
test bool assertTrue10() {
	int fac(int n){ return (n <= 0) ? 1 : (n * fac(n - 1));}
		    
	return fac(0) == 1 && fac(1)==1 && fac(2)== 2 && fac(3)==6 && fac(4)==24;
}
...
test bool formalsAreLocal11(){
    int fac(int n) { if (n == 0) { return 1; } int z = n; int m = fac(n - 1); return z * m; }
	return fac(0) == 1;
}
  	 	
test bool formalsAreLocal12(){
	int fac(int n) { if (n == 0) { return 1; } int z = n; int m = fac(n - 1); return z * m; }
	return fac(1) == 1;
}
  	 	
test bool formalsAreLocal13(){
	int fac(int n) { if (n == 0) { return 1; } int z = n; int m = fac(n - 1); return z * m; }
	return fac(2) == 2;
}
  	 	
test bool formalsAreLocal14(){
	int fac(int n) { if (n == 0) { return 1; } int z = n; int m = fac(n - 1); return z * m; }
	return fac(3) == 6;
}
  	 	
test bool formalsAreLocal15(){
  		 int fac(int n) { if (n == 0) { return 1; } int z = n; int m = fac(n - 1); return z * m; }
  		 return fac(4) == 24;
  	 	}
