...
public class RascalRascal extends org.rascalmpl.parser.gtd.SGTDBF<IConstructor, IConstructor, ISourceLocation> {
  ...
  protected static IntegerKeyedHashMap<IntegerList> _initDontNest() {
    ...
    _putDontNest(result, -2411, -2677);
    
    _putDontNest(result, -2436, -2567);
    ...
    _putDontNest(result, -2311, -2521);
    
    _putDontNest(result, -2411, -2557);
    
    _putDontNest(result, -2400, -2530);
    ...
    _putDontNest(result, -2436, -2647);
    
    _putDontNest(result, -2535, -2686);
    
    _putDontNest(result, -2541, -2632);
    
    _putDontNest(result, -2465, -2612);
    
    _putDontNest(result, -2465, -2550);
    
    _putDontNest(result, -2603, -2667);
    
    _putDontNest(result, -2563, -2627);
    
    _putDontNest(result, -2384, -2572);
    
    _putDontNest(result, -2422, -2642);
    ...
    _putDontNest(result, -2411, -2597);
    
    _putDontNest(result, -2400, -2572);
    
    _putDontNest(result, -2389, -2567);
    ...
    _putDontNest(result, -2465, -2577);
    
    _putDontNest(result, -2298, -2607);
    
    _putDontNest(result, -2389, -2527);
    
    _putDontNest(result, -2400, -2514);
    ...
    _putDontNest(result, -2400, -2652);
    
    _putDontNest(result, -2389, -2647);
    ...
    _putDontNest(result, -2422, -2562);
    
    _putDontNest(result, -2384, -2652);
    ...
    _putDontNest(result, -2384, -2535);
    
    _putDontNest(result, -2326, -2521);
    ...
    _putDontNest(result, -2436, -2524);
    
    _putDontNest(result, -2400, -2535);
    ...
    _putDontNest(result, -2422, -2647);
    
    _putDontNest(result, -2400, -2617);
    ...
    _putDontNest(result, -2389, -2562);
    
    _putDontNest(result, -2384, -2617);
    ...
    _putDontNest(result, -2389, -2642);
    
    _putDontNest(result, -2546, -2622);
    
    _putDontNest(result, -2465, -2627);
    
    _putDontNest(result, -2436, -2672);
    
    _putDontNest(result, -2326, -2592);
    ...
    _putDontNest(result, -2411, -2667);
    
    _putDontNest(result, -2326, -2612);
    ...
    _putDontNest(result, -2400, -2587);
    
    _putDontNest(result, -2389, -2592);
    
    _putDontNest(result, -415, -430);
    
    _putDontNest(result, -2499, -2530);
    
    _putDontNest(result, -2311, -2527);
    ...
    _putDontNest(result, -2389, -2657);
    
    _putDontNest(result, -2311, -2647);
    
    _putDontNest(result, -2546, -2627);
    
    _putDontNest(result, -2465, -2622);
    
    _putDontNest(result, -2524, -2677);
    
    _putDontNest(result, -2384, -2587);
    ...
    _putDontNest(result, -2436, -2545);
    
    _putDontNest(result, -2389, -2521);
    ...
    _putDontNest(result, -2422, -2612);
    
    _putDontNest(result, -2384, -2602);
    ...
    _putDontNest(result, -2400, -2602);
    
    _putDontNest(result, -2535, -2612);
    
    _putDontNest(result, -2550, -2567);
    
    _putDontNest(result, -2465, -2686);
    
    _putDontNest(result, -2436, -2592);
    ...
    _putDontNest(result, -2411, -2662);
    
    _putDontNest(result, -2422, -2657);
    
    _putDontNest(result, -2546, -2672);
    
    _putDontNest(result, -2436, -2622);
    ...
    _putDontNest(result, -2389, -2612);
    
    _putDontNest(result, -2558, -2652);
    
    _putDontNest(result, -2551, -2647);
    
    _putDontNest(result, -2465, -2535);
    ...
    _putDontNest(result, -2384, -2607);
    
    _putDontNest(result, -2411, -2582);
    ...
    _putDontNest(result, -2400, -2607);
    
    _putDontNest(result, -2326, -2657);
    ...
    _putDontNest(result, -2411, -2657);
    
    _putDontNest(result, -2422, -2662);
    ...
    _putDontNest(result, -2400, -2672);
    
    _putDontNest(result, -2311, -2597);
    
    _putDontNest(result, -2389, -2667);
    ...
    _putDontNest(result, -2436, -2627);
    
    _putDontNest(result, -2465, -2672);
    
    _putDontNest(result, -2465, -2530);
    ...
    _putDontNest(result, -2411, -2521);
    
    _putDontNest(result, -2311, -2557);
    ...
    _putDontNest(result, -2384, -2637);
    
    _putDontNest(result, -2465, -2607);
    
    _putDontNest(result, -2436, -2572);
    ...
    _putDontNest(result, -2400, -2637);
    
    _putDontNest(result, -2422, -2667);
    ...
    _putDontNest(result, -2326, -2667);
    
    _putDontNest(result, -2411, -2612);
    ...
    _putDontNest(result, -2400, -2686);
    
    _putDontNest(result, -2536, -2677);
    
    _putDontNest(result, -2512, -2637);
    
    _putDontNest(result, -2465, -2602);
    
    _putDontNest(result, -2422, -2577);
    
    _putDontNest(result, -2389, -2557);
    ...
    _putDontNest(result, -2384, -2686);
    
    _putDontNest(result, -2550, -2667);
    
    _putDontNest(result, -2436, -2617);
    ...
    _putDontNest(result, -2400, -2622);
    
    _putDontNest(result, -2326, -2632);
    ...
    _putDontNest(result, -2411, -2647);
    
    _putDontNest(result, -2384, -2622);
    ...
    _putDontNest(result, -2436, -2557);
    
    _putDontNest(result, -2411, -2527);
    ...
    _putDontNest(result, -2411, -2567);
    
    _putDontNest(result, -2389, -2597);
    ...
    _putDontNest(result, -2384, -2627);
    
    _putDontNest(result, -2389, -2632);
    ...
    _putDontNest(result, -2400, -2627);
    
    _putDontNest(result, -2422, -2677);
    ...
    _putDontNest(result, -2411, -2577);
    
    _putDontNest(result, -2298, -2550);
    
    _putDontNest(result, -2499, -2557);
    
    _putDontNest(result, -2422, -2535);
    ...
    _putDontNest(result, -2326, -2597);
    
    _putDontNest(result, -2541, -2637);
    
    _putDontNest(result, -2550, -2632);
    
    _putDontNest(result, -2436, -2602);
    
    _putDontNest(result, -2527, -2592);
    
    _putDontNest(result, -2524, -2577);
    
    _putDontNest(result, -2400, -2592);
    
    _putDontNest(result, -2389, -2587);
    ...
    _putDontNest(result, -2465, -2617);
    
    _putDontNest(result, -2557, -2637);
    
    _putDontNest(result, -2521, -2657);
    
    _putDontNest(result, -2384, -2592);
    ...
    _putDontNest(result, -2400, -2521);
    
    _putDontNest(result, -2311, -2530);
    ...
    _putDontNest(result, -2326, -2677);
    
    _putDontNest(result, -2546, -2572);
    
    _putDontNest(result, -2298, -2562);
    
    _putDontNest(result, -2384, -2521);
    
    _putDontNest(result, -2326, -2535);
    ...
    _putDontNest(result, -2411, -2637);
    
    _putDontNest(result, -2436, -2607);
    
    _putDontNest(result, -2465, -2572);
    ...
    _putDontNest(result, -2422, -2602);
    
    _putDontNest(result, -2384, -2612);
    ...
    _putDontNest(result, -2384, -2657);
    
    _putDontNest(result, -2499, -2677);
    
    _putDontNest(result, -2545, -2557);
    
    _putDontNest(result, -2422, -2545);
    ...
    _putDontNest(result, -2400, -2657);
    
    _putDontNest(result, -2326, -2607);
    ...
    _putDontNest(result, -2465, -2667);
    
    _putDontNest(result, -45, -114);
    
    _putDontNest(result, -2326, -2545);
    ...
    _putDontNest(result, -2389, -2514);
    
    _putDontNest(result, -2400, -2527);
    ...
    _putDontNest(result, -2465, -2557);
    
    _putDontNest(result, -2384, -2527);
    ...
    _putDontNest(result, -2326, -2652);
    
    _putDontNest(result, -2411, -2627);
    
    _putDontNest(result, -2540, -2637);
    
    _putDontNest(result, -2512, -2657);
    
    _putDontNest(result, -2465, -2582);
    ...
    _putDontNest(result, -2436, -2597);
    
    _putDontNest(result, -2531, -2632);
    
    _putDontNest(result, -2436, -2521);
    ...
    _putDontNest(result, -2422, -2652);
    
    _putDontNest(result, -2389, -2617);
    
    _putDontNest(result, -2384, -2562);
    ...
    _putDontNest(result, -2400, -2562);
    
    _putDontNest(result, -2465, -2662);
    
    _putDontNest(result, -2550, -2607);
    
    _putDontNest(result, -2541, -2642);
    
    _putDontNest(result, -2465, -2587);
    ...
    _putDontNest(result, -2400, -2642);
    
    _putDontNest(result, -2535, -2572);
    
    _putDontNest(result, -2436, -2677);
    
    _putDontNest(result, -61, -121);
    
    _putDontNest(result, -2311, -2535);
    ...
    _putDontNest(result, -2384, -2642);
    
    _putDontNest(result, -2422, -2572);
    ...
    _putDontNest(result, -2400, -2557);
    
    _putDontNest(result, -2411, -2530);
    ...
    _putDontNest(result, -2465, -2527);
    
    _putDontNest(result, -2384, -2557);
    ...
    _putDontNest(result, -2384, -2567);
    
    _putDontNest(result, -2465, -2677);
    ...
    _putDontNest(result, -2400, -2567);
    
    _putDontNest(result, -2389, -2572);
    
    _putDontNest(result, -2527, -2567);
    
    _putDontNest(result, -2551, -2607);
    
    _putDontNest(result, -2411, -2514);
    ...
    _putDontNest(result, -2389, -2652);
    
    _putDontNest(result, -2400, -2647);
    
    _putDontNest(result, -2422, -2617);
    ...
    _putDontNest(result, -2411, -2622);
    
    _putDontNest(result, -2384, -2647);
    
    _putDontNest(result, -2436, -2662);
    ...
    _putDontNest(result, -2400, -2632);
    
    _putDontNest(result, -2326, -2622);
    ...
    _putDontNest(result, -2411, -2592);
    
    _putDontNest(result, -421, -430);
    
    _putDontNest(result, -2422, -2540);
    ...
    _putDontNest(result, -2389, -2627);
    
    _putDontNest(result, -2384, -2632);
    
    _putDontNest(result, -2545, -2632);
    
    _putDontNest(result, -2540, -2627);
    
    _putDontNest(result, -2400, -2577);
    
    _putDontNest(result, -2326, -2524);
    ...
    _putDontNest(result, -2384, -2577);
    
    _putDontNest(result, -2298, -2627);
    
    _putDontNest(result, -2524, -2535);
    
    _putDontNest(result, -2436, -2527);
    
    _putDontNest(result, -2411, -2545);
    ...
    _putDontNest(result, -2422, -2622);
    
    _putDontNest(result, -2465, -2632);
    
    _putDontNest(result, -2541, -2612);
    
    _putDontNest(result, -2512, -2647);
    
    _putDontNest(result, -2326, -2540);
    ...
    _putDontNest(result, -2465, -2647);
    
    _putDontNest(result, -2436, -2612);
    ...
    _putDontNest(result, -2465, -2567);
    
    _putDontNest(result, -2311, -2524);
    
    _putDontNest(result, -2389, -2550);
    ...
    _putDontNest(result, -2400, -2677);
    
    _putDontNest(result, -2422, -2627);
    ...
    _putDontNest(result, -2411, -2652);
    
    _putDontNest(result, -2326, -2627);
    ...
    _putDontNest(result, -2400, -2597);
    
    _putDontNest(result, -2411, -2572);
    ...
    _putDontNest(result, -2465, -2524);
    
    _putDontNest(result, -2512, -2545);
    
    _putDontNest(result, -2422, -2550);
    ...
    _putDontNest(result, -2389, -2637);
    
    _putDontNest(result, -2422, -2672);
    
    _putDontNest(result, -2551, -2672);
    
    _putDontNest(result, -2465, -2642);
    ...
    _putDontNest(result, -2400, -2662);
    
    _putDontNest(result, -2536, -2637);
    
    _putDontNest(result, -2512, -2677);
    
    _putDontNest(result, -2465, -2562);
    ...
    _putDontNest(result, -2384, -2662);
    
    _putDontNest(result, -2550, -2627);
    
    _putDontNest(result, -2499, -2577);
    
    _putDontNest(result, -2465, -2540);
    ...
    _putDontNest(result, -2411, -2607);
    
    _putDontNest(result, -2384, -2582);
    ...
    _putDontNest(result, -2436, -2657);
    
    _putDontNest(result, -2530, -2567);
    
    _putDontNest(result, -2326, -2550);
    ...
    _putDontNest(result, -2400, -2667);
    
    _putDontNest(result, -2422, -2637);
    
    _putDontNest(result, -2389, -2672);
    
    _putDontNest(result, -2551, -2627);
    
    _putDontNest(result, -2536, -2686);
    
    _putDontNest(result, -2436, -2642);
    ...
    _putDontNest(result, -2411, -2602);
    
    _putDontNest(result, -2521, -2617);
    
    _putDontNest(result, -2465, -2657);
  ...
  protected static IntegerMap _initDontNestGroups() {
    ...
    result.putUnsafe(-2465, resultStoreId);
    ...
    result.putUnsafe(-2384, resultStoreId);
    ++resultStoreId;
  ...
  private static final IConstructor prod__prev_$Expression__conditional__lit_prev__not_precede__char_class___range__65_90_range__95_95_range__97_122_not_follow__char_class___range__65_90_range__95_95_range__97_122_ = (IConstructor) _read("prod(label(\"prev\",sort(\"Expression\")),[conditional(lit(\"prev\"),{\\not-precede(\\char-class([range(65,90),range(95,95),range(97,122)])),\\not-follow(\\char-class([range(65,90),range(95,95),range(97,122)]))})],{})", Factory.Production);
  ...
  private static final IConstructor prod__openRecursiveAddition_$Expression__lhs_$Expression_$layouts_LAYOUTLIST_lit___43_43_$layouts_LAYOUTLIST_rhs_$Expression__assoc__left = (IConstructor) _read("prod(label(\"openRecursiveAddition\",sort(\"Expression\")),[label(\"lhs\",sort(\"Expression\")),layouts(\"LAYOUTLIST\"),lit(\"++\"),layouts(\"LAYOUTLIST\"),label(\"rhs\",sort(\"Expression\"))],{assoc(left())})", Factory.Production);
  ...
  private static final IConstructor prod__transitiveClosure_$Expression__argument_$Expression_$layouts_LAYOUTLIST_conditional__lit___43__not_follow__char_class___range__43_43_range__61_61_ = (IConstructor) _read("prod(label(\"transitiveClosure\",sort(\"Expression\")),[label(\"argument\",sort(\"Expression\")),layouts(\"LAYOUTLIST\"),conditional(lit(\"+\"),{\\not-follow(\\char-class([range(43,43),range(61,61)]))})],{})", Factory.Production);
  ...
  protected static class $Expression {
    ...
    protected static final void _init_prod__transitiveReflexiveClosure_$Expression__argument_$Expression_$layouts_LAYOUTLIST_conditional__lit___42__not_follow__lit___61_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(-2300, 2, prod__lit___42__char_class___range__42_42_, new int[] {42}, null, new ICompletionFilter[] {new StringFollowRestriction(new int[] {61})});
    ...
    protected static final void _init_prod__callOrTree_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___40_$layouts_LAYOUTLIST_arguments_iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___41_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[6] = new LiteralStackNode<IConstructor>(-2321, 6, prod__lit___41__char_class___range__41_41_, new int[] {41}, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2320, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(-2315, 4, regular__iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2316, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2317, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2318, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2319, 3, "$layouts_LAYOUTLIST", null, null)}, false, null, null);
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(-2313, 2, prod__lit___40__char_class___range__40_40_, new int[] {40}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2314, 3, "$layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_prod__subscript_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___91_$layouts_LAYOUTLIST_subscripts_iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___93_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[6] = new LiteralStackNode<IConstructor>(-2336, 6, prod__lit___93__char_class___range__93_93_, new int[] {93}, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2335, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(-2330, 4, regular__iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2331, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2332, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2333, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2334, 3, "$layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2329, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2328, 2, prod__lit___91__char_class___range__91_91_, new int[] {91}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2327, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2326, 0, "$Expression", null, null);
    ...
    protected static final void _init_prod__qualifiedName_$Expression__qualifiedName_$QualifiedName_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2410, 0, "$QualifiedName", null, null);
    ...
    protected static final void _init_prod__list_$Expression__lit___91_$layouts_LAYOUTLIST_elements_iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___93_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new LiteralStackNode<IConstructor>(-2310, 4, prod__lit___93__char_class___range__93_93_, new int[] {93}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2309, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new SeparatedListStackNode<IConstructor>(-2304, 2, regular__iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2305, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2306, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2307, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2308, 3, "$layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2303, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2302, 0, prod__lit___91__char_class___range__91_91_, new int[] {91}, null, null);
    ...
    protected static final void _init_prod__visit_$Expression__label_$Label_$layouts_LAYOUTLIST_visit_$Visit_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new NonTerminalStackNode<IConstructor>(-2325, 2, "$Visit", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2324, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2323, 0, "$Label", null, null);
    ...
    protected static final void _init_prod__stepRange_$Expression__lit___91_$layouts_LAYOUTLIST_first_$Expression_$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_second_$Expression_$layouts_LAYOUTLIST_lit___46_46_$layouts_LAYOUTLIST_last_$Expression_$layouts_LAYOUTLIST_lit___93_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[12] = new LiteralStackNode<IConstructor>(-2372, 12, prod__lit___93__char_class___range__93_93_, new int[] {93}, null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(-2371, 11, "$layouts_LAYOUTLIST", null, null);
      tmp[10] = new NonTerminalStackNode<IConstructor>(-2370, 10, "$Expression", null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(-2369, 9, "$layouts_LAYOUTLIST", null, null);
      tmp[8] = new LiteralStackNode<IConstructor>(-2368, 8, prod__lit___46_46__char_class___range__46_46_char_class___range__46_46_, new int[] {46,46}, null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(-2367, 7, "$layouts_LAYOUTLIST", null, null);
      tmp[6] = new NonTerminalStackNode<IConstructor>(-2366, 6, "$Expression", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2365, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(-2364, 4, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2363, 3, "$layouts_LAYOUTLIST", null, null);
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(-2360, 0, prod__lit___91__char_class___range__91_91_, new int[] {91}, null, null);
    ...
    protected static final void _init_prod__voidClosure_$Expression__parameters_$Parameters_$layouts_LAYOUTLIST_lit___123_$layouts_LAYOUTLIST_statements_iter_star_seps__$Statement__$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___125_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2373, 0, "$Parameters", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2374, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2375, 2, prod__lit___123__char_class___range__123_123_, new int[] {123}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2376, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(-2377, 4, regular__iter_star_seps__$Statement__$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2378, 0, "$Statement", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2379, 1, "$layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2380, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(-2381, 6, prod__lit___125__char_class___range__125_125_, new int[] {125}, null, null);
    ...
    protected static final void _init_prod__has_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit_has_$layouts_LAYOUTLIST_name_$Name_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(-2388, 4, "$Name", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2387, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2386, 2, prod__lit_has__char_class___range__104_104_char_class___range__97_97_char_class___range__115_115_, new int[] {104,97,115}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2385, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2384, 0, "$Expression", null, null);
    ...
    protected static final void _init_prod__it_$Expression__conditional__lit_it__not_precede__char_class___range__65_90_range__95_95_range__97_122_not_follow__char_class___range__65_90_range__95_95_range__97_122_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new LiteralStackNode<IConstructor>(-2382, 0, prod__lit_it__char_class___range__105_105_char_class___range__116_116_, new int[] {105,116}, new IEnterFilter[] {new CharPrecedeRestriction(new int[][]{{65,90},{95,95},{97,122}})}, new ICompletionFilter[] {new CharFollowRestriction(new int[][]{{65,90},{95,95},{97,122}})});
    ...
    protected static final void _init_prod__literal_$Expression__literal_$Literal_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2301, 0, "$Literal", null, null);
    ...
    protected static final void _init_prod__comprehension_$Expression__comprehension_$Comprehension_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2322, 0, "$Comprehension", null, null);
    ...
    protected static final void _init_prod__set_$Expression__lit___123_$layouts_LAYOUTLIST_elements_iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___125_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new LiteralStackNode<IConstructor>(-2345, 4, prod__lit___125__char_class___range__125_125_, new int[] {125}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2344, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new SeparatedListStackNode<IConstructor>(-2339, 2, regular__iter_star_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2340, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2341, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2342, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2343, 3, "$layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2338, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2337, 0, prod__lit___123__char_class___range__123_123_, new int[] {123}, null, null);
    ...
    protected static final void _init_prod__prev_$Expression__conditional__lit_prev__not_precede__char_class___range__65_90_range__95_95_range__97_122_not_follow__char_class___range__65_90_range__95_95_range__97_122_(ExpectBuilder<IConstructor> builder) {
      AbstractStackNode<IConstructor>[] tmp = (AbstractStackNode<IConstructor>[]) new AbstractStackNode[1];
      
      tmp[0] = new LiteralStackNode<IConstructor>(-2383, 0, prod__lit_prev__char_class___range__112_112_char_class___range__114_114_char_class___range__101_101_char_class___range__118_118_, new int[] {112,114,101,118}, new IEnterFilter[] {new CharPrecedeRestriction(new int[][]{{65,90},{95,95},{97,122}})}, new ICompletionFilter[] {new CharFollowRestriction(new int[][]{{65,90},{95,95},{97,122}})});
      builder.addAlternative(RascalRascal.prod__prev_$Expression__conditional__lit_prev__not_precede__char_class___range__65_90_range__95_95_range__97_122_not_follow__char_class___range__65_90_range__95_95_range__97_122_, tmp);
	}
    protected static final void _init_prod__fieldAccess_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___46_$layouts_LAYOUTLIST_field_$Name_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(-2404, 4, "$Name", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2403, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2402, 2, prod__lit___46__char_class___range__46_46_, new int[] {46}, null, null);
    ...
    protected static final void _init_prod__bracket_$Expression__lit___40_$layouts_LAYOUTLIST_expression_$Expression_$layouts_LAYOUTLIST_lit___41__bracket(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new LiteralStackNode<IConstructor>(-2409, 4, prod__lit___41__char_class___range__41_41_, new int[] {41}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2408, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(-2407, 2, "$Expression", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2406, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2405, 0, prod__lit___40__char_class___range__40_40_, new int[] {40}, null, null);
    ...
    protected static final void _init_prod__fieldProject_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___60_$layouts_LAYOUTLIST_fields_iter_seps__$Field__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___62_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[6] = new LiteralStackNode<IConstructor>(-2421, 6, prod__lit___62__char_class___range__62_62_, new int[] {62}, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2420, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(-2415, 4, regular__iter_seps__$Field__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2416, 0, "$Field", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2417, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2418, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2419, 3, "$layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2414, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2413, 2, prod__lit___60__char_class___range__60_60_, new int[] {60}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2412, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2411, 0, "$Expression", null, null);
    ...
    protected static final void _init_prod__getAnnotation_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___64_$layouts_LAYOUTLIST_name_$Name_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(-2426, 4, "$Name", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2425, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2424, 2, prod__lit___64__char_class___range__64_64_, new int[] {64}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2423, 1, "$layouts_LAYOUTLIST", null, null);
    ...
    protected static final void _init_prod__nonEmptyBlock_$Expression__lit___123_$layouts_LAYOUTLIST_statements_iter_seps__$Statement__$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___125_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new LiteralStackNode<IConstructor>(-2464, 4, prod__lit___125__char_class___range__125_125_, new int[] {125}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2463, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new SeparatedListStackNode<IConstructor>(-2460, 2, regular__iter_seps__$Statement__$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2461, 0, "$Statement", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2462, 1, "$layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2459, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2458, 0, prod__lit___123__char_class___range__123_123_, new int[] {123}, null, null);
    ...
    protected static final void _init_prod__openRecursiveAddition_$Expression__lhs_$Expression_$layouts_LAYOUTLIST_lit___43_43_$layouts_LAYOUTLIST_rhs_$Expression__assoc__left(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new LiteralStackNode<IConstructor>(-2575, 2, prod__lit___43_43__char_class___range__43_43_char_class___range__43_43_, new int[] {43,43}, null, null);
    ...
    protected static final void _init_prod__reifyType_$Expression__lit___35_$layouts_LAYOUTLIST_conditional__type_$Type__not_follow__lit___91_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[2] = new NonTerminalStackNode<IConstructor>(-2348, 2, "$Type", null, new ICompletionFilter[] {new StringFollowRestriction(new int[] {91})});
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2347, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2346, 0, prod__lit___35__char_class___range__35_35_, new int[] {35}, null, null);
    ...
    protected static final void _init_prod__all_$Expression__lit_all_$layouts_LAYOUTLIST_lit___40_$layouts_LAYOUTLIST_generators_iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___41_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[6] = new LiteralStackNode<IConstructor>(-2359, 6, prod__lit___41__char_class___range__41_41_, new int[] {41}, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2358, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new SeparatedListStackNode<IConstructor>(-2353, 4, regular__iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2354, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2355, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2356, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2357, 3, "$layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2352, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2351, 2, prod__lit___40__char_class___range__40_40_, new int[] {40}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2350, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2349, 0, prod__lit_all__char_class___range__97_97_char_class___range__108_108_char_class___range__108_108_, new int[] {97,108,108}, null, null);
    ...
    protected static final void _init_prod__fieldUpdate_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit___91_$layouts_LAYOUTLIST_key_$Name_$layouts_LAYOUTLIST_lit___61_$layouts_LAYOUTLIST_replacement_$Expression_$layouts_LAYOUTLIST_lit___93_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[10] = new LiteralStackNode<IConstructor>(-2399, 10, prod__lit___93__char_class___range__93_93_, new int[] {93}, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(-2398, 9, "$layouts_LAYOUTLIST", null, null);
      tmp[8] = new NonTerminalStackNode<IConstructor>(-2397, 8, "$Expression", null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(-2396, 7, "$layouts_LAYOUTLIST", null, null);
      tmp[6] = new LiteralStackNode<IConstructor>(-2395, 6, prod__lit___61__char_class___range__61_61_, new int[] {61}, null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2394, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new NonTerminalStackNode<IConstructor>(-2393, 4, "$Name", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2392, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2391, 2, prod__lit___91__char_class___range__91_91_, new int[] {91}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2390, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2389, 0, "$Expression", null, null);
    ...
    protected static final void _init_prod__map_$Expression__lit___40_$layouts_LAYOUTLIST_mappings_iter_star_seps__$Mapping__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___41_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new LiteralStackNode<IConstructor>(-2435, 4, prod__lit___41__char_class___range__41_41_, new int[] {41}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2434, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new SeparatedListStackNode<IConstructor>(-2429, 2, regular__iter_star_seps__$Mapping__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2430, 0, "$Mapping__$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2431, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2432, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2433, 3, "$layouts_LAYOUTLIST", null, null)}, false, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2428, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2427, 0, prod__lit___40__char_class___range__40_40_, new int[] {40}, null, null);
    ...
    protected static final void _init_prod__is_$Expression__expression_$Expression_$layouts_LAYOUTLIST_lit_is_$layouts_LAYOUTLIST_name_$Name_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[4] = new NonTerminalStackNode<IConstructor>(-2440, 4, "$Name", null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2439, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new LiteralStackNode<IConstructor>(-2438, 2, prod__lit_is__char_class___range__105_105_char_class___range__115_115_, new int[] {105,115}, null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2437, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2436, 0, "$Expression", null, null);
    ...
    protected static final void _init_prod__reducer_$Expression__lit___40_$layouts_LAYOUTLIST_init_$Expression_$layouts_LAYOUTLIST_lit___124_$layouts_LAYOUTLIST_result_$Expression_$layouts_LAYOUTLIST_lit___124_$layouts_LAYOUTLIST_generators_iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST_$layouts_LAYOUTLIST_lit___41_(ExpectBuilder<IConstructor> builder) {
      ...
      tmp[12] = new LiteralStackNode<IConstructor>(-2457, 12, prod__lit___41__char_class___range__41_41_, new int[] {41}, null, null);
      tmp[11] = new NonTerminalStackNode<IConstructor>(-2456, 11, "$layouts_LAYOUTLIST", null, null);
      tmp[10] = new SeparatedListStackNode<IConstructor>(-2451, 10, regular__iter_seps__$Expression__$layouts_LAYOUTLIST_lit___44_$layouts_LAYOUTLIST, new NonTerminalStackNode<IConstructor>(-2452, 0, "$Expression", null, null), (AbstractStackNode<IConstructor>[]) new AbstractStackNode[]{new NonTerminalStackNode<IConstructor>(-2453, 1, "$layouts_LAYOUTLIST", null, null), new LiteralStackNode<IConstructor>(-2454, 2, prod__lit___44__char_class___range__44_44_, new int[] {44}, null, null), new NonTerminalStackNode<IConstructor>(-2455, 3, "$layouts_LAYOUTLIST", null, null)}, true, null, null);
      tmp[9] = new NonTerminalStackNode<IConstructor>(-2450, 9, "$layouts_LAYOUTLIST", null, null);
      tmp[8] = new LiteralStackNode<IConstructor>(-2449, 8, prod__lit___124__char_class___range__124_124_, new int[] {124}, null, null);
      tmp[7] = new NonTerminalStackNode<IConstructor>(-2448, 7, "$layouts_LAYOUTLIST", null, null);
      tmp[6] = new NonTerminalStackNode<IConstructor>(-2447, 6, "$Expression", null, null);
      tmp[5] = new NonTerminalStackNode<IConstructor>(-2446, 5, "$layouts_LAYOUTLIST", null, null);
      tmp[4] = new LiteralStackNode<IConstructor>(-2445, 4, prod__lit___124__char_class___range__124_124_, new int[] {124}, null, null);
      tmp[3] = new NonTerminalStackNode<IConstructor>(-2444, 3, "$layouts_LAYOUTLIST", null, null);
      tmp[2] = new NonTerminalStackNode<IConstructor>(-2443, 2, "$Expression", null, null);
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2442, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new LiteralStackNode<IConstructor>(-2441, 0, prod__lit___40__char_class___range__40_40_, new int[] {40}, null, null);
    ...
    protected static final void _init_prod__transitiveClosure_$Expression__argument_$Expression_$layouts_LAYOUTLIST_conditional__lit___43__not_follow__char_class___range__43_43_range__61_61_(ExpectBuilder<IConstructor> builder) {
      AbstractStackNode<IConstructor>[] tmp = (AbstractStackNode<IConstructor>[]) new AbstractStackNode[3];
      
      tmp[2] = new LiteralStackNode<IConstructor>(-2467, 2, prod__lit___43__char_class___range__43_43_, new int[] {43}, null, new ICompletionFilter[] {new CharFollowRestriction(new int[][]{{43,43},{61,61}})});
      tmp[1] = new NonTerminalStackNode<IConstructor>(-2466, 1, "$layouts_LAYOUTLIST", null, null);
      tmp[0] = new NonTerminalStackNode<IConstructor>(-2465, 0, "$Expression", null, null);
      builder.addAlternative(RascalRascal.prod__transitiveClosure_$Expression__argument_$Expression_$layouts_LAYOUTLIST_conditional__lit___43__not_follow__char_class___range__43_43_range__61_61_, tmp);
	}
    ...
    public static void init(ExpectBuilder<IConstructor> builder){
        ...
        _init_prod__prev_$Expression__conditional__lit_prev__not_precede__char_class___range__65_90_range__95_95_range__97_122_not_follow__char_class___range__65_90_range__95_95_range__97_122_(builder);
        ...
        _init_prod__transitiveClosure_$Expression__argument_$Expression_$layouts_LAYOUTLIST_conditional__lit___43__not_follow__char_class___range__43_43_range__61_61_(builder);
