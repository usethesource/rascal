...
data Expression(TypeSymbol typ=\unresolved())
    ...
    | \methodCall(Expression receiver, list[Type] typeArguments, str identifier, list[Expression] arguments)
    | \superMethodCall(list[Type] typeArguments, str identifier, list[Expression] arguments)
    | \superMethodCall(Expression qualifier, list[Type] typeArguments, str identifier, list[Expression] arguments)
    | \null()
