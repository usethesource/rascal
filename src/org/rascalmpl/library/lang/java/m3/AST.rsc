...
data Declaration
    ...
    | \class(list[Modifier] modifiers, Expression name, list[Type] extends, list[Type] implements, list[Declaration] body)
    | \class(list[Modifier] modifiers, list[Declaration] body)
    | \interface(list[Modifier] modifiers, Expression name, list[Type] extends, list[Type] implements, list[Declaration] body)
