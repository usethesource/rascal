...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 941 + 103 * defined.hashCode() + 67 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 769 + 149 * start.hashCode() + 541 * defined.hashCode() + 353 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 23 + 787 * vis.hashCode() + 863 * defined.hashCode() + 557 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 61 + 281 * defined.hashCode() + 263 * production.hashCode() ; 
    } 
