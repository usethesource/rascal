...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 331 + 167 * defined.hashCode() + 809 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 109 + 373 * start.hashCode() + 449 * defined.hashCode() + 571 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 467 + 691 * vis.hashCode() + 701 * defined.hashCode() + 19 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 137 + 907 * defined.hashCode() + 41 * production.hashCode() ; 
    } 
