...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 727 + 883 * defined.hashCode() + 617 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 233 + 263 * start.hashCode() + 163 * defined.hashCode() + 683 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 661 + 499 * vis.hashCode() + 769 * defined.hashCode() + 163 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 641 + 313 * defined.hashCode() + 509 * production.hashCode() ; 
    } 
