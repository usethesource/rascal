...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 863 + 467 * defined.hashCode() + 7 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 653 + 587 * start.hashCode() + 53 * defined.hashCode() + 47 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 53 + 211 * vis.hashCode() + 67 * defined.hashCode() + 127 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 433 + 499 * defined.hashCode() + 487 * production.hashCode() ; 
    } 
