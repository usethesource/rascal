...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 181 + 941 * defined.hashCode() + 17 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13 + 281 * start.hashCode() + 433 * defined.hashCode() + 619 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 911 + 197 * vis.hashCode() + 59 * defined.hashCode() + 877 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 41 + 167 * defined.hashCode() + 563 * production.hashCode() ; 
    } 
  ...
  static public class Token extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 827 + 563 * defined.hashCode() + 283 * production.hashCode() ; 
    } 
