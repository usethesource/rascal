...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * defined.hashCode() + 13 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13331 + 61 * start.hashCode() + 71 * defined.hashCode() + 79 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13331 + 13 * vis.hashCode() + 97 * defined.hashCode() + 13 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * defined.hashCode() + 17 * production.hashCode() ; 
    } 
