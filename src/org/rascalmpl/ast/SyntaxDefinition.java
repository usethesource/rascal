...
public abstract class SyntaxDefinition extends AbstractAST { 
  public org.rascalmpl.ast.Start getStart() { throw new UnsupportedOperationException(); } public org.rascalmpl.ast.UserType getUser() { throw new UnsupportedOperationException(); } public boolean hasStart() { return false; } public boolean hasUser() { return false; } public boolean isLanguage() { return false; }
...
/** start:Start "syntax" user:UserType "=" Prod ";" -> SyntaxDefinition {cons("Language")} */
	public Language(INode node, org.rascalmpl.ast.Start start, org.rascalmpl.ast.UserType user) {
		this.node = node;
		this.start = start;
		this.user = user;
	}
...
/** "layout" user:UserType "=" Prod ";" -> SyntaxDefinition {cons("Layout")} */
	public Layout(INode node, org.rascalmpl.ast.UserType user) {
		this.node = node;
		this.user = user;
	}
	@Override
