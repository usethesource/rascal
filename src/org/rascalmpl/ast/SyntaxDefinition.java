...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 103 + 103 * defined.hashCode() + 761 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 13 + 433 * start.hashCode() + 593 * defined.hashCode() + 619 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 331 + 991 * vis.hashCode() + 19 * defined.hashCode() + 157 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 401 + 431 * defined.hashCode() + 859 * production.hashCode() ; 
    } 
  ...
  static public class Token extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 613 + 29 * defined.hashCode() + 601 * production.hashCode() ; 
    } 
