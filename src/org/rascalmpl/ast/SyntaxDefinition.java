...
public abstract class SyntaxDefinition extends AbstractAST {
  public SyntaxDefinition(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends SyntaxDefinition {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.SyntaxDefinition> alternatives) {
    super(loc);
...
public Language(ISourceLocation loc, org.rascalmpl.ast.Start start,  org.rascalmpl.ast.Sym defined,  org.rascalmpl.ast.Prod production) {
  super(loc);
...
public Layout(ISourceLocation loc, org.rascalmpl.ast.Sym defined,  org.rascalmpl.ast.Prod production) {
  super(loc);
