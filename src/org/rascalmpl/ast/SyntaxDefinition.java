...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 769 + 163 * start.hashCode() + 641 * defined.hashCode() + 313 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 509 + 563 * vis.hashCode() + 149 * defined.hashCode() + 431 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 67 + 19 * defined.hashCode() + 181 * production.hashCode() ; 
    } 
