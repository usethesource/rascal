...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 997 + 991 * defined.hashCode() + 641 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 967 + 541 * start.hashCode() + 331 * defined.hashCode() + 97 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 911 + 151 * vis.hashCode() + 773 * defined.hashCode() + 719 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 193 + 397 * defined.hashCode() + 223 * production.hashCode() ; 
    } 
  ...
  static public class Token extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 71 + 827 * defined.hashCode() + 373 * production.hashCode() ; 
    } 
