...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 619 + 827 * defined.hashCode() + 313 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 83 + 409 * start.hashCode() + 181 * defined.hashCode() + 283 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 491 + 607 * vis.hashCode() + 479 * defined.hashCode() + 971 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 59 + 401 * defined.hashCode() + 313 * production.hashCode() ; 
    } 
