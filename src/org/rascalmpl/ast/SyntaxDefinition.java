...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 29 + 941 * defined.hashCode() + 103 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 67 + 769 * start.hashCode() + 149 * defined.hashCode() + 541 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 353 + 23 * vis.hashCode() + 787 * defined.hashCode() + 863 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 557 + 61 * defined.hashCode() + 281 * production.hashCode() ; 
    } 
