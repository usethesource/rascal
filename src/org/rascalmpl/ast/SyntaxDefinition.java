...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 389 + 229 * defined.hashCode() + 193 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 617 + 521 * start.hashCode() + 269 * defined.hashCode() + 839 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 743 + 751 * vis.hashCode() + 241 * defined.hashCode() + 911 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 827 + 29 * defined.hashCode() + 947 * production.hashCode() ; 
    } 
