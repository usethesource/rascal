...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 643 + 617 * defined.hashCode() + 743 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 109 + 919 * start.hashCode() + 599 * defined.hashCode() + 479 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 109 + 787 * vis.hashCode() + 5 * defined.hashCode() + 659 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 733 + 499 * defined.hashCode() + 757 * production.hashCode() ; 
    } 
  ...
  static public class Token extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 97 + 139 * defined.hashCode() + 977 * production.hashCode() ; 
    } 
