...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 317 + 701 * defined.hashCode() + 383 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 863 + 479 * start.hashCode() + 443 * defined.hashCode() + 331 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 967 + 563 * vis.hashCode() + 311 * defined.hashCode() + 431 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 163 + 773 * defined.hashCode() + 443 * production.hashCode() ; 
    } 
  ...
  static public class Token extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 983 + 269 * defined.hashCode() + 113 * production.hashCode() ; 
    } 
