...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 263 + 163 * defined.hashCode() + 683 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 661 + 499 * start.hashCode() + 769 * defined.hashCode() + 163 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 641 + 313 * vis.hashCode() + 509 * defined.hashCode() + 563 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 149 + 431 * defined.hashCode() + 67 * production.hashCode() ; 
    } 
