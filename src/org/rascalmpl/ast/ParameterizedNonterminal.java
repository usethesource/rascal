...
public abstract class ParameterizedNonterminal extends AbstractAST {
  public ParameterizedNonterminal(IConstructor node) {
    super(node);
  }
...
static public class Ambiguity extends ParameterizedNonterminal {
  ...
  public Ambiguity(IConstructor node, java.util.List<org.rascalmpl.ast.ParameterizedNonterminal> alternatives) {
    super(node);
