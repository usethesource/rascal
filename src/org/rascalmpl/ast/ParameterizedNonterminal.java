...
public abstract class ParameterizedNonterminal extends AbstractAST {
  public ParameterizedNonterminal(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends ParameterizedNonterminal {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.ParameterizedNonterminal> alternatives) {
    super(loc);
