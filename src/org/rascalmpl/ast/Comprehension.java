...
public abstract class Comprehension extends AbstractAST {
  ...
  static public class List extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 557 + 277 * results.hashCode() + 673 * generators.hashCode() ; 
    } 
  ...
  static public class Map extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 449 + 191 * from.hashCode() + 421 * to.hashCode() + 577 * generators.hashCode() ; 
    } 
  ...
  static public class Set extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 457 + 101 * results.hashCode() + 31 * generators.hashCode() ; 
    } 
