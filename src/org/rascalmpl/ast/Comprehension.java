...
public abstract class Comprehension extends AbstractAST {
  ...
  static public class List extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * results.hashCode() + 23 * generators.hashCode() ; 
    } 
  ...
  static public class Map extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 13331 + 13 * from.hashCode() + 37 * to.hashCode() + 67 * generators.hashCode() ; 
    } 
  ...
  static public class Set extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 13331 + 73 * results.hashCode() + 11 * generators.hashCode() ; 
    } 
