...
public abstract class Comprehension extends AbstractAST {
  ...
  static public class List extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 239 + 419 * results.hashCode() + 827 * generators.hashCode() ; 
    } 
  ...
  static public class Map extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 419 + 167 * from.hashCode() + 827 * to.hashCode() + 173 * generators.hashCode() ; 
    } 
  ...
  static public class Set extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 103 + 11 * results.hashCode() + 401 * generators.hashCode() ; 
    } 
