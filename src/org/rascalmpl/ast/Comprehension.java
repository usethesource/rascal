...
public abstract class Comprehension extends AbstractAST {
  ...
  static public class List extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 607 + 911 * results.hashCode() + 617 * generators.hashCode() ; 
    } 
  ...
  static public class Map extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 709 + 613 * from.hashCode() + 139 * to.hashCode() + 773 * generators.hashCode() ; 
    } 
  ...
  static public class Set extends Comprehension {
    ...
    @Override
    public int hashCode() {
      return 673 + 241 * results.hashCode() + 967 * generators.hashCode() ; 
    } 
