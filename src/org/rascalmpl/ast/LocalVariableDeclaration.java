...
public abstract class LocalVariableDeclaration extends AbstractAST {
  public LocalVariableDeclaration(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends LocalVariableDeclaration {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.LocalVariableDeclaration> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, org.rascalmpl.ast.Declarator declarator) {
  super(loc);
...
public Dynamic(ISourceLocation loc, org.rascalmpl.ast.Declarator declarator) {
  super(loc);
