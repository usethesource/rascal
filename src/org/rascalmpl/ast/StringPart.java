...
public abstract class StringPart extends AbstractAST {
  ...
  static public class Block extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 13 + 787 * statements.hashCode() ; 
    } 
  ...
  static public class Characters extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 37 + 131 * characters.hashCode() ; 
    } 
  ...
  static public class Comp extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 331 + 521 * result.hashCode() + 839 * keywordArguments.hashCode() + 191 * generators.hashCode() ; 
    } 
  ...
  static public class DoWhile extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 599 + 109 * preStats.hashCode() + 977 * body.hashCode() + 2 * postStats.hashCode() + 947 * condition.hashCode() ; 
    } 
  ...
  static public class Expr extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 281 + 409 * result.hashCode() + 97 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class For extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 607 + 547 * generators.hashCode() + 283 * preStats.hashCode() + 757 * body.hashCode() + 347 * postStats.hashCode() ; 
    } 
  ...
  static public class For2 extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 73 + 181 * conditions.hashCode() + 499 * body.hashCode() ; 
    } 
  ...
  static public class Forsep extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 227 + 389 * conditions.hashCode() + 479 * body.hashCode() + 103 * sepBody.hashCode() ; 
    } 
  ...
  static public class Hole extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 859 + 163 * arg.hashCode() + 739 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class IfThen extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 821 + 977 * conditions.hashCode() + 677 * preStats.hashCode() + 11 * body.hashCode() + 691 * postStats.hashCode() ; 
    } 
  ...
  static public class IfThen2 extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 71 + 181 * conditions.hashCode() + 199 * body.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 787 + 193 * conditions.hashCode() + 199 * preStatsThen.hashCode() + 389 * body.hashCode() + 281 * postStatsThen.hashCode() + 389 * preStatsElse.hashCode() + 683 * elseBody.hashCode() + 577 * postStatsElse.hashCode() ; 
    } 
  ...
  static public class IfThenElse2 extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 653 + 73 * conditions.hashCode() + 991 * body.hashCode() + 911 * elseBody.hashCode() ; 
    } 
  ...
  static public class Margin extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 379 + 811 * margin.hashCode() + 373 * indent.hashCode() ; 
    } 
  ...
  static public class Sepcomp extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 83 + 71 * result.hashCode() + 683 * keywordArguments.hashCode() + 839 * sep.hashCode() + 577 * generators.hashCode() ; 
    } 
  ...
  static public class Var extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 59 + 139 * variable.hashCode() ; 
    } 
  ...
  static public class While extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 233 + 331 * condition.hashCode() + 359 * preStats.hashCode() + 151 * body.hashCode() + 311 * postStats.hashCode() ; 
    } 
  ...
  static public class While2 extends StringPart {
    ...
    @Override
    public int hashCode() {
      return 73 + 619 * conditions.hashCode() + 5 * body.hashCode() ; 
    } 
