...
public abstract class Assignable extends AbstractAST {
  ...
  static public class Annotation extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 23 + 149 * receiver.hashCode() + 389 * annotation.hashCode() ; 
    } 
  ...
  static public class Constructor extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 131 + 863 * name.hashCode() + 727 * arguments.hashCode() ; 
    } 
  ...
  static public class FieldAccess extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 283 + 547 * receiver.hashCode() + 349 * field.hashCode() ; 
    } 
  ...
  static public class IfDefinedOrDefault extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 677 + 61 * receiver.hashCode() + 263 * defaultExpression.hashCode() ; 
    } 
  ...
  static public class Slice extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 953 + 331 * receiver.hashCode() + 977 * optFirst.hashCode() + 97 * optLast.hashCode() ; 
    } 
  ...
  static public class SliceStep extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 701 + 7 * receiver.hashCode() + 193 * optFirst.hashCode() + 571 * second.hashCode() + 131 * optLast.hashCode() ; 
    } 
  ...
  static public class Subscript extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 593 + 997 * receiver.hashCode() + 227 * subscript.hashCode() ; 
    } 
  ...
  static public class Tuple extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 283 + 617 * elements.hashCode() ; 
    } 
  ...
  static public class Variable extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 809 + 449 * qualifiedName.hashCode() ; 
    } 
