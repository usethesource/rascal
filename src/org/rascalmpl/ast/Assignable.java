...
public abstract class Assignable extends AbstractAST {
  ...
  static public class Annotation extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 101 + 631 * receiver.hashCode() + 293 * annotation.hashCode() ; 
    } 
  ...
  static public class Constructor extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 991 + 433 * name.hashCode() + 197 * arguments.hashCode() ; 
    } 
  ...
  static public class FieldAccess extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 859 + 251 * receiver.hashCode() + 673 * field.hashCode() ; 
    } 
  ...
  static public class IfDefinedOrDefault extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 149 + 3 * receiver.hashCode() + 71 * defaultExpression.hashCode() ; 
    } 
  ...
  static public class Slice extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 727 + 167 * receiver.hashCode() + 263 * optFirst.hashCode() + 769 * optLast.hashCode() ; 
    } 
  ...
  static public class SliceStep extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 503 + 563 * receiver.hashCode() + 373 * optFirst.hashCode() + 857 * second.hashCode() + 971 * optLast.hashCode() ; 
    } 
  ...
  static public class Subscript extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 281 + 911 * receiver.hashCode() + 653 * subscript.hashCode() ; 
    } 
  ...
  static public class Tuple extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 997 + 953 * elements.hashCode() ; 
    } 
  ...
  static public class Variable extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 509 + 277 * qualifiedName.hashCode() ; 
    } 
