...
public abstract class Assignable extends AbstractAST {
  ...
  static public class Annotation extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 593 + 211 * receiver.hashCode() + 61 * annotation.hashCode() ; 
    } 
  ...
  static public class Constructor extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 947 + 797 * name.hashCode() + 349 * arguments.hashCode() ; 
    } 
  ...
  static public class FieldAccess extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 307 + 587 * receiver.hashCode() + 211 * field.hashCode() ; 
    } 
  ...
  static public class IfDefinedOrDefault extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 103 + 151 * receiver.hashCode() + 421 * defaultExpression.hashCode() ; 
    } 
  ...
  static public class Slice extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 29 + 53 * receiver.hashCode() + 881 * optFirst.hashCode() + 863 * optLast.hashCode() ; 
    } 
  ...
  static public class SliceStep extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 857 + 743 * receiver.hashCode() + 211 * optFirst.hashCode() + 449 * second.hashCode() + 19 * optLast.hashCode() ; 
    } 
  ...
  static public class Subscript extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 131 + 719 * receiver.hashCode() + 137 * subscript.hashCode() ; 
    } 
  ...
  static public class Tuple extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 373 + 269 * elements.hashCode() ; 
    } 
  ...
  static public class Variable extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 619 + 443 * qualifiedName.hashCode() ; 
    } 
