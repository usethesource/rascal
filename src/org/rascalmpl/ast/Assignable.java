...
public abstract class Assignable extends AbstractAST {
  ...
  static public class Annotation extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 439 + 631 * receiver.hashCode() + 367 * annotation.hashCode() ; 
    } 
  ...
  static public class Constructor extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 991 + 977 * name.hashCode() + 389 * arguments.hashCode() ; 
    } 
  ...
  static public class FieldAccess extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 317 + 251 * receiver.hashCode() + 947 * field.hashCode() ; 
    } 
  ...
  static public class IfDefinedOrDefault extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 37 + 937 * receiver.hashCode() + 47 * defaultExpression.hashCode() ; 
    } 
  ...
  static public class Slice extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 821 + 3 * receiver.hashCode() + 683 * optFirst.hashCode() + 857 * optLast.hashCode() ; 
    } 
  ...
  static public class SliceStep extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 79 + 137 * receiver.hashCode() + 269 * optFirst.hashCode() + 467 * second.hashCode() + 719 * optLast.hashCode() ; 
    } 
  ...
  static public class Subscript extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 911 + 19 * receiver.hashCode() + 389 * subscript.hashCode() ; 
    } 
  ...
  static public class Tuple extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 197 + 47 * elements.hashCode() ; 
    } 
  ...
  static public class Variable extends Assignable {
    ...
    @Override
    public int hashCode() {
      return 7 + 601 * qualifiedName.hashCode() ; 
    } 
