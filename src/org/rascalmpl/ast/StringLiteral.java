...
public abstract class StringLiteral extends AbstractAST {
  ...
  static public class Interpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 53 + 547 * pre.hashCode() + 197 * expression.hashCode() + 937 * tail.hashCode() ; 
    } 
  ...
  static public class NonInterpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 337 + 823 * constant.hashCode() ; 
    } 
  ...
  static public class Template extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 839 + 491 * pre.hashCode() + 229 * template.hashCode() + 73 * tail.hashCode() ; 
    } 
