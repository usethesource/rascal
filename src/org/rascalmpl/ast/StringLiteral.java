...
public abstract class StringLiteral extends AbstractAST {
  ...
  static public class Interpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 599 + 109 * pre.hashCode() + 977 * expression.hashCode() + 2 * tail.hashCode() ; 
    } 
  ...
  static public class NonInterpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 947 + 281 * constant.hashCode() ; 
    } 
  ...
  static public class Template extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 409 + 97 * pre.hashCode() + 607 * template.hashCode() + 547 * tail.hashCode() ; 
    } 
