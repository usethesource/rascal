...
public abstract class StringLiteral extends AbstractAST {
  ...
  static public class Interpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 919 + 389 * pre.hashCode() + 877 * expression.hashCode() + 853 * tail.hashCode() ; 
    } 
  ...
  static public class NonInterpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 857 + 467 * constant.hashCode() ; 
    } 
  ...
  static public class Template extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 421 + 97 * pre.hashCode() + 311 * template.hashCode() + 709 * tail.hashCode() ; 
    } 
