...
public abstract class StringLiteral extends AbstractAST {
  ...
  static public class Interpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 359 + 397 * pre.hashCode() + 823 * expression.hashCode() + 521 * tail.hashCode() ; 
    } 
  ...
  static public class NonInterpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 173 + 163 * constant.hashCode() ; 
    } 
  ...
  static public class Template extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 911 + 809 * pre.hashCode() + 281 * template.hashCode() + 773 * tail.hashCode() ; 
    } 
