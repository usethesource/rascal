...
public abstract class StringLiteral extends AbstractAST {
  ...
  static public class Interpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 467 + 379 * pre.hashCode() + 271 * expression.hashCode() + 283 * tail.hashCode() ; 
    } 
  ...
  static public class NonInterpolated extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 613 + 853 * constant.hashCode() ; 
    } 
  ...
  static public class Template extends StringLiteral {
    ...
    @Override
    public int hashCode() {
      return 601 + 401 * pre.hashCode() + 997 * template.hashCode() + 71 * tail.hashCode() ; 
    } 
