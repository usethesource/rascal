...
/** pre:PreStringChars expression:Expression tail:StringTail -> StringLiteral {cons("Interpolated")} */
	protected Interpolated(INode node, org.rascalmpl.ast.PreStringChars pre, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.StringTail tail) {
		this.node = node;
		this.pre = pre;
...
static public class Ambiguity extends StringLiteral {
  ...
  protected Ambiguity(INode node, java.util.List<org.rascalmpl.ast.StringLiteral> alternatives) {
...
/** pre:PreStringChars template:StringTemplate tail:StringTail -> StringLiteral {cons("Template")} */
	protected Template(INode node, org.rascalmpl.ast.PreStringChars pre, org.rascalmpl.ast.StringTemplate template, org.rascalmpl.ast.StringTail tail) {
		this.node = node;
		this.pre = pre;
...
/** constant:StringConstant -> StringLiteral {cons("NonInterpolated")} */
	protected NonInterpolated(INode node, org.rascalmpl.ast.StringConstant constant) {
		this.node = node;
