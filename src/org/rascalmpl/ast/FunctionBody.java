...
public abstract class FunctionBody extends AbstractAST {
  public FunctionBody(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends FunctionBody {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.FunctionBody> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Statement> statements) {
  super(loc);
