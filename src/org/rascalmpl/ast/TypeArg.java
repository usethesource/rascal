...
public abstract class TypeArg extends AbstractAST {
  public TypeArg(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends TypeArg {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.TypeArg> alternatives) {
    super(loc);
...
public Named(ISourceLocation loc, org.rascalmpl.ast.Type type,  org.rascalmpl.ast.Name name) {
  super(loc);
...
public Default(ISourceLocation loc, org.rascalmpl.ast.Type type) {
  super(loc);
