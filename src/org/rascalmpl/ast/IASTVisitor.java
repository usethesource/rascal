...
public interface IASTVisitor<T> {
      ...
      public T visitTestLabeled(Test.Labeled x);
      ...
      public T visitProdFollow(Prod.Follow x);
      ...
      public T visitProdAction(Prod.Action x);
  
      public T visitProdReference(Prod.Reference x);
  
      public T visitProdReject(Prod.Reject x);
      ...
      public T visitParameterizedNonterminalLexical(ParameterizedNonterminal.Lexical x);
      ...
      public T visitParameterizedNonterminalAmbiguity(ParameterizedNonterminal.Ambiguity x);
      ...
      public T visitLanguageActionAmbiguity(LanguageAction.Ambiguity x);
