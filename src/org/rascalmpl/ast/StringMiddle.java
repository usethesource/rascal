...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 139 + 541 * mid.hashCode() + 491 * expression.hashCode() + 211 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 167 + 503 * mid.hashCode() + 461 * template.hashCode() + 977 * tail.hashCode() ; 
    } 
