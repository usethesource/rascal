...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 283 + 757 * mid.hashCode() + 347 * expression.hashCode() + 73 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 227 + 389 * mid.hashCode() + 479 * template.hashCode() + 103 * tail.hashCode() ; 
    } 
