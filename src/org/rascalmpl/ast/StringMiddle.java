...
/** mid:MidStringChars -> StringMiddle {cons("Mid")} */
	protected Mid(INode node, org.rascalmpl.ast.MidStringChars mid) {
		this.node = node;
		this.mid = mid;
	}
...
static public class Ambiguity extends StringMiddle {
  ...
  protected Ambiguity(INode node, java.util.List<org.rascalmpl.ast.StringMiddle> alternatives) {
...
/** mid:MidStringChars expression:Expression tail:StringMiddle -> StringMiddle {cons("Interpolated")} */
	protected Interpolated(INode node, org.rascalmpl.ast.MidStringChars mid, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.StringMiddle tail) {
		this.node = node;
		this.mid = mid;
...
/** mid:MidStringChars template:StringTemplate tail:StringMiddle -> StringMiddle {cons("Template")} */
	protected Template(INode node, org.rascalmpl.ast.MidStringChars mid, org.rascalmpl.ast.StringTemplate template, org.rascalmpl.ast.StringMiddle tail) {
		this.node = node;
		this.mid = mid;
