...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 197 + 353 * mid.hashCode() + 683 * expression.hashCode() + 233 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 383 + 83 * mid.hashCode() + 887 * template.hashCode() + 277 * tail.hashCode() ; 
    } 
