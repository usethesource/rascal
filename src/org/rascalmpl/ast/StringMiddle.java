...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 607 + 59 * mid.hashCode() + 71 * expression.hashCode() + 467 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 373 + 701 * mid.hashCode() + 953 * template.hashCode() + 733 * tail.hashCode() ; 
    } 
