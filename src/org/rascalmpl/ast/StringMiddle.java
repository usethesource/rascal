...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 419 + 373 * mid.hashCode() + 7 * expression.hashCode() + 601 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 199 + 3 * mid.hashCode() + 359 * template.hashCode() + 853 * tail.hashCode() ; 
    } 
