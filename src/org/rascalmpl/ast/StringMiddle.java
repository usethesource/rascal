...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 13331 + 17 * mid.hashCode() + 19 * expression.hashCode() + 37 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 13331 + 79 * mid.hashCode() + 67 * template.hashCode() + 41 * tail.hashCode() ; 
    } 
