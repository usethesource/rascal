...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 683 + 193 * mid.hashCode() + 13 * expression.hashCode() + 463 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 149 + 761 * mid.hashCode() + 277 * template.hashCode() + 883 * tail.hashCode() ; 
    } 
