...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 107 + 859 * mid.hashCode() + 151 * expression.hashCode() + 71 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 29 + 997 * mid.hashCode() + 307 * template.hashCode() + 491 * tail.hashCode() ; 
    } 
