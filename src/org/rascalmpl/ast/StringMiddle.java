...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 29 + 193 * mid.hashCode() + 911 * expression.hashCode() + 107 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 607 + 647 * mid.hashCode() + 359 * template.hashCode() + 677 * tail.hashCode() ; 
    } 
