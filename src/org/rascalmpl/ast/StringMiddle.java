...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 157 + 739 * mid.hashCode() + 727 * expression.hashCode() + 331 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 653 + 953 * mid.hashCode() + 257 * template.hashCode() + 821 * tail.hashCode() ; 
    } 
