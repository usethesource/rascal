...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 547 + 283 * mid.hashCode() + 757 * expression.hashCode() + 347 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 499 + 227 * mid.hashCode() + 389 * template.hashCode() + 479 * tail.hashCode() ; 
    } 
