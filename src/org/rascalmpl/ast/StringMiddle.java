...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 991 + 11 * mid.hashCode() + 173 * expression.hashCode() + 499 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 547 + 881 * mid.hashCode() + 89 * template.hashCode() + 109 * tail.hashCode() ; 
    } 
