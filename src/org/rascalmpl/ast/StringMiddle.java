...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 983 + 59 * mid.hashCode() + 547 * expression.hashCode() + 439 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 223 + 257 * mid.hashCode() + 283 * template.hashCode() + 103 * tail.hashCode() ; 
    } 
