...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 59 + 877 * mid.hashCode() + 23 * expression.hashCode() + 233 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 433 + 503 * mid.hashCode() + 17 * template.hashCode() + 673 * tail.hashCode() ; 
    } 
