...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 367 + 389 * mid.hashCode() + 941 * expression.hashCode() + 37 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 911 + 797 * mid.hashCode() + 953 * template.hashCode() + 479 * tail.hashCode() ; 
    } 
