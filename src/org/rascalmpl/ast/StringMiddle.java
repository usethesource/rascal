...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 739 + 631 * mid.hashCode() + 449 * expression.hashCode() + 947 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 491 + 907 * mid.hashCode() + 479 * template.hashCode() + 743 * tail.hashCode() ; 
    } 
