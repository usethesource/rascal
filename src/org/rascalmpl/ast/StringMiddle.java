...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 827 + 733 * mid.hashCode() + 739 * expression.hashCode() + 919 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 733 + 719 * mid.hashCode() + 883 * template.hashCode() + 809 * tail.hashCode() ; 
    } 
