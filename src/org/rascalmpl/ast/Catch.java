...
/** "catch" ":" body:Statement -> Catch {cons("Default")} */
	protected Default(INode node, org.rascalmpl.ast.Statement body) {
		this.node = node;
		this.body = body;
	}
...
static public class Ambiguity extends Catch {
  ...
  protected Ambiguity(INode node, java.util.List<org.rascalmpl.ast.Catch> alternatives) {
...
/** "catch" pattern:Expression ":" body:Statement -> Catch {cons("Binding")} */
	protected Binding(INode node, org.rascalmpl.ast.Expression pattern, org.rascalmpl.ast.Statement body) {
		this.node = node;
