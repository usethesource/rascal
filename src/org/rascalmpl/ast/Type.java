...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 509 + 89 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 269 + 677 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 59 + 347 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 113 + 701 * symbol.hashCode() ; 
    } 
