...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 19 + 59 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 557 + 71 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 307 + 421 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 277 + 503 * symbol.hashCode() ; 
    } 
  ...
  static public class Variable extends Type {
    ...
    @Override
    public int hashCode() {
      return 311 + 271 * typeVar.hashCode() ; 
    } 
