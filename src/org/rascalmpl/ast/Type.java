...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 83 + 79 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 617 + 293 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 223 + 499 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 179 + 227 * symbol.hashCode() ; 
    } 
  ...
  static public class Variable extends Type {
    ...
    @Override
    public int hashCode() {
      return 349 + 461 * typeVar.hashCode() ; 
    } 
