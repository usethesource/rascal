...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 101 + 991 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 409 + 937 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 173 + 263 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 139 + 787 * symbol.hashCode() ; 
    } 
  ...
  static public class Variable extends Type {
    ...
    @Override
    public int hashCode() {
      return 163 + 251 * typeVar.hashCode() ; 
    } 
