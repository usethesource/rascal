...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 157 + 953 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 491 + 197 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 971 + 647 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 769 + 397 * symbol.hashCode() ; 
    } 
  ...
  static public class Variable extends Type {
    ...
    @Override
    public int hashCode() {
      return 83 + 967 * typeVar.hashCode() ; 
    } 
