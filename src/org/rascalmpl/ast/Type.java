...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 383 + 521 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 911 + 827 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 103 + 31 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 449 + 719 * symbol.hashCode() ; 
    } 
