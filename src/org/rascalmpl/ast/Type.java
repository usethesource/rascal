...
public abstract class Type extends AbstractAST {
  ...
  static public class Function extends Type {
    ...
    @Override
    public int hashCode() {
      return 797 + 149 * function.hashCode() ; 
    } 
  ...
  static public class Selector extends Type {
    ...
    @Override
    public int hashCode() {
      return 877 + 401 * selector.hashCode() ; 
    } 
  ...
  static public class Structured extends Type {
    ...
    @Override
    public int hashCode() {
      return 787 + 239 * structured.hashCode() ; 
    } 
  ...
  static public class Symbol extends Type {
    ...
    @Override
    public int hashCode() {
      return 997 + 641 * symbol.hashCode() ; 
    } 
  ...
  static public class Variable extends Type {
    ...
    @Override
    public int hashCode() {
      return 179 + 797 * typeVar.hashCode() ; 
    } 
