...
public abstract class DecimalIntegerLiteral extends AbstractAST {
  public DecimalIntegerLiteral(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends DecimalIntegerLiteral {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.DecimalIntegerLiteral> alternatives) {
    super(loc);
