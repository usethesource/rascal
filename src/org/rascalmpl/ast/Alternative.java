...
public abstract class Alternative extends AbstractAST {
  public Alternative(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Alternative {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Alternative> alternatives) {
    super(loc);
...
public NamedType(ISourceLocation loc, org.rascalmpl.ast.Name name,  org.rascalmpl.ast.Type type) {
  super(loc);
