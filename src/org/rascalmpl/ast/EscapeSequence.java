...
public abstract class EscapeSequence extends AbstractAST { 
  ...
  private final java.util.List<org.rascalmpl.ast.EscapeSequence> alternatives;
  public Ambiguity(INode node, java.util.List<org.rascalmpl.ast.EscapeSequence> alternatives) {
	this.alternatives = java.util.Collections.unmodifiableList(alternatives);
         this.node = node;
  }
  public java.util.List<org.rascalmpl.ast.EscapeSequence> getAlternatives() {
	return alternatives;
  }
