...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 181 + 71 * tags.hashCode() + 23 * visibility.hashCode() + 211 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 719 + 911 * tags.hashCode() + 107 * visibility.hashCode() + 853 * signature.hashCode() + 23 * expression.hashCode() + 157 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 929 + 3 * tags.hashCode() + 137 * visibility.hashCode() + 683 * signature.hashCode() + 269 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 491 + 743 * tags.hashCode() + 947 * visibility.hashCode() + 113 * signature.hashCode() + 491 * expression.hashCode() ; 
    } 
