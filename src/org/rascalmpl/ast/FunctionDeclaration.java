...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 997 + 599 * tags.hashCode() + 911 * visibility.hashCode() + 941 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 463 + 173 * tags.hashCode() + 179 * visibility.hashCode() + 797 * signature.hashCode() + 53 * expression.hashCode() + 571 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 587 + 947 * tags.hashCode() + 827 * visibility.hashCode() + 881 * signature.hashCode() + 139 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 461 + 359 * tags.hashCode() + 401 * visibility.hashCode() + 349 * signature.hashCode() + 773 * expression.hashCode() ; 
    } 
