...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 181 + 383 * tags.hashCode() + 643 * visibility.hashCode() + 353 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 743 + 271 * tags.hashCode() + 131 * visibility.hashCode() + 397 * signature.hashCode() + 313 * expression.hashCode() + 17 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 107 + 263 * tags.hashCode() + 307 * visibility.hashCode() + 557 * signature.hashCode() + 479 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 163 + 911 * tags.hashCode() + 823 * visibility.hashCode() + 643 * signature.hashCode() + 421 * expression.hashCode() ; 
    } 
