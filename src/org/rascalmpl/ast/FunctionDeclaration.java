...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 811 + 11 * tags.hashCode() + 829 * visibility.hashCode() + 863 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 401 + 853 * tags.hashCode() + 569 * visibility.hashCode() + 229 * signature.hashCode() + 461 * expression.hashCode() + 47 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 787 + 167 * tags.hashCode() + 41 * visibility.hashCode() + 967 * signature.hashCode() + 499 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 233 + 743 * tags.hashCode() + 941 * visibility.hashCode() + 587 * signature.hashCode() + 139 * expression.hashCode() ; 
    } 
