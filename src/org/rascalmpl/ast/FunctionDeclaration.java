...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 257 + 29 * tags.hashCode() + 389 * visibility.hashCode() + 739 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 683 + 977 * tags.hashCode() + 859 * visibility.hashCode() + 647 * signature.hashCode() + 193 * expression.hashCode() + 397 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 491 + 439 * tags.hashCode() + 127 * visibility.hashCode() + 937 * signature.hashCode() + 277 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 251 + 317 * tags.hashCode() + 683 * visibility.hashCode() + 59 * signature.hashCode() + 479 * expression.hashCode() ; 
    } 
