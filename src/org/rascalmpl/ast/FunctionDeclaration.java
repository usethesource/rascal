...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 919 + 167 * tags.hashCode() + 7 * visibility.hashCode() + 283 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 31 + 907 * tags.hashCode() + 251 * visibility.hashCode() + 587 * signature.hashCode() + 853 * expression.hashCode() + 761 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 181 + 59 * tags.hashCode() + 89 * visibility.hashCode() + 487 * signature.hashCode() + 709 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 397 + 859 * tags.hashCode() + 61 * visibility.hashCode() + 229 * signature.hashCode() + 109 * expression.hashCode() ; 
    } 
