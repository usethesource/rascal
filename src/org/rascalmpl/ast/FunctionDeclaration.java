...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 601 + 67 * tags.hashCode() + 233 * visibility.hashCode() + 227 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 467 + 683 * tags.hashCode() + 283 * visibility.hashCode() + 331 * signature.hashCode() + 383 * expression.hashCode() + 281 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 41 + 113 * tags.hashCode() + 641 * visibility.hashCode() + 797 * signature.hashCode() + 233 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 137 + 181 * tags.hashCode() + 263 * visibility.hashCode() + 59 * signature.hashCode() + 239 * expression.hashCode() ; 
    } 
