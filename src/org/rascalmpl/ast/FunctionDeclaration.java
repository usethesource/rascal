...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 967 + 31 * tags.hashCode() + 103 * visibility.hashCode() + 521 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 947 + 769 * tags.hashCode() + 983 * visibility.hashCode() + 41 * signature.hashCode() + 223 * expression.hashCode() + 643 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 197 + 149 * tags.hashCode() + 769 * visibility.hashCode() + 659 * signature.hashCode() + 547 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 113 + 13 * tags.hashCode() + 353 * visibility.hashCode() + 593 * signature.hashCode() + 59 * expression.hashCode() ; 
    } 
