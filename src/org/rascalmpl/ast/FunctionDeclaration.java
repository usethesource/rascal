...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 151 + 991 * tags.hashCode() + 487 * visibility.hashCode() + 911 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 919 + 797 * tags.hashCode() + 397 * visibility.hashCode() + 521 * signature.hashCode() + 97 * expression.hashCode() + 601 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 809 + 2 * tags.hashCode() + 691 * visibility.hashCode() + 2 * signature.hashCode() + 509 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 857 + 409 * tags.hashCode() + 661 * visibility.hashCode() + 971 * signature.hashCode() + 859 * expression.hashCode() ; 
    } 
