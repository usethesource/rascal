...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 257 + 89 * tags.hashCode() + 727 * visibility.hashCode() + 137 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 823 + 227 * tags.hashCode() + 421 * visibility.hashCode() + 359 * signature.hashCode() + 191 * expression.hashCode() + 307 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 409 + 463 * tags.hashCode() + 787 * visibility.hashCode() + 41 * signature.hashCode() + 151 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 421 + 727 * tags.hashCode() + 599 * visibility.hashCode() + 43 * signature.hashCode() + 859 * expression.hashCode() ; 
    } 
