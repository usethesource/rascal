...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 701 + 241 * tags.hashCode() + 103 * visibility.hashCode() + 137 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 961 + 829 * tags.hashCode() + 541 * visibility.hashCode() + 139 * signature.hashCode() + 313 * expression.hashCode() + 787 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 761 + 383 * tags.hashCode() + 241 * visibility.hashCode() + 197 * signature.hashCode() + 449 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 787 + 317 * tags.hashCode() + 131 * visibility.hashCode() + 641 * signature.hashCode() + 3 * expression.hashCode() ; 
    } 
