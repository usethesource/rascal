...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 89 + 587 * tags.hashCode() + 239 * visibility.hashCode() + 17 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 257 + 653 * tags.hashCode() + 353 * visibility.hashCode() + 503 * signature.hashCode() + 827 * expression.hashCode() + 641 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 571 + 503 * tags.hashCode() + 857 * visibility.hashCode() + 251 * signature.hashCode() + 269 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 653 + 691 * tags.hashCode() + 103 * visibility.hashCode() + 557 * signature.hashCode() + 881 * expression.hashCode() ; 
    } 
