...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 181 + 827 * tags.hashCode() + 439 * visibility.hashCode() + 787 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 509 + 307 * tags.hashCode() + 881 * visibility.hashCode() + 337 * signature.hashCode() + 787 * expression.hashCode() + 911 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 587 + 113 * tags.hashCode() + 727 * visibility.hashCode() + 991 * signature.hashCode() + 853 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 269 + 239 * tags.hashCode() + 269 * visibility.hashCode() + 167 * signature.hashCode() + 521 * expression.hashCode() ; 
    } 
