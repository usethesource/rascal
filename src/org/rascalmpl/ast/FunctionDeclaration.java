...
public abstract class FunctionDeclaration extends AbstractAST {
  ...
  static public class Abstract extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 17 + 647 * tags.hashCode() + 127 * visibility.hashCode() + 7 * signature.hashCode() ; 
    } 
  ...
  static public class Conditional extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 659 + 643 * tags.hashCode() + 139 * visibility.hashCode() + 641 * signature.hashCode() + 61 * expression.hashCode() + 263 * conditions.hashCode() ; 
    } 
  ...
  static public class Default extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 449 + 53 * tags.hashCode() + 809 * visibility.hashCode() + 839 * signature.hashCode() + 37 * body.hashCode() ; 
    } 
  ...
  static public class Expression extends FunctionDeclaration {
    ...
    @Override
    public int hashCode() {
      return 263 + 373 * tags.hashCode() + 283 * visibility.hashCode() + 751 * signature.hashCode() + 479 * expression.hashCode() ; 
    } 
