...
public abstract class Statement extends AbstractAST {
  ...
  static public class Append extends Statement {
    ...
    @Override
    public int hashCode() {
      return 409 + 577 * dataTarget.hashCode() + 811 * statement.hashCode() ; 
    } 
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 313 + 401 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 883 + 953 * expression.hashCode() + 3 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 11 + 373 * assignable.hashCode() + 67 * operator.hashCode() + 547 * statement.hashCode() ; 
    } 
  ...
  static public class Break extends Statement {
    ...
    @Override
    public int hashCode() {
      return 353 + 227 * target.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 643 + 977 * label.hashCode() + 157 * body.hashCode() + 827 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 683 + 719 * expression.hashCode() ; 
    } 
  ...
  static public class Fail extends Statement {
    ...
    @Override
    public int hashCode() {
      return 607 + 491 * target.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 251 + 313 * label.hashCode() + 743 * generators.hashCode() + 373 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 863 + 17 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 509 + 593 * type.hashCode() + 739 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 197 + 191 * label.hashCode() + 479 * conditions.hashCode() + 269 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 13 + 179 * label.hashCode() + 467 * conditions.hashCode() + 7 * thenStatement.hashCode() + 47 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 151 + 983 * dataTarget.hashCode() + 977 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 23 + 577 * label.hashCode() + 587 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 379 + 311 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 571 + 911 * variables.hashCode() + 461 * bound.hashCode() + 997 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 41 + 241 * label.hashCode() + 269 * expression.hashCode() + 131 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 113 + 881 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 197 + 757 * body.hashCode() + 571 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 311 + 919 * body.hashCode() + 139 * handlers.hashCode() + 173 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 229 + 271 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 991 + 59 * label.hashCode() + 401 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 251 + 971 * label.hashCode() + 311 * conditions.hashCode() + 397 * body.hashCode() ; 
    } 
