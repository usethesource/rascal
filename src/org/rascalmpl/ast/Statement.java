...
public abstract class Statement extends AbstractAST {
  ...
  static public class Append extends Statement {
    ...
    @Override
    public int hashCode() {
      return 941 + 941 * dataTarget.hashCode() + 347 * statement.hashCode() ; 
    } 
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 397 + 541 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 677 + 733 * expression.hashCode() + 983 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 809 + 107 * assignable.hashCode() + 163 * operator.hashCode() + 233 * statement.hashCode() ; 
    } 
  ...
  static public class Break extends Statement {
    ...
    @Override
    public int hashCode() {
      return 571 + 911 * target.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 881 + 19 * label.hashCode() + 397 * body.hashCode() + 967 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 433 + 547 * expression.hashCode() ; 
    } 
  ...
  static public class Fail extends Statement {
    ...
    @Override
    public int hashCode() {
      return 503 + 263 * target.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 419 + 7 * label.hashCode() + 223 * generators.hashCode() + 173 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 853 + 929 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 397 + 41 * type.hashCode() + 313 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 3 + 179 * label.hashCode() + 2 * conditions.hashCode() + 563 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 941 + 613 * label.hashCode() + 877 * conditions.hashCode() + 997 * thenStatement.hashCode() + 947 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 317 + 137 * dataTarget.hashCode() + 2 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 5 + 709 * label.hashCode() + 857 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 787 + 599 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 163 + 983 * variables.hashCode() + 463 * bound.hashCode() + 79 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 331 + 881 * label.hashCode() + 701 * expression.hashCode() + 227 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 809 + 79 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 73 + 181 * body.hashCode() + 97 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 379 + 379 * body.hashCode() + 151 * handlers.hashCode() + 983 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 661 + 173 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 907 + 991 * label.hashCode() + 13 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 109 + 911 * label.hashCode() + 401 * conditions.hashCode() + 787 * body.hashCode() ; 
    } 
