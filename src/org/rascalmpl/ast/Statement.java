...
public abstract class Statement extends AbstractAST {
  ...
  static public class Append extends Statement {
    ...
    @Override
    public int hashCode() {
      return 947 + 761 * dataTarget.hashCode() + 461 * statement.hashCode() ; 
    } 
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 199 + 223 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 487 + 827 * expression.hashCode() + 997 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 281 + 601 * assignable.hashCode() + 911 * operator.hashCode() + 727 * statement.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 241 + 353 * label.hashCode() + 541 * body.hashCode() + 599 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 2 + 151 * expression.hashCode() ; 
    } 
  ...
  static public class Fail extends Statement {
    ...
    @Override
    public int hashCode() {
      return 263 + 757 * target.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 773 + 31 * label.hashCode() + 883 * generators.hashCode() + 223 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 139 + 419 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 277 + 163 * type.hashCode() + 47 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 971 + 71 * label.hashCode() + 223 * conditions.hashCode() + 691 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 47 + 677 * label.hashCode() + 23 * conditions.hashCode() + 887 * thenStatement.hashCode() + 977 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 181 + 617 * dataTarget.hashCode() + 821 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 613 + 349 * label.hashCode() + 113 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 619 + 733 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 389 + 859 * variables.hashCode() + 631 * bound.hashCode() + 313 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 503 + 283 * label.hashCode() + 821 * expression.hashCode() + 797 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 881 + 727 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 89 + 937 * body.hashCode() + 383 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 19 + 109 * body.hashCode() + 853 * handlers.hashCode() + 311 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 277 + 251 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 167 + 3 * label.hashCode() + 317 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 503 + 199 * label.hashCode() + 701 * conditions.hashCode() + 31 * body.hashCode() ; 
    } 
