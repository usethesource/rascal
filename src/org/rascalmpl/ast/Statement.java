...
public abstract class Statement extends AbstractAST {
  ...
  static public class Append extends Statement {
    ...
    @Override
    public int hashCode() {
      return 317 + 857 * dataTarget.hashCode() + 353 * statement.hashCode() ; 
    } 
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 53 + 149 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 127 + 827 * expression.hashCode() + 431 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 131 + 827 * assignable.hashCode() + 2 * operator.hashCode() + 449 * statement.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 19 + 787 * label.hashCode() + 457 * body.hashCode() + 283 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 547 + 97 * expression.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 89 + 599 * label.hashCode() + 3 * generators.hashCode() + 757 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 193 + 881 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 823 + 859 * type.hashCode() + 181 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 677 + 433 * label.hashCode() + 67 * conditions.hashCode() + 757 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 479 + 691 * label.hashCode() + 193 * conditions.hashCode() + 113 * thenStatement.hashCode() + 607 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 151 + 409 * dataTarget.hashCode() + 691 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 691 + 73 * label.hashCode() + 457 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 719 + 461 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 929 + 199 * variables.hashCode() + 569 * bound.hashCode() + 149 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 569 + 617 * label.hashCode() + 389 * expression.hashCode() + 757 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 757 + 439 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 239 + 641 * body.hashCode() + 227 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 269 + 389 * body.hashCode() + 367 * handlers.hashCode() + 643 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 619 + 631 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 151 + 593 * label.hashCode() + 109 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 53 + 839 * label.hashCode() + 389 * conditions.hashCode() + 229 * body.hashCode() ; 
    } 
