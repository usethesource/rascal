...
public abstract class Statement extends AbstractAST {
  ...
  static public class Append extends Statement {
    ...
    @Override
    public int hashCode() {
      return 907 + 79 * dataTarget.hashCode() + 971 * statement.hashCode() ; 
    } 
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 883 + 821 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 293 + 947 * expression.hashCode() + 857 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 823 + 809 * assignable.hashCode() + 811 * operator.hashCode() + 659 * statement.hashCode() ; 
    } 
  ...
  static public class Break extends Statement {
    ...
    @Override
    public int hashCode() {
      return 631 + 569 * target.hashCode() ; 
    } 
  ...
  static public class Continue extends Statement {
    ...
    @Override
    public int hashCode() {
      return 641 + 317 * target.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 223 + 557 * label.hashCode() + 13 * body.hashCode() + 619 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 757 + 701 * expression.hashCode() ; 
    } 
  ...
  static public class Fail extends Statement {
    ...
    @Override
    public int hashCode() {
      return 263 + 691 * target.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 823 + 643 * label.hashCode() + 823 * generators.hashCode() + 337 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 83 + 331 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 593 + 269 * type.hashCode() + 5 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 229 + 643 * label.hashCode() + 157 * conditions.hashCode() + 23 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 661 + 211 * label.hashCode() + 7 * conditions.hashCode() + 599 * thenStatement.hashCode() + 859 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 367 + 317 * dataTarget.hashCode() + 331 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 569 + 61 * label.hashCode() + 367 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 103 + 947 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 307 + 389 * variables.hashCode() + 31 * bound.hashCode() + 5 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 229 + 643 * label.hashCode() + 443 * expression.hashCode() + 439 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 647 + 563 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 421 + 607 * body.hashCode() + 353 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 263 + 311 * body.hashCode() + 587 * handlers.hashCode() + 251 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 89 + 193 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 761 + 521 * label.hashCode() + 113 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 809 + 349 * label.hashCode() + 317 * conditions.hashCode() + 11 * body.hashCode() ; 
    } 
