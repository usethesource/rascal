...
public abstract class OptionalTerminator extends AbstractAST {
  public OptionalTerminator(ISourceLocation src, IConstructor node) {
    super(src /* we forget node on purpose */);
  }

  

  static public class Lexical extends OptionalTerminator {
  ...
  public <T> T accept(IASTVisitor<T> v) {
    return v.visitOptionalTerminatorLexical(this);
  }
}
