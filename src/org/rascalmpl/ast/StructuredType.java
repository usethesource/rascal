...
public abstract class StructuredType extends AbstractAST {
  public StructuredType(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends StructuredType {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.StructuredType> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, org.rascalmpl.ast.BasicType basicType,  java.util.List<org.rascalmpl.ast.TypeArg> arguments) {
  super(loc);
