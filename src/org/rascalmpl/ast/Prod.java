...
public abstract class Prod extends AbstractAST {
  ...
  static public class All extends Prod {
    ...
    @Override
    public int hashCode() {
      return 809 + 5 * lhs.hashCode() + 757 * rhs.hashCode() ; 
    } 
  ...
  static public class AssociativityGroup extends Prod {
    ...
    @Override
    public int hashCode() {
      return 977 + 617 * associativity.hashCode() + 397 * group.hashCode() ; 
    } 
  ...
  static public class First extends Prod {
    ...
    @Override
    public int hashCode() {
      return 619 + 31 * lhs.hashCode() + 557 * rhs.hashCode() ; 
    } 
  ...
  static public class Labeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 907 + 359 * modifiers.hashCode() + 163 * name.hashCode() + 127 * syms.hashCode() ; 
    } 
  ...
  static public class Reference extends Prod {
    ...
    @Override
    public int hashCode() {
      return 239 + 487 * referenced.hashCode() ; 
    } 
  ...
  static public class Unlabeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 463 + 19 * modifiers.hashCode() + 823 * syms.hashCode() ; 
    } 
