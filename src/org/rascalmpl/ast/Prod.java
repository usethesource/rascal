...
public abstract class Prod extends AbstractAST {
  ...
  static public class All extends Prod {
    ...
    @Override
    public int hashCode() {
      return 59 + 239 * lhs.hashCode() + 467 * rhs.hashCode() ; 
    } 
  ...
  static public class AssociativityGroup extends Prod {
    ...
    @Override
    public int hashCode() {
      return 257 + 149 * associativity.hashCode() + 3 * group.hashCode() ; 
    } 
  ...
  static public class First extends Prod {
    ...
    @Override
    public int hashCode() {
      return 601 + 443 * lhs.hashCode() + 983 * rhs.hashCode() ; 
    } 
  ...
  static public class Labeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 71 + 241 * modifiers.hashCode() + 379 * name.hashCode() + 587 * syms.hashCode() ; 
    } 
  ...
  static public class Reference extends Prod {
    ...
    @Override
    public int hashCode() {
      return 857 + 181 * referenced.hashCode() ; 
    } 
  ...
  static public class Unlabeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 59 + 269 * modifiers.hashCode() + 101 * syms.hashCode() ; 
    } 
