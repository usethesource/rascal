...
public abstract class Prod extends AbstractAST {
  ...
  static public class All extends Prod {
    ...
    @Override
    public int hashCode() {
      return 347 + 607 * lhs.hashCode() + 349 * rhs.hashCode() ; 
    } 
  ...
  static public class AssociativityGroup extends Prod {
    ...
    @Override
    public int hashCode() {
      return 17 + 467 * associativity.hashCode() + 47 * group.hashCode() ; 
    } 
  ...
  static public class First extends Prod {
    ...
    @Override
    public int hashCode() {
      return 541 + 19 * lhs.hashCode() + 109 * rhs.hashCode() ; 
    } 
  ...
  static public class Labeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 313 + 409 * modifiers.hashCode() + 467 * name.hashCode() + 443 * syms.hashCode() ; 
    } 
  ...
  static public class Reference extends Prod {
    ...
    @Override
    public int hashCode() {
      return 251 + 53 * referenced.hashCode() ; 
    } 
  ...
  static public class Unlabeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 751 + 599 * modifiers.hashCode() + 947 * syms.hashCode() ; 
    } 
