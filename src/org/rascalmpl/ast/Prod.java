...
public abstract class Prod extends AbstractAST {
  ...
  static public class All extends Prod {
    ...
    @Override
    public int hashCode() {
      return 967 + 401 * lhs.hashCode() + 547 * rhs.hashCode() ; 
    } 
  ...
  static public class AssociativityGroup extends Prod {
    ...
    @Override
    public int hashCode() {
      return 701 + 89 * associativity.hashCode() + 11 * group.hashCode() ; 
    } 
  ...
  static public class First extends Prod {
    ...
    @Override
    public int hashCode() {
      return 257 + 719 * lhs.hashCode() + 449 * rhs.hashCode() ; 
    } 
  ...
  static public class Labeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 53 + 47 * modifiers.hashCode() + 71 * name.hashCode() + 743 * syms.hashCode() ; 
    } 
  ...
  static public class Reference extends Prod {
    ...
    @Override
    public int hashCode() {
      return 71 + 379 * referenced.hashCode() ; 
    } 
  ...
  static public class Unlabeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 449 + 277 * modifiers.hashCode() + 647 * syms.hashCode() ; 
    } 
