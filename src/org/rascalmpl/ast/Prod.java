...
public abstract class Prod extends AbstractAST {
  ...
  static public class All extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 41 * lhs.hashCode() + 67 * rhs.hashCode() ; 
    } 
  ...
  static public class AssociativityGroup extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 29 * associativity.hashCode() + 53 * group.hashCode() ; 
    } 
  ...
  static public class First extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 79 * lhs.hashCode() + 31 * rhs.hashCode() ; 
    } 
  ...
  static public class Labeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 61 * modifiers.hashCode() + 11 * name.hashCode() + 67 * args.hashCode() ; 
    } 
  ...
  static public class Reference extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 47 * referenced.hashCode() ; 
    } 
  ...
  static public class Unlabeled extends Prod {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * modifiers.hashCode() + 17 * args.hashCode() ; 
    } 
