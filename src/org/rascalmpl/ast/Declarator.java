...
public abstract class Declarator extends AbstractAST {
  public Declarator(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Declarator {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Declarator> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, org.rascalmpl.ast.Type type,  java.util.List<org.rascalmpl.ast.Variable> variables) {
  super(loc);
