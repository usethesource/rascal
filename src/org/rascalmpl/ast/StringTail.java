...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 613 + 593 * mid.hashCode() + 641 * expression.hashCode() + 691 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 443 + 797 * mid.hashCode() + 19 * template.hashCode() + 601 * tail.hashCode() ; 
    } 
