...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 227 + 47 * mid.hashCode() + 431 * expression.hashCode() + 787 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 571 + 11 * mid.hashCode() + 683 * template.hashCode() + 431 * tail.hashCode() ; 
    } 
