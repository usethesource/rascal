...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 521 + 521 * mid.hashCode() + 103 * expression.hashCode() + 349 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 167 + 151 * mid.hashCode() + 829 * template.hashCode() + 311 * tail.hashCode() ; 
    } 
