...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 107 + 709 * mid.hashCode() + 337 * expression.hashCode() + 167 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 677 + 347 * mid.hashCode() + 599 * template.hashCode() + 557 * tail.hashCode() ; 
    } 
