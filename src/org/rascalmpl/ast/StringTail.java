...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 743 + 563 * mid.hashCode() + 233 * expression.hashCode() + 887 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 307 + 881 * mid.hashCode() + 463 * template.hashCode() + 967 * tail.hashCode() ; 
    } 
