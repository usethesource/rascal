...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 859 + 163 * mid.hashCode() + 739 * expression.hashCode() + 821 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 977 + 677 * mid.hashCode() + 11 * template.hashCode() + 691 * tail.hashCode() ; 
    } 
