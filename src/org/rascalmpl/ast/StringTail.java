...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 311 + 41 * mid.hashCode() + 467 * expression.hashCode() + 883 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 179 + 229 * mid.hashCode() + 877 * template.hashCode() + 367 * tail.hashCode() ; 
    } 
