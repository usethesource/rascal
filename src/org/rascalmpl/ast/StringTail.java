...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 151 + 751 * mid.hashCode() + 409 * expression.hashCode() + 653 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 499 + 139 * mid.hashCode() + 227 * template.hashCode() + 251 * tail.hashCode() ; 
    } 
