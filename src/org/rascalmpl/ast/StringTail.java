...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 13331 + 31 * mid.hashCode() + 17 * expression.hashCode() + 11 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * mid.hashCode() + 97 * template.hashCode() + 79 * tail.hashCode() ; 
    } 
