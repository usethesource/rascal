...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 103 + 859 * mid.hashCode() + 163 * expression.hashCode() + 739 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 821 + 977 * mid.hashCode() + 677 * template.hashCode() + 11 * tail.hashCode() ; 
    } 
