...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 179 + 173 * mid.hashCode() + 829 * expression.hashCode() + 409 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 877 + 137 * mid.hashCode() + 947 * template.hashCode() + 139 * tail.hashCode() ; 
    } 
