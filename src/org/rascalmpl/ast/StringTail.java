...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 353 + 19 * mid.hashCode() + 353 * expression.hashCode() + 449 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 479 + 17 * mid.hashCode() + 31 * template.hashCode() + 233 * tail.hashCode() ; 
    } 
