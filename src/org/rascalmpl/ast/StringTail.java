...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 11 + 281 * mid.hashCode() + 223 * expression.hashCode() + 743 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 113 + 37 * mid.hashCode() + 587 * template.hashCode() + 883 * tail.hashCode() ; 
    } 
