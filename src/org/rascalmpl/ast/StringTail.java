...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 223 + 61 * mid.hashCode() + 83 * expression.hashCode() + 127 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 163 + 137 * mid.hashCode() + 683 * template.hashCode() + 191 * tail.hashCode() ; 
    } 
