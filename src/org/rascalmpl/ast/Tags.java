...
public abstract class Tags extends AbstractAST {
  public Tags(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Tags {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Tags> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Tag> tags) {
  super(loc);
