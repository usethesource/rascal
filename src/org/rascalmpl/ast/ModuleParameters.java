...
public abstract class ModuleParameters extends AbstractAST {
  public ModuleParameters(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends ModuleParameters {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.ModuleParameters> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, java.util.List<org.rascalmpl.ast.TypeVar> parameters) {
  super(loc);
