...
public abstract class OptionalEqualSign extends AbstractAST {
  public OptionalEqualSign(ISourceLocation src, IConstructor node) {
    super(src /* we forget node on purpose */);
  }

  

  static public class Lexical extends OptionalEqualSign {
  ...
  public <T> T accept(IASTVisitor<T> v) {
    return v.visitOptionalEqualSignLexical(this);
  }
}
