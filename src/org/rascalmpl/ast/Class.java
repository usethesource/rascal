...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 97 + 349 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 739 + 953 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 271 + 739 * lhs.hashCode() + 647 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 271 + 809 * lhs.hashCode() + 263 * rhs.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 701 + 877 * lhs.hashCode() + 359 * rhs.hashCode() ; 
    } 
