...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 467 + 167 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 317 + 347 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 709 + 163 * lhs.hashCode() + 431 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 877 + 127 * lhs.hashCode() + 653 * rhs.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 563 + 127 * lhs.hashCode() + 829 * rhs.hashCode() ; 
    } 
