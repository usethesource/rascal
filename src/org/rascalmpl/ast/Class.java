...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 859 + 61 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 983 + 17 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 821 + 491 * lhs.hashCode() + 277 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 19 + 677 * lhs.hashCode() + 71 * rhs.hashCode() ; 
    } 
  ...
  static public class SimpleCharclass extends Class {
    ...
    @Override
    public int hashCode() {
      return 467 + 359 * ranges.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 601 + 569 * lhs.hashCode() + 653 * rhs.hashCode() ; 
    } 
