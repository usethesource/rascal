...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 541 + 659 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 821 + 277 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 37 + 821 * lhs.hashCode() + 797 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 563 + 239 * lhs.hashCode() + 953 * rhs.hashCode() ; 
    } 
  ...
  static public class SimpleCharclass extends Class {
    ...
    @Override
    public int hashCode() {
      return 149 + 787 * ranges.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 181 + 191 * lhs.hashCode() + 2 * rhs.hashCode() ; 
    } 
