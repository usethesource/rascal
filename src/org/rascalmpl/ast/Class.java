...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 643 + 743 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 281 + 337 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 607 + 937 * lhs.hashCode() + 257 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 757 + 839 * lhs.hashCode() + 179 * rhs.hashCode() ; 
    } 
  ...
  static public class SimpleCharclass extends Class {
    ...
    @Override
    public int hashCode() {
      return 379 + 797 * ranges.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 439 + 547 * lhs.hashCode() + 487 * rhs.hashCode() ; 
    } 
