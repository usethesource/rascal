...
public abstract class Class extends AbstractAST {
  ...
  static public class Bracket extends Class {
    ...
    @Override
    public int hashCode() {
      return 647 + 739 * charclass.hashCode() ; 
    } 
  ...
  static public class Complement extends Class {
    ...
    @Override
    public int hashCode() {
      return 983 + 607 * charClass.hashCode() ; 
    } 
  ...
  static public class Difference extends Class {
    ...
    @Override
    public int hashCode() {
      return 467 + 593 * lhs.hashCode() + 821 * rhs.hashCode() ; 
    } 
  ...
  static public class Intersection extends Class {
    ...
    @Override
    public int hashCode() {
      return 547 + 467 * lhs.hashCode() + 229 * rhs.hashCode() ; 
    } 
  ...
  static public class Union extends Class {
    ...
    @Override
    public int hashCode() {
      return 619 + 643 * lhs.hashCode() + 421 * rhs.hashCode() ; 
    } 
