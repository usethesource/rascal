...
public abstract class StringCharacters extends AbstractAST {
  public StringCharacters(ISourceLocation src, IConstructor node) {
    super(src /* we forget node on purpose */);
  }

  

  static public class Lexical extends StringCharacters {
  ...
  public <T> T accept(IASTVisitor<T> v) {
    return v.visitStringCharactersLexical(this);
  }
}
