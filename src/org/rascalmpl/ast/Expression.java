...
/** type:Type parameters:Parameters "{" statements:Statement+ "}" -> Expression {cons("Closure")} */
	protected Closure(INode node, org.rascalmpl.ast.Type type, org.rascalmpl.ast.Parameters parameters, java.util.List<org.rascalmpl.ast.Statement> statements) {
		this.node = node;
		this.type = type;
...
static public class Ambiguity extends Expression {
  ...
  protected Ambiguity(INode node, java.util.List<org.rascalmpl.ast.Expression> alternatives) {
...
/** parameters:Parameters "{" statements:Statement* "}" -> Expression {cons("VoidClosure")} */
	protected VoidClosure(INode node, org.rascalmpl.ast.Parameters parameters, java.util.List<org.rascalmpl.ast.Statement> statements) {
		this.node = node;
		this.parameters = parameters;
		this.statements = statements;
	}
...
/** "{" statements:Statement+ "}" -> Expression {cons("NonEmptyBlock")} */
	protected NonEmptyBlock(INode node, java.util.List<org.rascalmpl.ast.Statement> statements) {
		this.node = node;
		this.statements = statements;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** "(" expression:Expression ")" -> Expression {cons("Bracket"), bracket} */
	protected Bracket(INode node, org.rascalmpl.ast.Expression expression) {
		this.node = node;
...
/** "[" first:Expression ".."  last:Expression "]" -> Expression {cons("Range")} */
	protected Range(INode node, org.rascalmpl.ast.Expression first, org.rascalmpl.ast.Expression last) {
		this.node = node;
		this.first = first;
		this.last = last;
	}
...
/** "[" first:Expression "," second:Expression ".." last:Expression "]" -> Expression {cons("StepRange")} */
	protected StepRange(INode node, org.rascalmpl.ast.Expression first, org.rascalmpl.ast.Expression second, org.rascalmpl.ast.Expression last) {
		this.node = node;
		this.first = first;
		this.second = second;
		this.last = last;
...
/** "#" type:Type -> Expression {cons("ReifyType")} */
	protected ReifyType(INode node, org.rascalmpl.ast.Type type) {
		this.node = node;
		this.type = type;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** basicType:BasicType "(" arguments:{Expression ","}* ")" -> Expression {cons("ReifiedType")} */
	protected ReifiedType(INode node, org.rascalmpl.ast.BasicType basicType, java.util.List<org.rascalmpl.ast.Expression> arguments) {
		this.node = node;
...
/** expression:Expression "(" arguments:{Expression ","}* ")" -> Expression {cons("CallOrTree")} */
	protected CallOrTree(INode node, org.rascalmpl.ast.Expression expression, java.util.List<org.rascalmpl.ast.Expression> arguments) {
		this.node = node;
		this.expression = expression;
		this.arguments = arguments;
	}
...
/** expression:Expression "[" key:Name "=" replacement:Expression "]" -> Expression {cons("FieldUpdate")} */
	protected FieldUpdate(INode node, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.Name key, org.rascalmpl.ast.Expression replacement) {
		this.node = node;
		this.expression = expression;
		this.key = key;
...
/** expression:Expression "." field:Name -> Expression {cons("FieldAccess")} */
	protected FieldAccess(INode node, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.Name field) {
		this.node = node;
		this.expression = expression;
		this.field = field;
	}
...
/** expression:Expression "<" fields:{Field ","}+ ">" -> Expression {cons("FieldProject")} */
	protected FieldProject(INode node, org.rascalmpl.ast.Expression expression, java.util.List<org.rascalmpl.ast.Field> fields) {
		this.node = node;
		this.expression = expression;
		this.fields = fields;
	}
...
/** expression:Expression "[" subscripts: {Expression ","}+"]" -> Expression {cons("Subscript")} */
	protected Subscript(INode node, org.rascalmpl.ast.Expression expression, java.util.List<org.rascalmpl.ast.Expression> subscripts) {
		this.node = node;
		this.expression = expression;
...
/** argument:Expression "?" -> Expression {cons("IsDefined")} */
	protected IsDefined(INode node, org.rascalmpl.ast.Expression argument) {
		this.node = node;
...
/** "!" argument:Expression -> Expression {cons("Negation")} */
	protected Negation(INode node, org.rascalmpl.ast.Expression argument) {
		this.node = node;
		this.argument = argument;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** "-" argument:Expression -> Expression {cons("Negative")} */
	protected Negative(INode node, org.rascalmpl.ast.Expression argument) {
		this.node = node;
		this.argument = argument;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** argument:Expression "*" -> Expression {cons("TransitiveReflexiveClosure")} */
	protected TransitiveReflexiveClosure(INode node, org.rascalmpl.ast.Expression argument) {
		this.node = node;
		this.argument = argument;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** argument:Expression "+" -> Expression {cons("TransitiveClosure")} */
	protected TransitiveClosure(INode node, org.rascalmpl.ast.Expression argument) {
		this.node = node;
		this.argument = argument;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** expression:Expression "@" name:Name -> Expression {cons("GetAnnotation")} */
	protected GetAnnotation(INode node, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.Name name) {
		this.node = node;
		this.expression = expression;
		this.name = name;
	}
...
/** expression:Expression "[" "@" name:Name "=" value: Expression "]" -> Expression {cons("SetAnnotation")} */
	protected SetAnnotation(INode node, org.rascalmpl.ast.Expression expression, org.rascalmpl.ast.Name name, org.rascalmpl.ast.Expression value) {
		this.node = node;
		this.expression = expression;
		this.name = name;
		this.value = value;
...
/** lhs:Expression "o" rhs:Expression -> Expression {cons("Composition"), left} */
	protected Composition(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "*" rhs:Expression -> Expression {cons("Product"), left} */
	protected Product(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "join" rhs:Expression -> Expression {cons("Join"), left} */
	protected Join(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "/" rhs:Expression -> Expression {cons("Division"), left} */
	protected Division(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "%" rhs:Expression -> Expression {cons("Modulo"), left} */
	protected Modulo(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "&" rhs:Expression -> Expression {cons("Intersection"), left} */
	protected Intersection(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "+" rhs:Expression -> Expression {cons("Addition"), left} */
	protected Addition(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "-" rhs:Expression -> Expression {cons("Subtraction"), left} */
	protected Subtraction(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "notin" rhs:Expression -> Expression {non-assoc, cons("NotIn")} */
	protected NotIn(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "in" rhs:Expression -> Expression {non-assoc, cons("In")} */
	protected In(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "<" rhs:Expression -> Expression {non-assoc, cons("LessThan")} */
	protected LessThan(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "<=" rhs:Expression -> Expression {non-assoc, cons("LessThanOrEq")} */
	protected LessThanOrEq(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression ">" rhs:Expression -> Expression {non-assoc, cons("GreaterThan")} */
	protected GreaterThan(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression ">=" rhs:Expression -> Expression {non-assoc, cons("GreaterThanOrEq")} */
	protected GreaterThanOrEq(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "==" rhs:Expression -> Expression {left, cons("Equals")} */
	protected Equals(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "!=" rhs:Expression -> Expression {left, cons("NonEquals")} */
	protected NonEquals(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** condition:Expression "?" thenExp:Expression ":" elseExp:Expression -> Expression {right, cons("IfThenElse")} */
	protected IfThenElse(INode node, org.rascalmpl.ast.Expression condition, org.rascalmpl.ast.Expression thenExp, org.rascalmpl.ast.Expression elseExp) {
		this.node = node;
...
/** lhs:Expression "?" rhs:Expression -> Expression {non-assoc, cons("IfDefinedOtherwise")} */
	protected IfDefinedOtherwise(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "==>" rhs:Expression -> Expression {right, cons("Implication")} */
	protected Implication(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "<==>" rhs:Expression -> Expression {right, cons("Equivalence")} */
	protected Equivalence(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "&&" rhs:Expression -> Expression {left, cons("And")} */
	protected And(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
/** lhs:Expression "||" rhs:Expression -> Expression {left, cons("Or")} */
	protected Or(INode node, org.rascalmpl.ast.Expression lhs, org.rascalmpl.ast.Expression rhs) {
		this.node = node;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
} public org.rascalmpl.ast.Literal getLiteral() { throw new UnsupportedOperationException(); } public boolean hasLiteral() { return false; } public boolean isLiteral() { return false; } static public class Literal extends Expression {
/** literal:Literal -> Expression {cons("Literal")} */
	protected Literal(INode node, org.rascalmpl.ast.Literal literal) {
		this.node = node;
...
} public org.rascalmpl.ast.QualifiedName getQualifiedName() { throw new UnsupportedOperationException(); } public boolean hasQualifiedName() { return false; } public boolean isQualifiedName() { return false; } static public class QualifiedName extends Expression {
/** qualifiedName:QualifiedName -> Expression {cons("QualifiedName")} */
	protected QualifiedName(INode node, org.rascalmpl.ast.QualifiedName qualifiedName) {
		this.node = node;
...
} public java.util.List<org.rascalmpl.ast.Expression> getElements() { throw new UnsupportedOperationException(); } public boolean hasElements() { return false; } public boolean isList() { return false; } static public class List extends Expression {
/** "[" elements:{Expression ","}* "]" -> Expression {cons("List")} */
	protected List(INode node, java.util.List<org.rascalmpl.ast.Expression> elements) {
		this.node = node;
...
} public boolean isSet() { return false; } static public class Set extends Expression {
/** "{" elements:{Expression ","}* "}" -> Expression {cons("Set")} */
	protected Set(INode node, java.util.List<org.rascalmpl.ast.Expression> elements) {
		this.node = node;
		this.elements = elements;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
private final java.util.List<org.rascalmpl.ast.Expression> elements;
	public java.util.List<org.rascalmpl.ast.Expression> getElements() { return elements; }	
} public boolean isTuple() { return false; } static public class Tuple extends Expression {
/** "<" elements:{Expression ","}+ ">" -> Expression {cons("Tuple")} */
	protected Tuple(INode node, java.util.List<org.rascalmpl.ast.Expression> elements) {
		this.node = node;
		this.elements = elements;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
private final java.util.List<org.rascalmpl.ast.Expression> elements;
	public java.util.List<org.rascalmpl.ast.Expression> getElements() { return elements; }	
} public java.util.List<org.rascalmpl.ast.Mapping> getMappings() { throw new UnsupportedOperationException(); } public boolean hasMappings() { return false; } public boolean isMap() { return false; } static public class Map extends Expression {
/** "(" mappings:{Mapping ","}* ")" -> Expression {cons("Map")} */
	protected Map(INode node, java.util.List<org.rascalmpl.ast.Mapping> mappings) {
		this.node = node;
...
/** pattern:Expression ":=" expression:Expression -> Expression {non-assoc, cons("Match")} */
	protected Match(INode node, org.rascalmpl.ast.Expression pattern, org.rascalmpl.ast.Expression expression) {
		this.node = node;
...
/** pattern:Expression "!:=" expression:Expression -> Expression {non-assoc, cons("NoMatch")} */
	protected NoMatch(INode node, org.rascalmpl.ast.Expression pattern, org.rascalmpl.ast.Expression expression) {
		this.node = node;
		this.pattern = pattern;
		this.expression = expression;
	}
...
/** pattern:Expression "<-" expression:Expression -> Expression {prefer, cons("Enumerator")} */
	protected Enumerator(INode node, org.rascalmpl.ast.Expression pattern, org.rascalmpl.ast.Expression expression) {
		this.node = node;
		this.pattern = pattern;
		this.expression = expression;
	}
...
/** comprehension:Comprehension -> Expression {cons("Comprehension")} */
	protected Comprehension(INode node, org.rascalmpl.ast.Comprehension comprehension) {
		this.node = node;
...
/** "(" init:Expression "|" result:Expression "|" generators:{Expression ","}+ ")" -> Expression {cons("Reducer")} */
	protected Reducer(INode node, org.rascalmpl.ast.Expression init, org.rascalmpl.ast.Expression result, java.util.List<org.rascalmpl.ast.Expression> generators) {
		this.node = node;
		this.init = init;
		this.result = result;
...
/** "all" "(" generators:{Expression ","}+ ")" -> Expression {cons("All")} */
	protected All(INode node, java.util.List<org.rascalmpl.ast.Expression> generators) {
		this.node = node;
		this.generators = generators;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** "any" "(" generators:{Expression ","}+ ")" -> Expression {cons("Any")} */
	protected Any(INode node, java.util.List<org.rascalmpl.ast.Expression> generators) {
		this.node = node;
		this.generators = generators;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** type:Type name:Name -> Expression {cons("TypedVariable")} */
	protected TypedVariable(INode node, org.rascalmpl.ast.Type type, org.rascalmpl.ast.Name name) {
		this.node = node;
		this.type = type;
		this.name = name;
	}
...
/** qualifiedName:QualifiedName "*" -> Expression {cons("MultiVariable")} */
	protected MultiVariable(INode node, org.rascalmpl.ast.QualifiedName qualifiedName) {
		this.node = node;
		this.qualifiedName = qualifiedName;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** "/" pattern:Expression -> Expression {cons("Descendant")} */
	protected Descendant(INode node, org.rascalmpl.ast.Expression pattern) {
		this.node = node;
		this.pattern = pattern;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** name:Name ":" pattern:Expression -> Expression {cons("VariableBecomes")} */
	protected VariableBecomes(INode node, org.rascalmpl.ast.Name name, org.rascalmpl.ast.Expression pattern) {
		this.node = node;
		this.name = name;
		this.pattern = pattern;
	}
...
/** type:Type name:Name ":" pattern:Expression -> Expression {cons("TypedVariableBecomes")} */
	protected TypedVariableBecomes(INode node, org.rascalmpl.ast.Type type, org.rascalmpl.ast.Name name, org.rascalmpl.ast.Expression pattern) {
		this.node = node;
		this.type = type;
		this.name = name;
		this.pattern = pattern;
...
/** "[" type:Type "]" pattern:Expression -> Expression {cons("Guarded")} */
	protected Guarded(INode node, org.rascalmpl.ast.Type type, org.rascalmpl.ast.Expression pattern) {
		this.node = node;
		this.type = type;
		this.pattern = pattern;
	}
...
/** "!" pattern:Expression -> Expression {cons("Anti")} */
	protected Anti(INode node, org.rascalmpl.ast.Expression pattern) {
		this.node = node;
		this.pattern = pattern;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
