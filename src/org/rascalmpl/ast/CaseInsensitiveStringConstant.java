...
public abstract class CaseInsensitiveStringConstant extends AbstractAST {
  public CaseInsensitiveStringConstant(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends CaseInsensitiveStringConstant {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.CaseInsensitiveStringConstant> alternatives) {
    super(loc);
