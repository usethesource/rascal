...
public abstract class Visit extends AbstractAST {
  public Visit(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Visit {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Visit> alternatives) {
    super(loc);
...
public DefaultStrategy(ISourceLocation loc, org.rascalmpl.ast.Expression subject,  java.util.List<org.rascalmpl.ast.Case> cases) {
  super(loc);
...
public GivenStrategy(ISourceLocation loc, org.rascalmpl.ast.Strategy strategy,  org.rascalmpl.ast.Expression subject,  java.util.List<org.rascalmpl.ast.Case> cases) {
  super(loc);
