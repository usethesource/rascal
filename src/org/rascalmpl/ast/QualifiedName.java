...
public abstract class QualifiedName extends AbstractAST {
  public QualifiedName(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends QualifiedName {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.QualifiedName> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Name> names) {
  super(loc);
