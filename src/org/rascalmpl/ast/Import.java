...
/** "import" module:ImportedModule ";" -> Import {cons("Default")} */
	protected Default(INode node, org.rascalmpl.ast.ImportedModule module) {
		this.node = node;
		this.module = module;
	}
...
static public class Ambiguity extends Import {
  ...
  protected Ambiguity(INode node, java.util.List<org.rascalmpl.ast.Import> alternatives) {
...
/** "extend" module:ImportedModule ";" -> Import {cons("Extend")} */
	protected Extend(INode node, org.rascalmpl.ast.ImportedModule module) {
		this.node = node;
		this.module = module;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
...
/** syntax:SyntaxDefinition -> Import {cons("Syntax")} */
	protected Syntax(INode node, org.rascalmpl.ast.SyntaxDefinition syntax) {
		this.node = node;
		this.syntax = syntax;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
