...
public abstract class PatternWithAction extends AbstractAST {
  public PatternWithAction(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends PatternWithAction {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.PatternWithAction> alternatives) {
    super(loc);
...
public Replacing(ISourceLocation loc, org.rascalmpl.ast.Expression pattern,  org.rascalmpl.ast.Replacement replacement) {
  super(loc);
...
public Arbitrary(ISourceLocation loc, org.rascalmpl.ast.Expression pattern,  org.rascalmpl.ast.Statement statement) {
  super(loc);
