...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 701 + 701 * tags.hashCode() + 7 * name.hashCode() + 59 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 257 + 257 * tags.hashCode() + 743 * name.hashCode() + 199 * params.hashCode() + 179 * imports.hashCode() ; 
    } 
