...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 991 + 467 * tags.hashCode() + 19 * name.hashCode() + 643 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 193 + 821 * tags.hashCode() + 197 * name.hashCode() + 883 * params.hashCode() + 181 * imports.hashCode() ; 
    } 
