...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 811 + 281 * tags.hashCode() + 467 * name.hashCode() + 521 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 937 + 929 * tags.hashCode() + 503 * name.hashCode() + 719 * params.hashCode() + 61 * imports.hashCode() ; 
    } 
