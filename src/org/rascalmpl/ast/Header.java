...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 239 + 619 * tags.hashCode() + 547 * name.hashCode() + 929 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 977 + 163 * tags.hashCode() + 191 * name.hashCode() + 137 * params.hashCode() + 643 * imports.hashCode() ; 
    } 
