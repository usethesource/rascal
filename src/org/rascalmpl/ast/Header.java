...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 151 + 397 * tags.hashCode() + 137 * name.hashCode() + 811 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 709 + 167 * tags.hashCode() + 53 * name.hashCode() + 463 * params.hashCode() + 127 * imports.hashCode() ; 
    } 
