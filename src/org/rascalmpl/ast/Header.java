...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 929 + 337 * tags.hashCode() + 881 * name.hashCode() + 109 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 491 + 59 * tags.hashCode() + 709 * name.hashCode() + 409 * params.hashCode() + 617 * imports.hashCode() ; 
    } 
