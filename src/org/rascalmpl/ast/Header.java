...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 991 + 277 * tags.hashCode() + 683 * name.hashCode() + 293 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 421 + 991 * tags.hashCode() + 239 * name.hashCode() + 149 * params.hashCode() + 479 * imports.hashCode() ; 
    } 
