...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 599 + 389 * tags.hashCode() + 877 * name.hashCode() + 2 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 907 + 167 * tags.hashCode() + 593 * name.hashCode() + 349 * params.hashCode() + 643 * imports.hashCode() ; 
    } 
