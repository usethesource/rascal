...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 523 + 911 * tags.hashCode() + 263 * name.hashCode() + 941 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 521 + 761 * tags.hashCode() + 991 * name.hashCode() + 467 * params.hashCode() + 317 * imports.hashCode() ; 
    } 
