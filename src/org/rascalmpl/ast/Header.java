...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 691 + 383 * tags.hashCode() + 907 * name.hashCode() + 107 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 827 + 967 * tags.hashCode() + 181 * name.hashCode() + 311 * params.hashCode() + 191 * imports.hashCode() ; 
    } 
