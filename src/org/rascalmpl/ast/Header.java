...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 523 + 691 * tags.hashCode() + 571 * name.hashCode() + 659 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 719 + 307 * tags.hashCode() + 797 * name.hashCode() + 647 * params.hashCode() + 769 * imports.hashCode() ; 
    } 
