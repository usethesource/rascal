...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 13331 + 29 * tags.hashCode() + 71 * name.hashCode() + 13 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 13331 + 67 * tags.hashCode() + 13 * name.hashCode() + 13 * params.hashCode() + 19 * imports.hashCode() ; 
    } 
