...
public abstract class Label extends AbstractAST {
  public Label(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Label {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Label> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, org.rascalmpl.ast.Name name) {
  super(loc);
