...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 311 + 73 * first.hashCode() + 619 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 5 + 191 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 467 + 149 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 19 + 761 * symbol.hashCode() + 89 * column.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 577 + 263 * symbol.hashCode() + 647 * label.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 991 + 409 * symbol.hashCode() + 907 * match.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 509 + 151 * symbol.hashCode() + 599 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 149 + 541 * symbol.hashCode() + 353 * label.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 863 + 557 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 61 + 281 * symbol.hashCode() + 263 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 19 + 61 * match.hashCode() + 241 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 409 + 443 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 11 + 389 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 229 + 193 * nonterminal.hashCode() + 617 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 521 + 269 * match.hashCode() + 839 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 743 + 751 * first.hashCode() + 241 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 911 + 827 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 883 + 743 * symbol.hashCode() + 313 * match.hashCode() ; 
    } 
