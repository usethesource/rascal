...
public abstract class Sym extends AbstractAST {
  ...
  public org.rascalmpl.ast.StringLiteral getString() {
    throw new UnsupportedOperationException();
  }
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 19 + 761 * first.hashCode() + 89 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 587 + 67 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 191 + 577 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 263 + 647 * symbol.hashCode() + 991 * column.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 347 + 509 * symbol.hashCode() + 151 * label.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 599 + 29 * symbol.hashCode() + 941 * match.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 769 + 149 * symbol.hashCode() + 541 * sep.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 787 + 863 * symbol.hashCode() + 557 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 61 + 281 * symbol.hashCode() + 263 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    // Production: sig("Literal",[arg("org.rascalmpl.ast.StringLiteral","string")],breakable=false)
  
    
    private final org.rascalmpl.ast.StringLiteral string;
  
    public Literal(ISourceLocation src, IConstructor node , org.rascalmpl.ast.StringLiteral string) {
      super(src, node);
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 241 + 409 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 443 + 11 * symbol.hashCode() + 389 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 229 + 193 * match.hashCode() + 617 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 521 + 269 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 839 + 743 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 751 + 241 * nonterminal.hashCode() + 911 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 827 + 29 * match.hashCode() + 947 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 883 + 743 * first.hashCode() + 313 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 607 + 727 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 883 + 617 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 233 + 263 * symbol.hashCode() + 163 * match.hashCode() ; 
    } 
