...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 29 + 547 * first.hashCode() + 601 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 149 + 193 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 887 + 967 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 461 + 79 * symbol.hashCode() + 601 * column.hashCode() ; 
    } 
  ...
  static public class DependAlternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 857 + 401 * condition.hashCode() + 353 * thenPart.hashCode() + 743 * elsePart.hashCode() ; 
    } 
  ...
  static public class DependCode extends Sym {
    ...
    @Override
    public int hashCode() {
      return 163 + 653 * symbol.hashCode() + 577 * block.hashCode() ; 
    } 
  ...
  static public class DependConditionAfter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 571 + 881 * symbol.hashCode() + 263 * condition.hashCode() ; 
    } 
  ...
  static public class DependConditionBefore extends Sym {
    ...
    @Override
    public int hashCode() {
      return 229 + 23 * condition.hashCode() + 691 * thenPart.hashCode() ; 
    } 
  ...
  static public class DependFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 967 + 113 * symbol.hashCode() + 809 * typ.hashCode() + 173 * formals.hashCode() ; 
    } 
  ...
  static public class DependLoop extends Sym {
    ...
    @Override
    public int hashCode() {
      return 877 + 743 * condition.hashCode() + 773 * body.hashCode() ; 
    } 
  ...
  static public class DependNonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 739 + 41 * nonterminal.hashCode() + 461 * arguments.hashCode() + 181 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependParametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 419 + 859 * nonterminal.hashCode() + 163 * parameters.hashCode() + 829 * arguments.hashCode() + 641 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependVoidFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 881 + 761 * symbol.hashCode() + 491 * formals.hashCode() ; 
    } 
  ...
  static public class EndOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 769 + 983 * symbol.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 941 + 229 * symbol.hashCode() + 421 * label.hashCode() ; 
    } 
  ...
  static public class FarFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 19 + 263 * symbol.hashCode() + 191 * match.hashCode() ; 
    } 
  ...
  static public class FarNotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 31 + 401 * symbol.hashCode() + 373 * match.hashCode() ; 
    } 
  ...
  static public class FarNotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 263 + 157 * match.hashCode() + 521 * symbol.hashCode() ; 
    } 
  ...
  static public class FarPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 137 + 271 * match.hashCode() + 79 * symbol.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 643 + 653 * symbol.hashCode() + 107 * match.hashCode() ; 
    } 
  ...
  static public class Iter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 971 + 101 * symbol.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 479 + 283 * symbol.hashCode() + 877 * sep.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 3 + 463 * symbol.hashCode() + 563 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 821 + 311 * symbol.hashCode() + 409 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 947 + 379 * string.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 401 + 991 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 719 + 487 * symbol.hashCode() + 577 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 479 + 83 * match.hashCode() + 53 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 401 + 181 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 521 + 457 * nonterminal.hashCode() + 631 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 967 + 113 * match.hashCode() + 823 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 941 + 223 * first.hashCode() + 109 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 151 + 229 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 641 + 347 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 89 + 101 * symbol.hashCode() + 37 * match.hashCode() ; 
    } 
