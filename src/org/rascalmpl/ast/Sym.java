...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13 + 593 * first.hashCode() + 557 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 197 + 17 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 739 + 881 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 991 + 863 * symbol.hashCode() + 757 * column.hashCode() ; 
    } 
  ...
  static public class DependAlign extends Sym {
    ...
    @Override
    public int hashCode() {
      return 167 + 389 * symbol.hashCode() ; 
    } 
  ...
  static public class DependAlternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 739 + 23 * condition.hashCode() + 29 * thenPart.hashCode() + 83 * elsePart.hashCode() ; 
    } 
  ...
  static public class DependCode extends Sym {
    ...
    @Override
    public int hashCode() {
      return 139 + 139 * symbol.hashCode() + 499 * block.hashCode() ; 
    } 
  ...
  static public class DependConditionAfter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 241 + 193 * symbol.hashCode() + 521 * condition.hashCode() ; 
    } 
  ...
  static public class DependConditionBefore extends Sym {
    ...
    @Override
    public int hashCode() {
      return 59 + 419 * condition.hashCode() + 317 * thenPart.hashCode() ; 
    } 
  ...
  static public class DependFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 41 + 83 * symbol.hashCode() + 457 * typ.hashCode() + 569 * formals.hashCode() ; 
    } 
  ...
  static public class DependLoop extends Sym {
    ...
    @Override
    public int hashCode() {
      return 439 + 83 * condition.hashCode() + 359 * body.hashCode() ; 
    } 
  ...
  static public class DependNonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 5 + 563 * nonterminal.hashCode() + 347 * arguments.hashCode() + 911 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependOffside extends Sym {
    ...
    @Override
    public int hashCode() {
      return 941 + 353 * symbol.hashCode() ; 
    } 
  ...
  static public class DependParametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 107 + 619 * nonterminal.hashCode() + 677 * parameters.hashCode() + 701 * arguments.hashCode() + 653 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependScope extends Sym {
    ...
    @Override
    public int hashCode() {
      return 41 + 773 * symbols.hashCode() ; 
    } 
  ...
  static public class DependVoidFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 727 + 151 * symbol.hashCode() + 113 * formals.hashCode() ; 
    } 
  ...
  static public class EndOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 113 + 977 * symbol.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 283 + 443 * symbol.hashCode() + 173 * label.hashCode() ; 
    } 
  ...
  static public class FarFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 547 + 821 * symbol.hashCode() + 907 * match.hashCode() ; 
    } 
  ...
  static public class FarNotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 137 + 541 * symbol.hashCode() + 607 * match.hashCode() ; 
    } 
  ...
  static public class FarNotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 223 + 307 * match.hashCode() + 761 * symbol.hashCode() ; 
    } 
  ...
  static public class FarPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 109 + 887 * match.hashCode() + 211 * symbol.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 937 + 937 * symbol.hashCode() + 719 * match.hashCode() ; 
    } 
  ...
  static public class Iter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 113 + 107 * symbol.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 619 + 151 * symbol.hashCode() + 211 * sep.hashCode() ; 
    } 
  ...
  static public class IterStar extends Sym {
    ...
    @Override
    public int hashCode() {
      return 109 + 379 * symbol.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 661 + 557 * symbol.hashCode() + 563 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 149 + 479 * symbol.hashCode() + 677 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 173 + 809 * string.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 53 + 317 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 47 + 3 * symbol.hashCode() + 787 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 719 + 829 * match.hashCode() + 389 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 811 + 719 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 953 + 467 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 103 + 853 * nonterminal.hashCode() + 937 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 577 + 577 * match.hashCode() + 73 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 383 + 5 * first.hashCode() + 601 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 809 + 449 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 463 + 569 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 593 + 17 * symbol.hashCode() + 229 * match.hashCode() ; 
    } 
