...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 53 * first.hashCode() + 29 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 17 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 59 * symbol.hashCode() + 47 * column.hashCode() ; 
    } 
  ...
  static public class EndOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 53 * symbol.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 29 * symbol.hashCode() + 19 * label.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 53 * symbol.hashCode() + 59 * match.hashCode() ; 
    } 
  ...
  static public class Iter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * symbol.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 97 * symbol.hashCode() + 83 * sep.hashCode() ; 
    } 
  ...
  static public class IterStar extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * symbol.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 71 * symbol.hashCode() + 59 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 59 * symbol.hashCode() + 19 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * string.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 17 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 67 * symbol.hashCode() + 73 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 61 * match.hashCode() + 97 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 83 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 13 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 67 * nonterminal.hashCode() + 89 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 37 * match.hashCode() + 37 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * first.hashCode() + 79 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 37 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 17 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 13331 + 19 * symbol.hashCode() + 97 * match.hashCode() ; 
    } 
