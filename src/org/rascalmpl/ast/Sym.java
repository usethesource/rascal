...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 101 + 251 * first.hashCode() + 211 * alternatives.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 907 + 457 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 607 + 521 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 439 + 277 * symbol.hashCode() + 409 * column.hashCode() ; 
    } 
  ...
  static public class DependAlign extends Sym {
    ...
    @Override
    public int hashCode() {
      return 677 + 647 * symbol.hashCode() ; 
    } 
  ...
  static public class DependAlternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 313 + 487 * condition.hashCode() + 79 * thenPart.hashCode() + 433 * elsePart.hashCode() ; 
    } 
  ...
  static public class DependCode extends Sym {
    ...
    @Override
    public int hashCode() {
      return 887 + 919 * symbol.hashCode() + 79 * block.hashCode() ; 
    } 
  ...
  static public class DependConditionAfter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 601 + 809 * symbol.hashCode() + 571 * condition.hashCode() ; 
    } 
  ...
  static public class DependConditionBefore extends Sym {
    ...
    @Override
    public int hashCode() {
      return 37 + 773 * condition.hashCode() + 97 * thenPart.hashCode() ; 
    } 
  ...
  static public class DependFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 61 + 401 * symbol.hashCode() + 17 * typ.hashCode() + 199 * formals.hashCode() ; 
    } 
  ...
  static public class DependLoop extends Sym {
    ...
    @Override
    public int hashCode() {
      return 149 + 367 * condition.hashCode() + 463 * body.hashCode() ; 
    } 
  ...
  static public class DependNonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 31 + 757 * nonterminal.hashCode() + 787 * arguments.hashCode() + 653 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependOffside extends Sym {
    ...
    @Override
    public int hashCode() {
      return 191 + 463 * symbol.hashCode() ; 
    } 
  ...
  static public class DependParametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 281 + 643 * nonterminal.hashCode() + 61 * parameters.hashCode() + 139 * arguments.hashCode() + 577 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependScope extends Sym {
    ...
    @Override
    public int hashCode() {
      return 239 + 601 * symbols.hashCode() ; 
    } 
  ...
  static public class DependVoidFormals extends Sym {
    ...
    @Override
    public int hashCode() {
      return 773 + 439 * symbol.hashCode() + 733 * formals.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 941 + 257 * symbol.hashCode() + 7 * label.hashCode() ; 
    } 
  ...
  static public class FarFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 211 + 193 * symbol.hashCode() + 307 * match.hashCode() ; 
    } 
  ...
  static public class FarNotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 367 + 719 * symbol.hashCode() + 311 * match.hashCode() ; 
    } 
  ...
  static public class FarNotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 107 + 569 * match.hashCode() + 991 * symbol.hashCode() ; 
    } 
  ...
  static public class FarPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 607 + 601 * match.hashCode() + 269 * symbol.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 367 + 827 * symbol.hashCode() + 631 * match.hashCode() ; 
    } 
  ...
  static public class Iter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 491 + 593 * symbol.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 31 + 5 * symbol.hashCode() + 367 * sep.hashCode() ; 
    } 
  ...
  static public class IterStar extends Sym {
    ...
    @Override
    public int hashCode() {
      return 229 + 719 * symbol.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 379 + 607 * symbol.hashCode() + 127 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 823 + 157 * symbol.hashCode() + 971 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 941 + 571 * string.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 19 + 883 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 463 + 199 * symbol.hashCode() + 727 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 769 + 107 * match.hashCode() + 659 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 601 + 659 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 467 + 241 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 67 + 5 * nonterminal.hashCode() + 827 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 181 + 587 * match.hashCode() + 157 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 877 + 953 * first.hashCode() + 107 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 359 + 449 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 251 + 449 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 61 + 179 * symbol.hashCode() + 113 * match.hashCode() ; 
    } 
