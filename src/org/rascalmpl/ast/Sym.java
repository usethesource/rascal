...
public abstract class Sym extends AbstractAST {
  ...
  static public class Alternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 463 + 643 * first.hashCode() + 23 * alternatives.hashCode() ; 
    } 
  ...
  static public class Bracket extends Sym {
    ...
    @Override
    public int hashCode() {
      return 311 + 727 * symbol.hashCode() ; 
    } 
  ...
  static public class CaseInsensitiveLiteral extends Sym {
    ...
    @Override
    public int hashCode() {
      return 467 + 359 * cistring.hashCode() ; 
    } 
  ...
  static public class CharacterClass extends Sym {
    ...
    @Override
    public int hashCode() {
      return 43 + 257 * charClass.hashCode() ; 
    } 
  ...
  static public class Column extends Sym {
    ...
    @Override
    public int hashCode() {
      return 823 + 863 * symbol.hashCode() + 97 * column.hashCode() ; 
    } 
  ...
  static public class DependAlign extends Sym {
    ...
    @Override
    public int hashCode() {
      return 887 + 241 * symbol.hashCode() ; 
    } 
  ...
  static public class DependAlternative extends Sym {
    ...
    @Override
    public int hashCode() {
      return 163 + 3 * condition.hashCode() + 137 * thenPart.hashCode() + 3 * elsePart.hashCode() ; 
    } 
  ...
  static public class DependCode extends Sym {
    ...
    @Override
    public int hashCode() {
      return 179 + 239 * symbol.hashCode() + 661 * block.hashCode() ; 
    } 
  ...
  static public class DependConditionAfter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 467 + 829 * symbol.hashCode() + 769 * condition.hashCode() ; 
    } 
  ...
  static public class DependConditionBefore extends Sym {
    ...
    @Override
    public int hashCode() {
      return 853 + 89 * condition.hashCode() + 919 * thenPart.hashCode() ; 
    } 
  ...
  static public class DependLoop extends Sym {
    ...
    @Override
    public int hashCode() {
      return 677 + 557 * condition.hashCode() + 823 * body.hashCode() ; 
    } 
  ...
  static public class DependNonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 83 + 823 * nonterminal.hashCode() + 617 * arguments.hashCode() + 787 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependOffside extends Sym {
    ...
    @Override
    public int hashCode() {
      return 293 + 877 * symbol.hashCode() ; 
    } 
  ...
  static public class DependParametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 283 + 461 * nonterminal.hashCode() + 467 * parameters.hashCode() + 73 * arguments.hashCode() + 7 * keywordArguments.hashCode() ; 
    } 
  ...
  static public class DependScope extends Sym {
    ...
    @Override
    public int hashCode() {
      return 881 + 167 * symbols.hashCode() ; 
    } 
  ...
  static public class EndOfFile extends Sym {
    ...
    @Override
    public int hashCode() {
      return 863 + 733 * symbol.hashCode() ; 
    } 
  ...
  static public class Except extends Sym {
    ...
    @Override
    public int hashCode() {
      return 311 + 89 * symbol.hashCode() + 37 * label.hashCode() ; 
    } 
  ...
  static public class FarFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 587 + 809 * symbol.hashCode() + 769 * match.hashCode() ; 
    } 
  ...
  static public class FarNotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 547 + 199 * symbol.hashCode() + 787 * match.hashCode() ; 
    } 
  ...
  static public class FarNotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 839 + 613 * match.hashCode() + 719 * symbol.hashCode() ; 
    } 
  ...
  static public class FarPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 911 + 419 * match.hashCode() + 457 * symbol.hashCode() ; 
    } 
  ...
  static public class Follow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 2 + 223 * symbol.hashCode() + 643 * match.hashCode() ; 
    } 
  ...
  static public class IterSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 443 + 227 * symbol.hashCode() + 859 * sep.hashCode() ; 
    } 
  ...
  static public class IterStar extends Sym {
    ...
    @Override
    public int hashCode() {
      return 359 + 367 * symbol.hashCode() ; 
    } 
  ...
  static public class IterStarSep extends Sym {
    ...
    @Override
    public int hashCode() {
      return 443 + 883 * symbol.hashCode() + 541 * sep.hashCode() ; 
    } 
  ...
  static public class Labeled extends Sym {
    ...
    @Override
    public int hashCode() {
      return 523 + 233 * symbol.hashCode() + 809 * label.hashCode() ; 
    } 
  ...
  static public class Literal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 271 + 941 * string.hashCode() ; 
    } 
  ...
  static public class Nonterminal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 127 + 439 * nonterminal.hashCode() ; 
    } 
  ...
  static public class NotFollow extends Sym {
    ...
    @Override
    public int hashCode() {
      return 107 + 541 * symbol.hashCode() + 547 * match.hashCode() ; 
    } 
  ...
  static public class NotPrecede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 491 + 67 * match.hashCode() + 947 * symbol.hashCode() ; 
    } 
  ...
  static public class Optional extends Sym {
    ...
    @Override
    public int hashCode() {
      return 907 + 293 * symbol.hashCode() ; 
    } 
  ...
  static public class Parameter extends Sym {
    ...
    @Override
    public int hashCode() {
      return 619 + 97 * nonterminal.hashCode() ; 
    } 
  ...
  static public class Parametrized extends Sym {
    ...
    @Override
    public int hashCode() {
      return 709 + 503 * nonterminal.hashCode() + 557 * parameters.hashCode() ; 
    } 
  ...
  static public class Precede extends Sym {
    ...
    @Override
    public int hashCode() {
      return 271 + 41 * match.hashCode() + 419 * symbol.hashCode() ; 
    } 
  ...
  static public class Sequence extends Sym {
    ...
    @Override
    public int hashCode() {
      return 983 + 167 * first.hashCode() + 139 * sequence.hashCode() ; 
    } 
  ...
  static public class Start extends Sym {
    ...
    @Override
    public int hashCode() {
      return 353 + 233 * nonterminal.hashCode() ; 
    } 
  ...
  static public class StartOfLine extends Sym {
    ...
    @Override
    public int hashCode() {
      return 277 + 293 * symbol.hashCode() ; 
    } 
  ...
  static public class Unequal extends Sym {
    ...
    @Override
    public int hashCode() {
      return 593 + 233 * symbol.hashCode() + 173 * match.hashCode() ; 
    } 
