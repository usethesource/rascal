...
public abstract class Toplevel extends AbstractAST {
  public Toplevel(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Toplevel {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Toplevel> alternatives) {
    super(loc);
...
public GivenVisibility(ISourceLocation loc, org.rascalmpl.ast.Declaration declaration) {
  super(loc);
