...
public abstract class ImportedModule extends AbstractAST {
  ...
  static public class Actuals extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 43 + 233 * name.hashCode() + 71 * actuals.hashCode() ; 
    } 
  ...
  static public class ActualsRenaming extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 97 + 83 * name.hashCode() + 349 * actuals.hashCode() + 37 * renamings.hashCode() ; 
    } 
  ...
  static public class Renamings extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 19 + 673 * name.hashCode() + 101 * renamings.hashCode() ; 
    } 
