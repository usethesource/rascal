...
public abstract class ImportedModule extends AbstractAST {
  ...
  static public class Actuals extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 37 + 389 * name.hashCode() + 719 * actuals.hashCode() ; 
    } 
  ...
  static public class ActualsRenaming extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 797 + 109 * name.hashCode() + 349 * actuals.hashCode() + 797 * renamings.hashCode() ; 
    } 
  ...
  static public class Renamings extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 479 + 443 * name.hashCode() + 41 * renamings.hashCode() ; 
    } 
