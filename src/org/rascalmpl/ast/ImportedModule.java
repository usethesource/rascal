...
public abstract class ImportedModule extends AbstractAST {
  ...
  static public class Actuals extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 859 + 313 * name.hashCode() + 821 * actuals.hashCode() ; 
    } 
  ...
  static public class ActualsRenaming extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 727 + 137 * name.hashCode() + 281 * actuals.hashCode() + 313 * renamings.hashCode() ; 
    } 
  ...
  static public class Renamings extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 19 + 227 * name.hashCode() + 349 * renamings.hashCode() ; 
    } 
