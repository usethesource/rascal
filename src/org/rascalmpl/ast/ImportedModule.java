...
public abstract class ImportedModule extends AbstractAST {
  ...
  static public class Actuals extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 997 + 487 * name.hashCode() + 311 * actuals.hashCode() ; 
    } 
  ...
  static public class ActualsRenaming extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 3 + 409 * name.hashCode() + 421 * actuals.hashCode() + 13 * renamings.hashCode() ; 
    } 
  ...
  static public class Renamings extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 503 + 337 * name.hashCode() + 349 * renamings.hashCode() ; 
    } 
