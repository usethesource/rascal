...
public abstract class ImportedModule extends AbstractAST {
  ...
  static public class Actuals extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 421 + 419 * name.hashCode() + 229 * actuals.hashCode() ; 
    } 
  ...
  static public class ActualsRenaming extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 271 + 89 * name.hashCode() + 11 * actuals.hashCode() + 109 * renamings.hashCode() ; 
    } 
  ...
  static public class Renamings extends ImportedModule {
    ...
    @Override
    public int hashCode() {
      return 431 + 31 * name.hashCode() + 619 * renamings.hashCode() ; 
    } 
