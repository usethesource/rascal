...
public abstract class Command extends AbstractAST {
  ...
  static public class Declaration extends Command {
    ...
    @Override
    public int hashCode() {
      return 331 + 67 * declaration.hashCode() ; 
    } 
  ...
  static public class Expression extends Command {
    ...
    @Override
    public int hashCode() {
      return 983 + 43 * expression.hashCode() ; 
    } 
  ...
  static public class Import extends Command {
    ...
    @Override
    public int hashCode() {
      return 887 + 443 * imported.hashCode() ; 
    } 
  ...
  static public class Shell extends Command {
    ...
    @Override
    public int hashCode() {
      return 643 + 701 * command.hashCode() ; 
    } 
  ...
  static public class Statement extends Command {
    ...
    @Override
    public int hashCode() {
      return 257 + 281 * statement.hashCode() ; 
    } 
