...
public abstract class Command extends AbstractAST {
  ...
  static public class Declaration extends Command {
    ...
    @Override
    public int hashCode() {
      return 887 + 673 * declaration.hashCode() ; 
    } 
  ...
  static public class Expression extends Command {
    ...
    @Override
    public int hashCode() {
      return 241 + 127 * expression.hashCode() ; 
    } 
  ...
  static public class Import extends Command {
    ...
    @Override
    public int hashCode() {
      return 653 + 263 * imported.hashCode() ; 
    } 
  ...
  static public class Shell extends Command {
    ...
    @Override
    public int hashCode() {
      return 997 + 359 * command.hashCode() ; 
    } 
  ...
  static public class Statement extends Command {
    ...
    @Override
    public int hashCode() {
      return 857 + 571 * statement.hashCode() ; 
    } 
