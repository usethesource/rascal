...
public abstract class Command extends AbstractAST {
  ...
  static public class Declaration extends Command {
    ...
    @Override
    public int hashCode() {
      return 67 + 787 * declaration.hashCode() ; 
    } 
  ...
  static public class Expression extends Command {
    ...
    @Override
    public int hashCode() {
      return 823 + 19 * expression.hashCode() ; 
    } 
  ...
  static public class Import extends Command {
    ...
    @Override
    public int hashCode() {
      return 109 + 641 * imported.hashCode() ; 
    } 
  ...
  static public class Shell extends Command {
    ...
    @Override
    public int hashCode() {
      return 379 + 907 * command.hashCode() ; 
    } 
  ...
  static public class Statement extends Command {
    ...
    @Override
    public int hashCode() {
      return 827 + 239 * statement.hashCode() ; 
    } 
