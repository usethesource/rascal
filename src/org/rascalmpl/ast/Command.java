...
public abstract class Command extends AbstractAST {
  ...
  static public class Declaration extends Command {
    ...
    @Override
    public int hashCode() {
      return 367 + 593 * declaration.hashCode() ; 
    } 
  ...
  static public class Expression extends Command {
    ...
    @Override
    public int hashCode() {
      return 149 + 193 * expression.hashCode() ; 
    } 
  ...
  static public class Import extends Command {
    ...
    @Override
    public int hashCode() {
      return 953 + 443 * imported.hashCode() ; 
    } 
  ...
  static public class Shell extends Command {
    ...
    @Override
    public int hashCode() {
      return 349 + 587 * command.hashCode() ; 
    } 
  ...
  static public class Statement extends Command {
    ...
    @Override
    public int hashCode() {
      return 239 + 439 * statement.hashCode() ; 
    } 
