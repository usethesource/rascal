...
public abstract class Command extends AbstractAST {
  ...
  static public class Declaration extends Command {
    ...
    @Override
    public int hashCode() {
      return 631 + 101 * declaration.hashCode() ; 
    } 
  ...
  static public class Expression extends Command {
    ...
    @Override
    public int hashCode() {
      return 227 + 787 * expression.hashCode() ; 
    } 
  ...
  static public class Import extends Command {
    ...
    @Override
    public int hashCode() {
      return 997 + 233 * imported.hashCode() ; 
    } 
  ...
  static public class Shell extends Command {
    ...
    @Override
    public int hashCode() {
      return 599 + 751 * command.hashCode() ; 
    } 
  ...
  static public class Statement extends Command {
    ...
    @Override
    public int hashCode() {
      return 199 + 193 * statement.hashCode() ; 
    } 
