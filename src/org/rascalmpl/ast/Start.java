...
public abstract class Start extends AbstractAST {
  public Start(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Start {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Start> alternatives) {
    super(loc);
...
public Absent(ISourceLocation loc) {
  super(loc);
...
public Present(ISourceLocation loc) {
  super(loc);
