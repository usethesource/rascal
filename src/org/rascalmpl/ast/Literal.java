...
public abstract class Literal extends AbstractAST {
  ...
  static public class Boolean extends Literal {
    ...
    @Override
    public int hashCode() {
      return 487 + 71 * booleanLiteral.hashCode() ; 
    } 
  ...
  static public class DateTime extends Literal {
    ...
    @Override
    public int hashCode() {
      return 887 + 83 * dateTimeLiteral.hashCode() ; 
    } 
  ...
  static public class Integer extends Literal {
    ...
    @Override
    public int hashCode() {
      return 739 + 19 * integerLiteral.hashCode() ; 
    } 
  ...
  static public class Location extends Literal {
    ...
    @Override
    public int hashCode() {
      return 179 + 821 * locationLiteral.hashCode() ; 
    } 
  ...
  static public class Rational extends Literal {
    ...
    @Override
    public int hashCode() {
      return 797 + 223 * rationalLiteral.hashCode() ; 
    } 
  ...
  static public class Real extends Literal {
    ...
    @Override
    public int hashCode() {
      return 557 + 41 * realLiteral.hashCode() ; 
    } 
  ...
  static public class RegExp extends Literal {
    ...
    @Override
    public int hashCode() {
      return 373 + 907 * regExpLiteral.hashCode() ; 
    } 
  ...
  static public class String extends Literal {
    ...
    @Override
    public int hashCode() {
      return 271 + 733 * stringLiteral.hashCode() ; 
    } 
