...
public abstract class Literal extends AbstractAST {
  ...
  static public class Boolean extends Literal {
    ...
    @Override
    public int hashCode() {
      return 823 + 541 * booleanLiteral.hashCode() ; 
    } 
  ...
  static public class DateTime extends Literal {
    ...
    @Override
    public int hashCode() {
      return 359 + 911 * dateTimeLiteral.hashCode() ; 
    } 
  ...
  static public class Integer extends Literal {
    ...
    @Override
    public int hashCode() {
      return 43 + 647 * integerLiteral.hashCode() ; 
    } 
  ...
  static public class Location extends Literal {
    ...
    @Override
    public int hashCode() {
      return 101 + 167 * locationLiteral.hashCode() ; 
    } 
  ...
  static public class Rational extends Literal {
    ...
    @Override
    public int hashCode() {
      return 991 + 151 * rationalLiteral.hashCode() ; 
    } 
  ...
  static public class Real extends Literal {
    ...
    @Override
    public int hashCode() {
      return 397 + 631 * realLiteral.hashCode() ; 
    } 
  ...
  static public class RegExp extends Literal {
    ...
    @Override
    public int hashCode() {
      return 821 + 947 * regExpLiteral.hashCode() ; 
    } 
  ...
  static public class String extends Literal {
    ...
    @Override
    public int hashCode() {
      return 541 + 751 * stringLiteral.hashCode() ; 
    } 
