...
public abstract class Literal extends AbstractAST {
  ...
  static public class Boolean extends Literal {
    ...
    @Override
    public int hashCode() {
      return 653 + 827 * booleanLiteral.hashCode() ; 
    } 
  ...
  static public class DateTime extends Literal {
    ...
    @Override
    public int hashCode() {
      return 199 + 3 * dateTimeLiteral.hashCode() ; 
    } 
  ...
  static public class Integer extends Literal {
    ...
    @Override
    public int hashCode() {
      return 151 + 709 * integerLiteral.hashCode() ; 
    } 
  ...
  static public class Location extends Literal {
    ...
    @Override
    public int hashCode() {
      return 857 + 719 * locationLiteral.hashCode() ; 
    } 
  ...
  static public class Rational extends Literal {
    ...
    @Override
    public int hashCode() {
      return 337 + 101 * rationalLiteral.hashCode() ; 
    } 
  ...
  static public class Real extends Literal {
    ...
    @Override
    public int hashCode() {
      return 349 + 257 * realLiteral.hashCode() ; 
    } 
  ...
  static public class RegExp extends Literal {
    ...
    @Override
    public int hashCode() {
      return 577 + 419 * regExpLiteral.hashCode() ; 
    } 
  ...
  static public class String extends Literal {
    ...
    @Override
    public int hashCode() {
      return 877 + 631 * stringLiteral.hashCode() ; 
    } 
