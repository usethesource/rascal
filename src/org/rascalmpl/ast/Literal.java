...
public abstract class Literal extends AbstractAST {
  ...
  static public class Boolean extends Literal {
    ...
    @Override
    public int hashCode() {
      return 337 + 163 * booleanLiteral.hashCode() ; 
    } 
  ...
  static public class DateTime extends Literal {
    ...
    @Override
    public int hashCode() {
      return 5 + 331 * dateTimeLiteral.hashCode() ; 
    } 
  ...
  static public class Integer extends Literal {
    ...
    @Override
    public int hashCode() {
      return 97 + 433 * integerLiteral.hashCode() ; 
    } 
  ...
  static public class Location extends Literal {
    ...
    @Override
    public int hashCode() {
      return 191 + 743 * locationLiteral.hashCode() ; 
    } 
  ...
  static public class Rational extends Literal {
    ...
    @Override
    public int hashCode() {
      return 251 + 197 * rationalLiteral.hashCode() ; 
    } 
  ...
  static public class Real extends Literal {
    ...
    @Override
    public int hashCode() {
      return 229 + 83 * realLiteral.hashCode() ; 
    } 
  ...
  static public class RegExp extends Literal {
    ...
    @Override
    public int hashCode() {
      return 223 + 137 * regExpLiteral.hashCode() ; 
    } 
  ...
  static public class String extends Literal {
    ...
    @Override
    public int hashCode() {
      return 743 + 523 * stringLiteral.hashCode() ; 
    } 
