...
public abstract class Literal extends AbstractAST {
  ...
  static public class Boolean extends Literal {
    ...
    @Override
    public int hashCode() {
      return 487 + 569 * booleanLiteral.hashCode() ; 
    } 
  ...
  static public class DateTime extends Literal {
    ...
    @Override
    public int hashCode() {
      return 587 + 967 * dateTimeLiteral.hashCode() ; 
    } 
  ...
  static public class Integer extends Literal {
    ...
    @Override
    public int hashCode() {
      return 439 + 107 * integerLiteral.hashCode() ; 
    } 
  ...
  static public class Location extends Literal {
    ...
    @Override
    public int hashCode() {
      return 463 + 349 * locationLiteral.hashCode() ; 
    } 
  ...
  static public class Rational extends Literal {
    ...
    @Override
    public int hashCode() {
      return 283 + 19 * rationalLiteral.hashCode() ; 
    } 
  ...
  static public class Real extends Literal {
    ...
    @Override
    public int hashCode() {
      return 127 + 523 * realLiteral.hashCode() ; 
    } 
  ...
  static public class RegExp extends Literal {
    ...
    @Override
    public int hashCode() {
      return 887 + 521 * regExpLiteral.hashCode() ; 
    } 
  ...
  static public class String extends Literal {
    ...
    @Override
    public int hashCode() {
      return 673 + 239 * stringLiteral.hashCode() ; 
    } 
