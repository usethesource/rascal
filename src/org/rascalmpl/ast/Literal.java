...
public abstract class Literal extends AbstractAST {
	...
	static public class Location extends Literal {
		// Production:
		// sig("Location",[arg("org.rascalmpl.ast.LocationLiteral","locationLiteral")])

		private final org.rascalmpl.ast.LocationLiteral locationLiteral;

		public Location(INode node,
	...
	static public class String extends Literal {
		// Production:
		// sig("String",[arg("org.rascalmpl.ast.StringLiteral","stringLiteral")])
	...
	static public class RegExp extends Literal {
		// Production:
		// sig("RegExp",[arg("org.rascalmpl.ast.RegExpLiteral","regExpLiteral")])
	...
	static public class Real extends Literal {
		// Production:
		// sig("Real",[arg("org.rascalmpl.ast.RealLiteral","realLiteral")])
	...
	static public class Boolean extends Literal {
		// Production:
		// sig("Boolean",[arg("org.rascalmpl.ast.BooleanLiteral","booleanLiteral")])

		private final org.rascalmpl.ast.BooleanLiteral booleanLiteral;

		public Boolean(INode node,
	...
	static public class DateTime extends Literal {
		// Production:
		// sig("DateTime",[arg("org.rascalmpl.ast.DateTimeLiteral","dateTimeLiteral")])
	...
	static public class Integer extends Literal {
		// Production:
		// sig("Integer",[arg("org.rascalmpl.ast.IntegerLiteral","integerLiteral")])

		private final org.rascalmpl.ast.IntegerLiteral integerLiteral;

		public Integer(INode node,
