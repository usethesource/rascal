...
public abstract class Formals extends AbstractAST {
  public Formals(ISourceLocation loc) {
    super(loc);
  }
...
static public class Ambiguity extends Formals {
  ...
  public Ambiguity(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Formals> alternatives) {
    super(loc);
...
public Default(ISourceLocation loc, java.util.List<org.rascalmpl.ast.Expression> formals) {
  super(loc);
