...
public class JarURIResolver implements ISourceLocationInput {
    ...
    private static final Cache<String, FileTree> fsCache = Caffeine.newBuilder()
            .weigher((String e, FileTree v) -> (int) (v.totalSize() / 1024))
    ...
    protected FileTree getFileHierchyCache(final File jar) {
