...
public class RascalTutorCompile {
    private static final String MODULENAME = "lang::rascal::tutor::Compiler";
    ...
    public static void main(String[] args) {
        try {
            ...
            eval.addRascalSearchPath(URIUtil.getChildLocation(rascalJar, "org/rascalmpl/tutor"));
