...
public class Ambiguity extends Solve {
  private final List<Solve> alternatives;
  public Ambiguity(List<Solve> alternatives) {
	this.alternatives = Collections.immutableList(alternatives);
  }
  public List<Solve> getAlternatives() {
	return alternatives;
  }
} 
...
private Expression bound;
	public Expression getbound() { return bound; }
	private void privateSetbound(Expression x) { this.bound = x; }
