...
private Sort sort;
	...
	private void privateSetsort(Sort x) { this.sort = x; }
...
/* sort:Sort "[[" parameters:{Symbol ","}+ "]]" -> Symbol {cons("ParameterizedSort")} */
	...
	/*package*/ ParameterizedSort(ITree tree, Sort sort, List<Symbol> parameters) {
		this.tree = tree;
		this.sort = sort;
...
private Sort sort;
	...
	private void privateSetparameters(List<Symbol> x) { this.parameters = x; }
...
private Symbol head;
	public Symbol gethead() { return head; }
	private void privateSethead(Symbol x) { this.head = x; }
	...
	public List<Symbol> gettail() { return tail; }
	private void privateSettail(List<Symbol> x) { this.tail = x; }
...
private Symbol symbol;
	...
	private void privateSetsymbol(Symbol x) { this.symbol = x; }
...
private Symbol symbol;
	...
	private StrCon sep;
	public StrCon getsep() { return sep; }
	private void privateSetsep(StrCon x) { this.sep = x; }
...
private Symbol lhs;
	...
	private void privateSetlhs(Symbol x) { this.lhs = x; }
	...
	private Symbol rhs;
	public Symbol getrhs() { return rhs; }
	private void privateSetrhs(Symbol x) { this.rhs = x; }
...
private StrCon string;
	public StrCon getstring() { return string; }
	private void privateSetstring(StrCon x) { this.string = x; }
...
/* singelQuotedString:SingleQuotedStrCon -> Symbol {cons("CaseInsensitiveLiteral")} */
	...
	/*package*/ CaseInsensitiveLiteral(ITree tree, SingleQuotedStrCon singelQuotedString) {
		this.tree = tree;
...
private SingleQuotedStrCon singelQuotedString;
	public SingleQuotedStrCon getsingelQuotedString() { return singelQuotedString; }
	private void privateSetsingelQuotedString(SingleQuotedStrCon x) { this.singelQuotedString = x; }
