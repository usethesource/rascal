...
public interface IASTVisitor<T> {
	...
	public T visitDoubleLiteralLexical(DoubleLiteral.Lexical x);
	...
	public T visitModuleWordLexical(ModuleWord.Lexical x);

	public T visitModuleNameLexical(ModuleName.Lexical x);
	...
	public T visitDoubleLiteralAmbiguity(DoubleLiteral.Ambiguity x);
	...
	public T visitMatchAmbiguity(Match.Ambiguity x);
	...
	public T visitAreaAmbiguity(Area.Ambiguity x);

	public T visitModuleAmbiguity(Module.Ambiguity x);

	public T visitModuleWordAmbiguity(ModuleWord.Ambiguity x);

	public T visitModuleNameAmbiguity(ModuleName.Ambiguity x);
