...
public interface IASTVisitor<T> {
	...
	public T visitExpressionConcreteUnquoted(Expression.ConcreteUnquoted x);

	public T visitExpressionConcreteQuoted(Expression.ConcreteQuoted x);
	...
	public T visitPatternConcreteUnquoted(Pattern.ConcreteUnquoted x);

	public T visitPatternConcreteQuoted(Pattern.ConcreteQuoted x);

	public T visitXMetaVariable(X.MetaVariable x);
	...
	public T visitPatternAmbiguity(Pattern.Ambiguity x);

	public T visitXAmbiguity(X.Ambiguity x);
