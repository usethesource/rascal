...
/* ModuleWord -> ModuleName {cons("Leaf")} */
	...
	public IVisitable accept(IASTVisitor visitor) {
		return visitor.visitLeafModuleName(this);
	}	
}
...
/* sep:"/" basename:ModuleName -> ModuleName {cons("Root")} */
	private Root() { }
	/*package*/ Root(ITree tree, List<get-sort-from-symbol("/")> sep, ModuleName basename) {
		this.tree = tree;
		this.sep = sep;
		this.basename = basename;
	}
	public IVisitable accept(IASTVisitor visitor) {
		return visitor.visitRootModuleName(this);
	}
private List<get-sort-from-symbol("/")> sep;
	public List<get-sort-from-symbol("/")> getsep() { return sep; }
	private void privateSetsep(List<get-sort-from-symbol("/")> x) { this.sep = x; }
	...
	public ModuleName getbasename() { return basename; }
	private void privateSetbasename(ModuleName x) { this.basename = x; }
...
/* dirname:ModuleWord sep:"/" basename:ModuleName -> ModuleName {cons("Path")} */
	private Path() { }
	/*package*/ Path(ITree tree, ModuleWord dirname, List<get-sort-from-symbol("/")> sep, ModuleName basename) {
		this.tree = tree;
	...
	public IVisitable accept(IASTVisitor visitor) {
		return visitor.visitPathModuleName(this);
	}
private ModuleWord dirname;
	public ModuleWord getdirname() { return dirname; }
	private void privateSetdirname(ModuleWord x) { this.dirname = x; }
