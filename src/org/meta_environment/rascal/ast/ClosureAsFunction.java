...
/* "#" expression:Expression -> ClosureAsFunction {cons("Evaluated")} */
    ...
    public Evaluated setExpression (org.meta_environment.rascal.ast.
				    Expression x)
    {
  ...
  static public class Ambiguity extends ClosureAsFunction
  {
    private final java.util.List <
      org.meta_environment.rascal.ast.ClosureAsFunction > alternatives;
    public Ambiguity (java.util.List <
		      org.meta_environment.rascal.ast.ClosureAsFunction >
		      alternatives)
    {
      this.alternatives =
    ...
    public java.util.List <
      org.meta_environment.rascal.ast.ClosureAsFunction > getAlternatives ()
    {
      return alternatives;
    }
  }
