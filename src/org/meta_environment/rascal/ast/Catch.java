...
/** "catch" ":" body:Statement -> Catch {cons("Default")} */
	...
	public Default(INode node, org.meta_environment.rascal.ast.Statement body) {
		this.node = node;
		this.body = body;
	}
...
/** "catch" pattern:Expression ":" body:Statement -> Catch {cons("Binding")} */
	...
	public Binding(INode node, org.meta_environment.rascal.ast.Expression pattern, org.meta_environment.rascal.ast.Statement body) {
		this.node = node;
