...
/* "{" result:Expression "|" generators:{Generator ","}+ "}" -> Comprehension {cons("Set")} */
	private Set() { }
	/*package*/ Set(ITree tree, Expression result, List<Generator> generators) {
		this.tree = tree;
		this.result = result;
...
private Expression result;
	...
	private void privateSetresult(Expression x) { this.result = x; }
...
/* "[" result:Expression "|" generators:{Generator ","}+ "]" -> Comprehension {cons("List")} */
	private List() { }
	/*package*/ List(ITree tree, Expression result, List<Generator> generators) {
		this.tree = tree;
		this.result = result;
		this.generators = generators;
	}
