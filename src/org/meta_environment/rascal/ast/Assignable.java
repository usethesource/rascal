...
public org.meta_environment.rascal.ast.Assignable getFirst() { throw new UnsupportedOperationException(); }
	public java.util.List<org.meta_environment.rascal.ast.Assignable> getRest() { throw new UnsupportedOperationException(); }
...
/* "<" first:Assignable "," rest:{Assignable ","}+ ">" -> Assignable {cons("Tuple")} */
	private Tuple() { }
	/*package*/ Tuple(ITree tree, org.meta_environment.rascal.ast.Assignable first, java.util.List<org.meta_environment.rascal.ast.Assignable> rest) {
		this.tree = tree;
		this.first = first;
		this.rest = rest;
	}
...
private org.meta_environment.rascal.ast.Assignable first;
	public org.meta_environment.rascal.ast.Assignable getFirst() { return first; }
	private void $setFirst(org.meta_environment.rascal.ast.Assignable x) { this.first = x; }
	...
	public java.util.List<org.meta_environment.rascal.ast.Assignable> getRest() { return rest; }
	private void $setRest(java.util.List<org.meta_environment.rascal.ast.Assignable> x) { this.rest = x; }
	public Tuple setRest(java.util.List<org.meta_environment.rascal.ast.Assignable> x) { 
		Tuple z = new Tuple();
 		z.$setRest(x);
		return z;
	}	
