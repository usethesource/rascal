...
/* pattern:Pattern ":" expression:Expression -> ValueProducer {cons("DefaultStrategy")} */
	...
	/*package*/ DefaultStrategy(ITree tree, Pattern pattern, Expression expression) {
		this.tree = tree;
...
/* strategy:Strategy pattern:Pattern ":" expression:Expression -> ValueProducer {cons("GivenStrategy")} */
	...
	/*package*/ GivenStrategy(ITree tree, Strategy strategy, Pattern pattern, Expression expression) {
		this.tree = tree;
