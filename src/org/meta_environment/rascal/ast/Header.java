...
/* "module" name:ModuleName tags:Tags  imports:Import* -> Header {cons("Default")} */
	private Default() { }
	/*package*/ Default(ITree tree, ModuleName name, Tags tags, List<Import> imports) {
		this.tree = tree;
		this.name = name;
		this.tags = tags;
...
private ModuleName name;
	...
	private void privateSetname(ModuleName x) { this.name = x; }
	...
	private void privateSetimports(List<Import> x) { this.imports = x; }
...
/* "module" name:ModuleName params:ModuleParameters tags:Tags imports:Import* -> Header {cons("Parameters")} */
	private Parameters() { }
	/*package*/ Parameters(ITree tree, ModuleName name, ModuleParameters params, Tags tags, List<Import> imports) {
		this.tree = tree;
		this.name = name;
		this.params = params;
		this.tags = tags;
...
private ModuleName name;
	...
	public ModuleParameters getparams() { return params; }
	private void privateSetparams(ModuleParameters x) { this.params = x; }
