...
/* type:Type modifiers:FunctionModifiers name:FunctionName parameters:Parameters -> Signature {cons("NoThrows")} */
	private NoThrows() { }
	/*package*/ NoThrows(ITree tree, org.meta_environment.rascal.ast.Type type, org.meta_environment.rascal.ast.FunctionModifiers modifiers, org.meta_environment.rascal.ast.FunctionName name, org.meta_environment.rascal.ast.Parameters parameters) {
		this.tree = tree;
		this.type = type;
...
private org.meta_environment.rascal.ast.Type type;
	...
	public org.meta_environment.rascal.ast.FunctionName getName() { return name; }
	private void $setName(org.meta_environment.rascal.ast.FunctionName x) { this.name = x; }
...
/* type:Type modifiers:FunctionModifiers name:FunctionName parameters:Parameters "throws" exceptions:{Type ","}+ -> Signature {cons("WithThrows")} */
	private WithThrows() { }
	/*package*/ WithThrows(ITree tree, org.meta_environment.rascal.ast.Type type, org.meta_environment.rascal.ast.FunctionModifiers modifiers, org.meta_environment.rascal.ast.FunctionName name, org.meta_environment.rascal.ast.Parameters parameters, java.util.List<org.meta_environment.rascal.ast.Type> exceptions) {
		this.tree = tree;
		this.type = type;
		this.modifiers = modifiers;
		this.name = name;
