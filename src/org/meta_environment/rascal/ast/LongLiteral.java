...
/* decimalLong:DecimalLongLiteral -> LongLiteral {prefer, cons("DecimalLongLiteral")} */
    ...
    /*package */ DecimalLongLiteral (ITree tree,
				     ...
				     DecimalLongLiteral decimalLong)
    {
      this.tree = tree;
    ...
    public org.meta_environment.rascal.ast.
      DecimalLongLiteral getDecimalLong ()
    {
      return decimalLong;
    }
    private void $setDecimalLong (org.meta_environment.rascal.ast.
				  DecimalLongLiteral x)
    {
      this.decimalLong = x;
    }
    public DecimalLongLiteral setDecimalLong (org.meta_environment.rascal.ast.
					      DecimalLongLiteral x)
    {
...
/* hexLong:HexLongLiteral -> LongLiteral {prefer, cons("HexLongLiteral")} */
    ...
    private void $setHexLong (org.meta_environment.rascal.ast.
			      HexLongLiteral x)
    {
      this.hexLong = x;
    }
    public HexLongLiteral setHexLong (org.meta_environment.rascal.ast.
				      HexLongLiteral x)
    {
...
/* octalLong:OctalLongLiteral -> LongLiteral {prefer, cons("OctalLongLiteral")} */
    ...
    private void $setOctalLong (org.meta_environment.rascal.ast.
				OctalLongLiteral x)
    {
      this.octalLong = x;
    }
    public OctalLongLiteral setOctalLong (org.meta_environment.rascal.ast.
					  OctalLongLiteral x)
    {
