...
/* "\\n" -> SingleQuotedStrChar {cons("newline")} */
    ...
    {
      return visitor.visitSingleQuotedStrCharnewline (this);
    }
  }
...
/* "\\t" -> SingleQuotedStrChar {cons("tab")} */
    ...
    public IVisitable accept (IASTVisitor visitor)
    {
      return visitor.visitSingleQuotedStrChartab (this);
    }
  }
...
/* "\\'" -> SingleQuotedStrChar {cons("quote")} */
    ...
    public IVisitable accept (IASTVisitor visitor)
    {
      return visitor.visitSingleQuotedStrCharquote (this);
    }
  }
...
/* "\\\\" -> SingleQuotedStrChar {cons("backslash")} */
    ...
    public IVisitable accept (IASTVisitor visitor)
    {
      return visitor.visitSingleQuotedStrCharbackslash (this);
    }
  }
...
/* "\\" a:[0-9]b:[0-9]c:[0-9] -> SingleQuotedStrChar {cons("decimal")} */
    ...
    public IVisitable accept (IASTVisitor visitor)
    {
      return visitor.visitSingleQuotedStrChardecimal (this);
    }
...
/* ~[\0-\31\n\t\'\\] -> SingleQuotedStrChar {cons("normal")} */
    ...
    public IVisitable accept (IASTVisitor visitor)
    {
      return visitor.visitSingleQuotedStrCharnormal (this);
    }
  }
}
