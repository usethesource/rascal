...
public org.meta_environment.rascal.ast.SymbolLiteral getSymbolLiteral() { throw new UnsupportedOperationException(); }
public boolean hasSymbolLiteral() { return false; }
public boolean isSymbol() { return false; }
static public class Symbol extends Literal {
/* symbolLiteral:SymbolLiteral -> Literal {cons("Symbol")} */
	private Symbol() { }
	/*package*/ Symbol(ITree tree, org.meta_environment.rascal.ast.SymbolLiteral symbolLiteral) {
		this.tree = tree;
	...
	public boolean hasSymbolLiteral() { return true; }

private org.meta_environment.rascal.ast.SymbolLiteral symbolLiteral;
	public org.meta_environment.rascal.ast.SymbolLiteral getSymbolLiteral() { return symbolLiteral; }
	private void $setSymbolLiteral(org.meta_environment.rascal.ast.SymbolLiteral x) { this.symbolLiteral = x; }
	public Symbol setSymbolLiteral(org.meta_environment.rascal.ast.SymbolLiteral x) { 
		Symbol z = new Symbol();
...
public org.meta_environment.rascal.ast.IntegerLiteral getIntegerLiteral() { throw new UnsupportedOperationException(); }
