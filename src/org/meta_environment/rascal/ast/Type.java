...
private BasicType basic;
	public BasicType getbasic() { return basic; }
	private void privateSetbasic(BasicType x) { this.basic = x; }
...
private StructuredType structured;
	public StructuredType getstructured() { return structured; }
	private void privateSetstructured(StructuredType x) { this.structured = x; }
...
private FunctionType function;
	...
	private void privateSetfunction(FunctionType x) { this.function = x; }
...
private TypeVar typeVar;
	...
	private void privateSettypeVar(TypeVar x) { this.typeVar = x; }
...
private DataTypeSelector selector;
	public DataTypeSelector getselector() { return selector; }
	private void privateSetselector(DataTypeSelector x) { this.selector = x; }
