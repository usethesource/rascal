...
public class NullASTVisitor<T> implements IASTVisitor<T>{
	...
	public T visitStringTailMid(StringTail.Mid x){
		return null;
	}
	...
	public T visitStringMiddleLexical(StringMiddle.Lexical x){
		return null;
	}
	...
	public T visitLocationLiteralFile(LocationLiteral.File x){
		return null;
	}
