...
/* signature:Signature tags:Tags body:FunctionBody -> FunctionDeclaration {cons("Default")} */
	private Default() { }
	/*package*/ Default(ITree tree, Signature signature, Tags tags, FunctionBody body) {
		this.tree = tree;
...
private Signature signature;
	...
	private void privateSetsignature(Signature x) { this.signature = x; }
	...
	private void privateSetbody(FunctionBody x) { this.body = x; }
