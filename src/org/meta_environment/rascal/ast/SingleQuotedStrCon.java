...
/* [\'] chars:SingleQuotedStrChar* [\'] -> SingleQuotedStrCon {cons("default")} */
	...
	public IVisitable accept(IASTVisitor visitor) {
		return visitor.visitdefaultSingleQuotedStrCon(this);
	}
private List<SingleQuotedStrChar> chars;
	public List<SingleQuotedStrChar> getchars() { return chars; }
	private void privateSetchars(List<SingleQuotedStrChar> x) { this.chars = x; }
