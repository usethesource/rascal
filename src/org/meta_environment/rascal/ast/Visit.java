...
/* "visit" "(" subject:Expression ")" "{" cases:Case+ "}" -> Visit {cons("DefaultStrategy")} */
	...
	/*package*/ DefaultStrategy(ITree tree, Expression subject, List<Case> cases) {
		this.tree = tree;
...
private Expression subject;
	...
	private void privateSetsubject(Expression x) { this.subject = x; }
...
/* strategy:Strategy "visit" "(" subject:Expression ")" "{" cases:Case+ "}" -> Visit {cons("GivenStrategy")} */
	...
	/*package*/ GivenStrategy(ITree tree, Strategy strategy, Expression subject, List<Case> cases) {
		this.tree = tree;
...
private Strategy strategy;
	...
	private void privateSetstrategy(Strategy x) { this.strategy = x; }
