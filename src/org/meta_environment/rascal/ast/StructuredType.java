...
private TypeArg typeArg;
	public TypeArg gettypeArg() { return typeArg; }
	private void privateSettypeArg(TypeArg x) { this.typeArg = x; }
...
private TypeArg first;
	public TypeArg getfirst() { return first; }
	private void privateSetfirst(TypeArg x) { this.first = x; }
	...
	public TypeArg getsecond() { return second; }
	private void privateSetsecond(TypeArg x) { this.second = x; }
...
private TypeArg first;
	...
	public List<TypeArg> getrest() { return rest; }
	private void privateSetrest(List<TypeArg> x) { this.rest = x; }
