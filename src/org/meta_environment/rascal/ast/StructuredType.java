...
/** "map" "[" first:TypeArg "," second:TypeArg "]" -> StructuredType {cons("Map")} */
	...
	public Map(INode node, org.meta_environment.rascal.ast.TypeArg first, org.meta_environment.rascal.ast.TypeArg second) {
		this.node = node;
		this.first = first;
		this.second = second;
	}
...
/** "rel" "[" arguments:{TypeArg ","}+ "]" -> StructuredType {cons("Relation")} */
	...
	public Relation(INode node, java.util.List<org.meta_environment.rascal.ast.TypeArg> arguments) {
		this.node = node;
...
/** "tuple" "[" arguments:{TypeArg ","}+  "]" -> StructuredType {cons("Tuple")} */
	...
	public Tuple(INode node, java.util.List<org.meta_environment.rascal.ast.TypeArg> arguments) {
		this.node = node;
		this.arguments = arguments;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
