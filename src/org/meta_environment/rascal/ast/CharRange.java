...
private Character character;
	...
	private void privateSetcharacter(Character x) { this.character = x; }
...
private Character start;
	...
	private void privateSetstart(Character x) { this.start = x; }
	...
	public Character getend() { return end; }
	private void privateSetend(Character x) { this.end = x; }
