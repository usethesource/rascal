...
/* name:Name "(" arguments:{TypeArg ","}+ ")" -> Variant {cons("NAryConstructor")} */
	...
	/*package*/ NAryConstructor(ITree tree, Name name, List<TypeArg> arguments) {
		this.tree = tree;
		this.name = name;
...
private Name name;
	...
	public List<TypeArg> getarguments() { return arguments; }
	private void privateSetarguments(List<TypeArg> x) { this.arguments = x; }
