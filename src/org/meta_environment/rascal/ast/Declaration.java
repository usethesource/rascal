...
/* "rule" name:Name tags:Tags patternAction:PatternWithAction ";" -> Declaration {cons("Rule")} */
	...
	/*package*/ Rule(INode node, org.meta_environment.rascal.ast.Name name, org.meta_environment.rascal.ast.Tags tags, org.meta_environment.rascal.ast.PatternWithAction patternAction) {
		this.node = node;
		this.name = name;
		this.tags = tags;
