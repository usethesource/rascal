...
private CharRange range;
	public CharRange getrange() { return range; }
	private void privateSetrange(CharRange x) { this.range = x; }
...
private CharRanges lhs;
	public CharRanges getlhs() { return lhs; }
	private void privateSetlhs(CharRanges x) { this.lhs = x; }
	...
	public CharRanges getrhs() { return rhs; }
	private void privateSetrhs(CharRanges x) { this.rhs = x; }
