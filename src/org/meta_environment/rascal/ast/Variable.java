...
/* name:Name tags:Tags "=" initial:Expression -> Variable {cons("GivenInitialization")} */
	...
	/*package*/ GivenInitialization(ITree tree, Name name, Tags tags, Expression initial) {
		this.tree = tree;
		this.name = name;
		this.tags = tags;
...
private Name name;
	...
	public Expression getinitial() { return initial; }
	private void privateSetinitial(Expression x) { this.initial = x; }
