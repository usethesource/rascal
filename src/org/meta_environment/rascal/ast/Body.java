...
public abstract class Body extends AbstractAST {
	public org.meta_environment.rascal.ast.Marker getMarker() {
		throw new UnsupportedOperationException();
	}

	public org.meta_environment.rascal.ast.Rest getRest() {
		throw new UnsupportedOperationException();
	}
	...
	static public class Anything extends Body {
		...
		public Anything(INode node,
				org.meta_environment.rascal.ast.Marker marker,
		...
		private void $setMarker(org.meta_environment.rascal.ast.Marker x) {
			this.marker = x;
		}
		...
		private void $setRest(org.meta_environment.rascal.ast.Rest x) {
			this.rest = x;
		}
