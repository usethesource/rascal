...
/* name:ModuleName actuals:ModuleActuals renamings:Renamings -> ImportedModule {cons("ActualsRenaming")} */
	...
	/*package*/ ActualsRenaming(ITree tree, ModuleName name, ModuleActuals actuals, Renamings renamings) {
		this.tree = tree;
		this.name = name;
...
private ModuleName name;
	...
	public ModuleActuals getactuals() { return actuals; }
	private void privateSetactuals(ModuleActuals x) { this.actuals = x; }
	...
	public Renamings getrenamings() { return renamings; }
	private void privateSetrenamings(Renamings x) { this.renamings = x; }
