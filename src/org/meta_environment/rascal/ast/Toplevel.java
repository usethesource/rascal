...
/** visibility:Visibility declaration:Declaration -> Toplevel {cons("GivenVisibility")} */
	...
	public GivenVisibility(INode node, org.meta_environment.rascal.ast.Visibility visibility, org.meta_environment.rascal.ast.Declaration declaration) {
		this.node = node;
...
/** declaration:Declaration -> Toplevel {cons("DefaultVisibility")} */
	...
	public DefaultVisibility(INode node, org.meta_environment.rascal.ast.Declaration declaration) {
		this.node = node;
		this.declaration = declaration;
	}
	public <T> T accept(IASTVisitor<T> visitor) {
