...
/* visibility:Visibility declaration:Declaration -> Toplevel {cons("GivenVisibility")} */
	...
	/*package*/ GivenVisibility(ITree tree, Visibility visibility, Declaration declaration) {
		this.tree = tree;
...
private Visibility visibility;
	...
	private void privateSetvisibility(Visibility x) { this.visibility = x; }
	...
	private void privateSetdeclaration(Declaration x) { this.declaration = x; }
