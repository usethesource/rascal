...
public class ASTFactory
{
  ...
  public org.meta_environment.rascal.ast.Variant.
    Type makeVariantType (ITree tree,
			  org.meta_environment.rascal.ast.Type type,
			  org.meta_environment.rascal.ast.Name name)
  {
  ...
  public org.meta_environment.rascal.ast.Symbol.
    Lexical makeSymbolLexical (ITree tree, String string)
  {
    org.meta_environment.rascal.ast.Symbol.Lexical x =
      new org.meta_environment.rascal.ast.Symbol.Lexical (tree, string);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
