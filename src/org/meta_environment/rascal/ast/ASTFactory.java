...
org.meta_environment.rascal.ast.Expression.CallOrTree x = (org.meta_environment.rascal.ast.Expression.CallOrTree) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Expression.CallOrTree(node, expression, arguments);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.ShellCommand.SetOption x = (org.meta_environment.rascal.ast.ShellCommand.SetOption) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.SetOption(node, name, expression);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.ShellCommand.Undeclare x = (org.meta_environment.rascal.ast.ShellCommand.Undeclare) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.Undeclare(node, name);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.ShellCommand.Unimport x = (org.meta_environment.rascal.ast.ShellCommand.Unimport) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.Unimport(node, name);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
public org.meta_environment.rascal.ast.ShellCommand.Test makeShellCommandTest(INode node) { 
org.meta_environment.rascal.ast.ShellCommand.Test x = (org.meta_environment.rascal.ast.ShellCommand.Test) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.Test(node);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
public org.meta_environment.rascal.ast.ShellCommand.ListDeclarations makeShellCommandListDeclarations(INode node) { 
org.meta_environment.rascal.ast.ShellCommand.ListDeclarations x = (org.meta_environment.rascal.ast.ShellCommand.ListDeclarations) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.ListDeclarations(node);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
public org.meta_environment.rascal.ast.ShellCommand.ListModules makeShellCommandListModules(INode node) { 
org.meta_environment.rascal.ast.ShellCommand.ListModules x = (org.meta_environment.rascal.ast.ShellCommand.ListModules) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.ShellCommand.ListModules(node);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Declaration.Test x = (org.meta_environment.rascal.ast.Declaration.Test) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Declaration.Test(node, test);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Test.Ambiguity amb = (org.meta_environment.rascal.ast.Test.Ambiguity) ambCache.get(node);
     if(amb == null){
     	amb = new org.meta_environment.rascal.ast.Test.Ambiguity(node, alternatives);
     	ambCache.putUnsafe(node, amb);
     }
     return amb; 
}
