...
public class ASTFactory
{
  ...
  public org.meta_environment.rascal.ast.Expression.
    Area makeExpressionArea (ITree tree,
			     org.meta_environment.rascal.ast.Area area)
  {
    org.meta_environment.rascal.ast.Expression.Area x =
      new org.meta_environment.rascal.ast.Expression.Area (tree, area);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.Expression.
    Map makeExpressionMap (ITree tree)
  {
    org.meta_environment.rascal.ast.Expression.Map x =
      new org.meta_environment.rascal.ast.Expression.Map (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.Expression.
    NonEmptySet makeExpressionNonEmptySet (ITree tree,
					   java.util.List <
					   org.meta_environment.rascal.ast.
					   Expression > elements)
  {
    org.meta_environment.rascal.ast.Expression.NonEmptySet x =
      new org.meta_environment.rascal.ast.Expression.NonEmptySet (tree,
								  elements);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.Expression.
    EmptySetOrBlock makeExpressionEmptySetOrBlock (ITree tree)
  {
    org.meta_environment.rascal.ast.Expression.EmptySetOrBlock x =
      new org.meta_environment.rascal.ast.Expression.EmptySetOrBlock (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.Expression.
    FunctionAsValue makeExpressionFunctionAsValue (ITree tree,
						   org.meta_environment.
						   rascal.ast.
						   FunctionAsValue function)
  {
    org.meta_environment.rascal.ast.Expression.FunctionAsValue x =
      new org.meta_environment.rascal.ast.Expression.FunctionAsValue (tree,
								      function);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.Expression.
    OperatorAsValue makeExpressionOperatorAsValue (ITree tree,
						   org.meta_environment.
						   rascal.ast.
						   OperatorAsValue operator)
  {
    org.meta_environment.rascal.ast.Expression.OperatorAsValue x =
      new org.meta_environment.rascal.ast.Expression.OperatorAsValue (tree,
								      operator);
    if (!table.containsKey (x))
      {
	table.put (x, x);
				       ...
				       Expression last)
  {
    org.meta_environment.rascal.ast.Expression.StepRange x =
      new org.meta_environment.rascal.ast.Expression.StepRange (tree, first,
								second, last);
    if (!table.containsKey (x))
      {
	table.put (x, x);
			       ...
			       Expression last)
  {
    org.meta_environment.rascal.ast.Expression.Range x =
      new org.meta_environment.rascal.ast.Expression.Range (tree, first,
							    last);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.Expression.
    NonEmptyBlock makeExpressionNonEmptyBlock (ITree tree,
					       java.util.List <
					       org.meta_environment.rascal.
					       ast.Statement > statements)
  {
    org.meta_environment.rascal.ast.Expression.NonEmptyBlock x =
      new org.meta_environment.rascal.ast.Expression.NonEmptyBlock (tree,
								    statements);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.Expression.
    VoidClosure makeExpressionVoidClosure (ITree tree,
					   org.meta_environment.rascal.ast.
  ...
  {
    org.meta_environment.rascal.ast.Expression.VoidClosure x =
      new org.meta_environment.rascal.ast.Expression.VoidClosure (tree,
								  parameters,
								  statements);
    if (!table.containsKey (x))
      {
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    NotIn makeOperatorAsValueNotIn (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.NotIn x =
      new org.meta_environment.rascal.ast.OperatorAsValue.NotIn (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    In makeOperatorAsValueIn (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.In x =
      new org.meta_environment.rascal.ast.OperatorAsValue.In (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Not makeOperatorAsValueNot (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Not x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Not (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Or makeOperatorAsValueOr (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Or x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Or (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    And makeOperatorAsValueAnd (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.And x =
      new org.meta_environment.rascal.ast.OperatorAsValue.And (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    GreaterThanOrEq makeOperatorAsValueGreaterThanOrEq (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.GreaterThanOrEq x =
      new org.meta_environment.rascal.ast.OperatorAsValue.
      GreaterThanOrEq (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
    return (org.meta_environment.rascal.ast.OperatorAsValue.
	    GreaterThanOrEq) table.get (x);
  }
  public org.meta_environment.rascal.ast.OperatorAsValue.
    GreaterThan makeOperatorAsValueGreaterThan (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.GreaterThan x =
      new org.meta_environment.rascal.ast.OperatorAsValue.GreaterThan (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    LessThanOrEq makeOperatorAsValueLessThanOrEq (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.LessThanOrEq x =
      new org.meta_environment.rascal.ast.OperatorAsValue.LessThanOrEq (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    LessThan makeOperatorAsValueLessThan (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.LessThan x =
      new org.meta_environment.rascal.ast.OperatorAsValue.LessThan (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    NotEquals makeOperatorAsValueNotEquals (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.NotEquals x =
      new org.meta_environment.rascal.ast.OperatorAsValue.NotEquals (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Equals makeOperatorAsValueEquals (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Equals x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Equals (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Intersection makeOperatorAsValueIntersection (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Intersection x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Intersection (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Division makeOperatorAsValueDivision (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Division x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Division (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Product makeOperatorAsValueProduct (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Product x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Product (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Substraction makeOperatorAsValueSubstraction (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Substraction x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Substraction (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Ambiguity makeOperatorAsValueAmbiguity (java.util.List <
					    org.meta_environment.rascal.ast.
					    OperatorAsValue > alternatives)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Ambiguity amb =
      new org.meta_environment.rascal.ast.OperatorAsValue.
  ...
  public org.meta_environment.rascal.ast.OperatorAsValue.
    Addition makeOperatorAsValueAddition (ITree tree)
  {
    org.meta_environment.rascal.ast.OperatorAsValue.Addition x =
      new org.meta_environment.rascal.ast.OperatorAsValue.Addition (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
  ...
  public org.meta_environment.rascal.ast.FunctionAsValue.
    Ambiguity makeFunctionAsValueAmbiguity (java.util.List <
					    org.meta_environment.rascal.ast.
					    FunctionAsValue > alternatives)
  {
    org.meta_environment.rascal.ast.FunctionAsValue.Ambiguity amb =
      new org.meta_environment.rascal.ast.FunctionAsValue.
      Ambiguity (alternatives);
    if (!table.containsKey (amb))
      {
	table.put (amb, amb);
  ...
  public org.meta_environment.rascal.ast.FunctionAsValue.
    Default makeFunctionAsValueDefault (ITree tree,
					org.meta_environment.rascal.ast.
					Name name)
  {
    org.meta_environment.rascal.ast.FunctionAsValue.Default x =
      new org.meta_environment.rascal.ast.FunctionAsValue.Default (tree,
								   name);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.ClosureAsFunction.
    Ambiguity makeClosureAsFunctionAmbiguity (java.util.List <
					      org.meta_environment.rascal.ast.
					      ClosureAsFunction >
					      alternatives)
  {
    org.meta_environment.rascal.ast.ClosureAsFunction.Ambiguity amb =
      new org.meta_environment.rascal.ast.ClosureAsFunction.
      Ambiguity (alternatives);
    if (!table.containsKey (amb))
      {
	table.put (amb, amb);
      }
    return (org.meta_environment.rascal.ast.ClosureAsFunction.
	    Ambiguity) table.get (amb);
  }
  public org.meta_environment.rascal.ast.ClosureAsFunction.
    Evaluated makeClosureAsFunctionEvaluated (ITree tree,
					      org.meta_environment.rascal.ast.
					      Expression expression)
  {
    org.meta_environment.rascal.ast.ClosureAsFunction.Evaluated x =
      new org.meta_environment.rascal.ast.ClosureAsFunction.Evaluated (tree,
								       expression);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.BasicType.
    Tree makeBasicTypeTree (ITree tree)
  {
    org.meta_environment.rascal.ast.BasicType.Tree x =
      new org.meta_environment.rascal.ast.BasicType.Tree (tree);
    if (!table.containsKey (x))
      {
	table.put (x, x);
      }
				   ...
				   arguments)
  {
    org.meta_environment.rascal.ast.StructuredType.Tuple x =
      new org.meta_environment.rascal.ast.StructuredType.Tuple (tree,
								arguments);
    if (!table.containsKey (x))
      {
	table.put (x, x);
  ...
  public org.meta_environment.rascal.ast.Comprehension.
    Map makeComprehensionMap (ITree tree,
			      ...
			      generators)
  {
    org.meta_environment.rascal.ast.Comprehension.Map x =
      new org.meta_environment.rascal.ast.Comprehension.Map (tree, from, to,
							     generators);
    if (!table.containsKey (x))
      {
	table.put (x, x);
