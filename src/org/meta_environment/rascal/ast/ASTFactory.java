...
public org.meta_environment.rascal.ast.Expression.ConcreteUnquoted makeExpressionConcreteUnquoted(INode node, org.meta_environment.rascal.ast.X symbol) { 
return new org.meta_environment.rascal.ast.Expression.ConcreteUnquoted(node, symbol); 
}
public org.meta_environment.rascal.ast.Expression.ConcreteQuoted makeExpressionConcreteQuoted(INode node, org.meta_environment.rascal.ast.X symbol) { 
return new org.meta_environment.rascal.ast.Expression.ConcreteQuoted(node, symbol); 
}
...
return new org.meta_environment.rascal.ast.Expression.Location(node, url, offset, length, beginLine, beginColumn, endLine, endColumn); 
}
...
return new org.meta_environment.rascal.ast.Expression.CallOrTree(node, qualifiedName, arguments); 
}
...
return new org.meta_environment.rascal.ast.Expression.ClosureCall(node, closure, arguments); 
}
...
return new org.meta_environment.rascal.ast.Expression.FunctionAsValue(node, function); 
}
...
return new org.meta_environment.rascal.ast.Expression.OperatorAsValue(node, operator); 
}
...
return new org.meta_environment.rascal.ast.OperatorAsValue.Intersection(node); 
}
public org.meta_environment.rascal.ast.OperatorAsValue.Division makeOperatorAsValueDivision(INode node) { 
return new org.meta_environment.rascal.ast.OperatorAsValue.Division(node); 
}
...
return new org.meta_environment.rascal.ast.OperatorAsValue.Subtraction(node); 
}
...
return new org.meta_environment.rascal.ast.OperatorAsValue.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.OperatorAsValue.Addition makeOperatorAsValueAddition(INode node) { 
return new org.meta_environment.rascal.ast.OperatorAsValue.Addition(node); 
}
...
return new org.meta_environment.rascal.ast.FunctionAsValue.Ambiguity(node, alternatives); 
}
...
return new org.meta_environment.rascal.ast.FunctionAsValue.Default(node, name); 
}
...
return new org.meta_environment.rascal.ast.ClosureAsFunction.Ambiguity(node, alternatives); 
}
...
return new org.meta_environment.rascal.ast.ClosureAsFunction.Evaluated(node, expression); 
}
...
return new org.meta_environment.rascal.ast.Comprehension.List(node, result, generators); 
}
...
return new org.meta_environment.rascal.ast.Comprehension.Set(node, result, generators); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Lex(node, typeArg); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Tuple(node, arguments); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Relation(node, arguments); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Map(node, first, second); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Bag(node, typeArg); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.Set(node, typeArg); 
}
...
return new org.meta_environment.rascal.ast.StructuredType.List(node, typeArg); 
}
...
return new org.meta_environment.rascal.ast.Header.Parameters(node, name, params, tags, imports); 
}
...
return new org.meta_environment.rascal.ast.Header.Default(node, name, tags, imports); 
}
...
return new org.meta_environment.rascal.ast.Statement.Solve(node, declarations, bound, body); 
}
...
return new org.meta_environment.rascal.ast.Toplevel.DefaultVisibility(node, declaration); 
}
...
return new org.meta_environment.rascal.ast.Toplevel.GivenVisibility(node, visibility, declaration); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Tag(node, kind, name, tags, types); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Annotation(node, annoType, onType, name, tags); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Rule(node, name, tags, patternAction); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Variable(node, type, variables); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Data(node, user, tags, variants); 
}
...
return new org.meta_environment.rascal.ast.Declaration.Alias(node, user, base, tags); 
}
...
return new org.meta_environment.rascal.ast.Declaration.View(node, view, superType, tags, alts); 
}
...
return new org.meta_environment.rascal.ast.Variant.NillaryConstructor(node, name); 
}
...
return new org.meta_environment.rascal.ast.FunctionDeclaration.Abstract(node, signature, tags); 
}
...
return new org.meta_environment.rascal.ast.FunctionDeclaration.Default(node, signature, tags, body); 
}
...
return new org.meta_environment.rascal.ast.Variable.Initialized(node, name, tags, initial); 
}
...
return new org.meta_environment.rascal.ast.Variable.UnInitialized(node, name, tags); 
}
...
return new org.meta_environment.rascal.ast.Symbol.LiftedSymbol(node, symbol); 
}
...
return new org.meta_environment.rascal.ast.URLLiteral.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.URLLiteral.Lexical makeURLLiteralLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.URLLiteral.Lexical(node, string); 
}
...
return new org.meta_environment.rascal.ast.URL.Ambiguity(node, alternatives); 
}
...
public org.meta_environment.rascal.ast.Pattern.ConcreteUnquoted makePatternConcreteUnquoted(INode node, org.meta_environment.rascal.ast.X symbol) { 
return new org.meta_environment.rascal.ast.Pattern.ConcreteUnquoted(node, symbol); 
}
public org.meta_environment.rascal.ast.Pattern.Ambiguity makePatternAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.Pattern> alternatives) { 
return new org.meta_environment.rascal.ast.Pattern.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.Pattern.ConcreteQuoted makePatternConcreteQuoted(INode node, org.meta_environment.rascal.ast.X symbol) { 
return new org.meta_environment.rascal.ast.Pattern.ConcreteQuoted(node, symbol); 
}
public org.meta_environment.rascal.ast.X.Ambiguity makeXAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.X> alternatives) { 
return new org.meta_environment.rascal.ast.X.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.X.MetaVariable makeXMetaVariable(INode node, org.meta_environment.rascal.ast.QualifiedName name) { 
return new org.meta_environment.rascal.ast.X.MetaVariable(node, name); 
}
...
return new org.meta_environment.rascal.ast.Tags.Default(node, annotations); 
}
}