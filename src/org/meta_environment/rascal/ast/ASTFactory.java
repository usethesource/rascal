...
public org.meta_environment.rascal.ast.Type.Lexical makeTypeLexical(INode node, String string) { 
org.meta_environment.rascal.ast.Type.Lexical x = (org.meta_environment.rascal.ast.Type.Lexical) lexCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Type.Lexical(node, string);
          lexCache.putUnsafe(node, x);
       }
       return x; 
}
