...
org.meta_environment.rascal.ast.Expression.ConcreteUnquoted x = (org.meta_environment.rascal.ast.Expression.ConcreteUnquoted) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Expression.ConcreteUnquoted(node, symbol);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Expression.ConcreteQuoted x = (org.meta_environment.rascal.ast.Expression.ConcreteQuoted) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Expression.ConcreteQuoted(node, symbol);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Symbol.LiftedSymbol x = (org.meta_environment.rascal.ast.Symbol.LiftedSymbol) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Symbol.LiftedSymbol(node, symbol);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Character.LabelStart x = (org.meta_environment.rascal.ast.Character.LabelStart) sortCache.get(node);
       if(x == null){
...
org.meta_environment.rascal.ast.Comprehension.List x = (org.meta_environment.rascal.ast.Comprehension.List) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Comprehension.List(node, result, generators);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Comprehension.Set x = (org.meta_environment.rascal.ast.Comprehension.Set) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Comprehension.Set(node, result, generators);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Pattern.ConcreteUnquoted x = (org.meta_environment.rascal.ast.Pattern.ConcreteUnquoted) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Pattern.ConcreteUnquoted(node, symbol);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.Pattern.Ambiguity amb = (org.meta_environment.rascal.ast.Pattern.Ambiguity) ambCache.get(node);
     if(amb == null){
     	amb = new org.meta_environment.rascal.ast.Pattern.Ambiguity(node, alternatives);
     	ambCache.putUnsafe(node, amb);
     }
     return amb; 
}
...
org.meta_environment.rascal.ast.Pattern.ConcreteQuoted x = (org.meta_environment.rascal.ast.Pattern.ConcreteQuoted) sortCache.get(node);
       if(x == null){
          x = new org.meta_environment.rascal.ast.Pattern.ConcreteQuoted(node, symbol);
          sortCache.putUnsafe(node, x);
       }
       return x; 
}
...
org.meta_environment.rascal.ast.X.Ambiguity amb = (org.meta_environment.rascal.ast.X.Ambiguity) ambCache.get(node);
     if(amb == null){
     	amb = new org.meta_environment.rascal.ast.X.Ambiguity(node, alternatives);
     	ambCache.putUnsafe(node, amb);
     }
     return amb; 
}
...
org.meta_environment.rascal.ast.X.MetaVariable x = (org.meta_environment.rascal.ast.X.MetaVariable) sortCache.get(node);
       if(x == null){
