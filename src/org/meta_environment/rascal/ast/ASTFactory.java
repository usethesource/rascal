...
public org.meta_environment.rascal.ast.StringConstant.Ambiguity makeStringConstantAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.StringConstant> alternatives) { 
return new org.meta_environment.rascal.ast.StringConstant.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.StringConstant.Lexical makeStringConstantLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.StringConstant.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.PreStringChars.Ambiguity makePreStringCharsAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.PreStringChars> alternatives) { 
return new org.meta_environment.rascal.ast.PreStringChars.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.PreStringChars.Lexical makePreStringCharsLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.PreStringChars.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.MidStringChars.Ambiguity makeMidStringCharsAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.MidStringChars> alternatives) { 
return new org.meta_environment.rascal.ast.MidStringChars.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.MidStringChars.Lexical makeMidStringCharsLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.MidStringChars.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.PostStringChars.Ambiguity makePostStringCharsAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.PostStringChars> alternatives) { 
return new org.meta_environment.rascal.ast.PostStringChars.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.PostStringChars.Lexical makePostStringCharsLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.PostStringChars.Lexical(node, string); 
}
...
public org.meta_environment.rascal.ast.LocationLiteral.File makeLocationLiteralFile(INode node, org.meta_environment.rascal.ast.PathPart pathPart) { 
return new org.meta_environment.rascal.ast.LocationLiteral.File(node, pathPart); 
}
...
public org.meta_environment.rascal.ast.DatePart.Ambiguity makeDatePartAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.DatePart> alternatives) { 
return new org.meta_environment.rascal.ast.DatePart.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.DatePart.Lexical makeDatePartLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.DatePart.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.JustDate.Ambiguity makeJustDateAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.JustDate> alternatives) { 
return new org.meta_environment.rascal.ast.JustDate.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.JustDate.Lexical makeJustDateLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.JustDate.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.TimePartNoTZ.Ambiguity makeTimePartNoTZAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.TimePartNoTZ> alternatives) { 
return new org.meta_environment.rascal.ast.TimePartNoTZ.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.TimePartNoTZ.Lexical makeTimePartNoTZLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.TimePartNoTZ.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.TimeZonePart.Ambiguity makeTimeZonePartAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.TimeZonePart> alternatives) { 
return new org.meta_environment.rascal.ast.TimeZonePart.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.TimeZonePart.Lexical makeTimeZonePartLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.TimeZonePart.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.JustTime.Ambiguity makeJustTimeAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.JustTime> alternatives) { 
return new org.meta_environment.rascal.ast.JustTime.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.JustTime.Lexical makeJustTimeLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.JustTime.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.DateAndTime.Ambiguity makeDateAndTimeAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.DateAndTime> alternatives) { 
return new org.meta_environment.rascal.ast.DateAndTime.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.DateAndTime.Lexical makeDateAndTimeLexical(INode node, String string) { 
return new org.meta_environment.rascal.ast.DateAndTime.Lexical(node, string); 
}
public org.meta_environment.rascal.ast.DateTimeLiteral.DateAndTimeLiteral makeDateTimeLiteralDateAndTimeLiteral(INode node, org.meta_environment.rascal.ast.DateAndTime dateAndTime) { 
return new org.meta_environment.rascal.ast.DateTimeLiteral.DateAndTimeLiteral(node, dateAndTime); 
}
public org.meta_environment.rascal.ast.DateTimeLiteral.TimeLiteral makeDateTimeLiteralTimeLiteral(INode node, org.meta_environment.rascal.ast.JustTime time) { 
return new org.meta_environment.rascal.ast.DateTimeLiteral.TimeLiteral(node, time); 
}
public org.meta_environment.rascal.ast.DateTimeLiteral.Ambiguity makeDateTimeLiteralAmbiguity(INode node, java.util.List<org.meta_environment.rascal.ast.DateTimeLiteral> alternatives) { 
return new org.meta_environment.rascal.ast.DateTimeLiteral.Ambiguity(node, alternatives); 
}
public org.meta_environment.rascal.ast.DateTimeLiteral.DateLiteral makeDateTimeLiteralDateLiteral(INode node, org.meta_environment.rascal.ast.JustDate date) { 
return new org.meta_environment.rascal.ast.DateTimeLiteral.DateLiteral(node, date); 
}
