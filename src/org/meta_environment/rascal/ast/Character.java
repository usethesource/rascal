...
private NumChar numeric;
	public NumChar getnumeric() { return numeric; }
	private void privateSetnumeric(NumChar x) { this.numeric = x; }
...
private ShortChar short;
	public ShortChar getshort() { return short; }
	private void privateSetshort(ShortChar x) { this.short = x; }
