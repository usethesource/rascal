...
/* parameters:Parameters "{" statements:Statement* "}" -> Expression {cons("VoidClosure")} */
    ...
    /*package */ VoidClosure (ITree tree,
			      org.meta_environment.rascal.ast.
			      Parameters parameters,
			      java.util.List <
			      org.meta_environment.rascal.ast.Statement >
    ...
    public VoidClosure setParameters (org.meta_environment.rascal.ast.
				      Parameters x)
    {
    ...
    public VoidClosure setStatements (java.util.List <
				      org.meta_environment.rascal.ast.
				      Statement > x)
    {
      VoidClosure z = new VoidClosure ();
...
/* "{" statements:Statement+ "}" -> Expression {cons("NonEmptyBlock")} */
    ...
    /*package */ NonEmptyBlock (ITree tree,
				java.util.List <
				org.meta_environment.rascal.ast.Statement >
				statements)
    {
    ...
    public NonEmptyBlock setStatements (java.util.List <
					org.meta_environment.rascal.ast.
					Statement > x)
    {
...
/* operator:OperatorAsValue -> Expression {cons("OperatorAsValue")} */
    ...
    public OperatorAsValue setOperator (org.meta_environment.rascal.ast.
					OperatorAsValue x)
    {
...
/* function:FunctionAsValue -> Expression {cons("FunctionAsValue")} */
    ...
    private void $setFunction (org.meta_environment.rascal.ast.
			       FunctionAsValue x)
    {
      this.function = x;
    }
    public FunctionAsValue setFunction (org.meta_environment.rascal.ast.
					FunctionAsValue x)
    {
...
/* closure:ClosureAsFunction "(" arguments:{Expression ","}* ")" -> Expression {cons("ClosureCall")} */
    ...
    private void $setClosure (org.meta_environment.rascal.ast.
			      ClosureAsFunction x)
    {
      this.closure = x;
    }
...
/* "{" elements:{Expression ","}+ "}" -> Expression {cons("NonEmptySet")} */
    ...
    /*package */ NonEmptySet (ITree tree,
			      java.util.List <
			      org.meta_environment.rascal.ast.Expression >
			      elements)
    {
    ...
    public NonEmptySet setElements (java.util.List <
				    org.meta_environment.rascal.ast.
				    Expression > x)
    {
...
/* "area" "(" areaExpression:Expression ")" -> Expression {cons("AreaLocation")} */
    ...
    private void $setAreaExpression (org.meta_environment.rascal.ast.
				     Expression x)
    {
      this.areaExpression = x;
    }
    public AreaLocation setAreaExpression (org.meta_environment.rascal.ast.
					   Expression x)
    {
...
/* "area-in-file" "(" filename:Expression "," areaExpression:Expression ")" -> Expression {cons("AreaInFileLocation")} */
    ...
    public AreaInFileLocation setAreaExpression (org.meta_environment.rascal.
						 ast.Expression x)
    {
      AreaInFileLocation z = new AreaInFileLocation ();
      z.$setAreaExpression (x);
