...
public abstract class Expression extends AbstractAST {
	...
	static public class ConcreteQuoted extends Expression {
		/* "[|" symbol:X "|]" -> Expression {cons("ConcreteQuoted")} */
		...
		@Override
		public <T> T accept(IASTVisitor<T> visitor) {
			return visitor.visitExpressionConcreteQuoted(this);
		}
	...
	static public class ConcreteUnquoted extends Expression {
		/* symbol:X -> Expression {cons("ConcreteUnquoted")} */
		...
		@Override
		public <T> T accept(IASTVisitor<T> visitor) {
			return visitor.visitExpressionConcreteUnquoted(this);
		}
	...
	static public class VariableBecomes extends Expression {
		...
		public VariableBecomes(INode node,
	...
	static public class TypedVariableBecomes extends Expression {
		...
		public TypedVariableBecomes(INode node,
	...
	static public class Guarded extends Expression {
		...
		public Guarded(INode node, org.meta_environment.rascal.ast.Type type,
				org.meta_environment.rascal.ast.Expression pattern) {
			this.node = node;
			this.type = type;
			this.pattern = pattern;
	...
	static public class MultiVariable extends Expression {
		...
		public MultiVariable(INode node,
		...
		public MultiVariable setQualifiedName(
				org.meta_environment.rascal.ast.QualifiedName x) {
	...
	static public class OperatorAsValue extends Expression {
		...
		public OperatorAsValue(INode node,
	...
	static public class FunctionAsValue extends Expression {
		...
		public FunctionAsValue(INode node,
	...
	static public class FieldProject extends Expression {
		...
		public FieldProject(INode node,
				org.meta_environment.rascal.ast.Expression expression,
	...
	static public class TransitiveReflexiveClosure extends Expression {
		...
		public TransitiveReflexiveClosure(INode node,
				org.meta_environment.rascal.ast.Expression argument) {
			this.node = node;
			this.argument = argument;
		}
	...
	static public class TransitiveClosure extends Expression {
		...
		public TransitiveClosure(INode node,
				org.meta_environment.rascal.ast.Expression argument) {
			this.node = node;
			this.argument = argument;
		}
	...
	static public class GetAnnotation extends Expression {
		...
		public GetAnnotation(INode node,
				org.meta_environment.rascal.ast.Expression expression,
				org.meta_environment.rascal.ast.Name name) {
			this.node = node;
			this.expression = expression;
	...
	static public class SetAnnotation extends Expression {
		...
		public SetAnnotation(INode node,
				org.meta_environment.rascal.ast.Expression expression,
				org.meta_environment.rascal.ast.Name name,
	...
	static public class Join extends Expression {
		...
		public Join(INode node, org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
			this.rhs = rhs;
	...
	static public class In extends Expression {
		...
		public In(INode node, org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
			this.rhs = rhs;
	...
	static public class LessThanOrEq extends Expression {
		...
		public LessThanOrEq(INode node,
				org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
	...
	static public class GreaterThanOrEq extends Expression {
		...
		public GreaterThanOrEq(INode node,
				org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
	...
	static public class IfDefinedOtherwise extends Expression {
		...
		public IfDefinedOtherwise(INode node,
				org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
	...
	static public class And extends Expression {
		...
		public And(INode node, org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
			this.rhs = rhs;
	...
	static public class Or extends Expression {
		...
		public Or(INode node, org.meta_environment.rascal.ast.Expression lhs,
				org.meta_environment.rascal.ast.Expression rhs) {
			this.node = node;
			this.lhs = lhs;
			this.rhs = rhs;
	...
	static public class Location extends Expression {
		...
		public Location(INode node, org.meta_environment.rascal.ast.URL url,
	...
	static public class TypedVariable extends Expression {
		...
		public TypedVariable(INode node,
				org.meta_environment.rascal.ast.Type type,
				org.meta_environment.rascal.ast.Name name) {
			this.node = node;
			this.type = type;
	...
	static public class EnumeratorWithStrategy extends Expression {
		...
		public EnumeratorWithStrategy(INode node,
