...
public org.meta_environment.rascal.ast.Expression getFirst() { throw new UnsupportedOperationException(); }
	public java.util.List<org.meta_environment.rascal.ast.Expression> getRest() { throw new UnsupportedOperationException(); }
...
/* "<" first:Expression "," rest:{Expression ","}+ ">" -> Expression {cons("Tuple")} */
	private Tuple() { }
	/*package*/ Tuple(ITree tree, org.meta_environment.rascal.ast.Expression first, java.util.List<org.meta_environment.rascal.ast.Expression> rest) {
		this.tree = tree;
		this.first = first;
		this.rest = rest;
	}
...
private org.meta_environment.rascal.ast.Expression first;
	...
	public java.util.List<org.meta_environment.rascal.ast.Expression> getRest() { return rest; }
	private void $setRest(java.util.List<org.meta_environment.rascal.ast.Expression> x) { this.rest = x; }
	public Tuple setRest(java.util.List<org.meta_environment.rascal.ast.Expression> x) { 
		Tuple z = new Tuple();
 		z.$setRest(x);
		return z;
	}	
} public org.meta_environment.rascal.ast.Expression getFrom() { throw new UnsupportedOperationException(); } public org.meta_environment.rascal.ast.Expression getTo() { throw new UnsupportedOperationException(); } public boolean hasFrom() { return false; } public boolean hasTo() { return false; } public boolean isMapTuple() { return false; }
static public class MapTuple extends Expression {
/* "<" from:Expression "->" to:Expression ">" -> Expression {cons("MapTuple")} */
	private MapTuple() { }
	/*package*/ MapTuple(ITree tree, org.meta_environment.rascal.ast.Expression from, org.meta_environment.rascal.ast.Expression to) {
		this.tree = tree;
		this.from = from;
		this.to = to;
	}
	...
	public boolean isMapTuple() { return true; }
...
public org.meta_environment.rascal.ast.Location getLocation() { throw new UnsupportedOperationException(); }
public boolean hasLocation() { return false; }
public boolean isLocation() { return false; }
static public class Location extends Expression {
/* location:Location -> Expression {cons("Location")} */
	private Location() { }
	/*package*/ Location(ITree tree, org.meta_environment.rascal.ast.Location location) {
		this.tree = tree;
...
private org.meta_environment.rascal.ast.Location location;
	public org.meta_environment.rascal.ast.Location getLocation() { return location; }
	private void $setLocation(org.meta_environment.rascal.ast.Location x) { this.location = x; }
	public Location setLocation(org.meta_environment.rascal.ast.Location x) { 
...
} public org.meta_environment.rascal.ast.Expression getArea() { throw new UnsupportedOperationException(); } public boolean isAreaLocation() { return false; }
static public class AreaLocation extends Expression {
/* "area" "(" area:Expression ")" -> Expression {cons("AreaLocation")} */
	private AreaLocation() { }
	/*package*/ AreaLocation(ITree tree, org.meta_environment.rascal.ast.Expression area) {
		this.tree = tree;
		this.area = area;
	}
	public IVisitable accept(IASTVisitor visitor) {
...
} public org.meta_environment.rascal.ast.Type getType() { throw new UnsupportedOperationException(); } public boolean hasType() { return false; } public boolean isTypedVariable() { return false; }
...
private org.meta_environment.rascal.ast.Visit visit;
	...
	public java.util.List<org.meta_environment.rascal.ast.Statement> getStatements() { throw new UnsupportedOperationException(); } public boolean hasParameters() { return false; }
...
public org.meta_environment.rascal.ast.Expression getClosure() { throw new UnsupportedOperationException(); } public boolean hasClosure() { return false; } public boolean isClosureCall() { return false; }
static public class ClosureCall extends Expression {
/* "(" closure:Expression ")" "(" arguments:{Expression ","}* ")" -> Expression {cons("ClosureCall")} */
	private ClosureCall() { }
	/*package*/ ClosureCall(ITree tree, org.meta_environment.rascal.ast.Expression closure, java.util.List<org.meta_environment.rascal.ast.Expression> arguments) {
		this.tree = tree;
...
private org.meta_environment.rascal.ast.Expression closure;
	public org.meta_environment.rascal.ast.Expression getClosure() { return closure; }
	private void $setClosure(org.meta_environment.rascal.ast.Expression x) { this.closure = x; }
	public ClosureCall setClosure(org.meta_environment.rascal.ast.Expression x) { 
...
/* "[" from:Expression ".." to:Expression "]" -> Expression {cons("Range")} */
	private Range() { }
	/*package*/ Range(ITree tree, org.meta_environment.rascal.ast.Expression from, org.meta_environment.rascal.ast.Expression to) {
		this.tree = tree;
		this.from = from;
		this.to = to;
	}
...
} public org.meta_environment.rascal.ast.Expression getBy() { throw new UnsupportedOperationException(); } public boolean hasBy() { return false; } public boolean isStepRange() { return false; }
static public class StepRange extends Expression {
/* "[" from:Expression "," by:Expression ",.." to:Expression "]" -> Expression {cons("StepRange")} */
	private StepRange() { }
	/*package*/ StepRange(ITree tree, org.meta_environment.rascal.ast.Expression from, org.meta_environment.rascal.ast.Expression by, org.meta_environment.rascal.ast.Expression to) {
		this.tree = tree;
		this.from = from;
		this.by = by;
		this.to = to;
	...
	public boolean hasFrom() { return true; }
	public boolean hasBy() { return true; }
	public boolean hasTo() { return true; }
...
private org.meta_environment.rascal.ast.Expression from;
	...
	public org.meta_environment.rascal.ast.Expression getBy() { return by; }
	private void $setBy(org.meta_environment.rascal.ast.Expression x) { this.by = x; }
...
} public org.meta_environment.rascal.ast.Expression getArgument() { throw new UnsupportedOperationException(); } public boolean hasArgument() { return false; } public boolean isTransitiveReflexiveClosure() { return false; }
...
/* lhs:Expression "-" rhs:Expression -> Expression {cons("Substraction"), left} */
	...
	/*package*/ Substraction(ITree tree, org.meta_environment.rascal.ast.Expression lhs, org.meta_environment.rascal.ast.Expression rhs) {
		this.tree = tree;
		this.lhs = lhs;
		this.rhs = rhs;
	}
...
public boolean hasCondition() { return false; }
	public boolean hasThenExp() { return false; }
	public boolean hasElseExp() { return false; }
...
public org.meta_environment.rascal.ast.StandardOperator getOperator() { throw new UnsupportedOperationException(); }
...
/* operator:StandardOperator -> Expression {cons("Operator")} */
	private Operator() { }
	/*package*/ Operator(ITree tree, org.meta_environment.rascal.ast.StandardOperator operator) {
		this.tree = tree;
...
private org.meta_environment.rascal.ast.StandardOperator operator;
	public org.meta_environment.rascal.ast.StandardOperator getOperator() { return operator; }
	private void $setOperator(org.meta_environment.rascal.ast.StandardOperator x) { this.operator = x; }
	public Operator setOperator(org.meta_environment.rascal.ast.StandardOperator x) { 
