...
public class Factory {
	private static TypeStore errors = new TypeStore(org.meta_environment.locations.Factory.getStore());
	...
	public static final Type Subject_Localized = tf.constructor(errors, Subject, "localized", tf.stringType(), "description", org.meta_environment.locations.Factory.Location, "location");
